...
//USEUNIT CR1404_12_GenererRapport


function CR1404_12_08_RapportCompteBrut()
{
  ...
  var excelPageName = "CR1404_12_08";
  var reportName = GetData(filePath_Portefeuille, excelPageName, 1, language);
  var reportFolderPath = Project.Path + "GENERATED_REPORTS\\CR1404\\CR1404_12_08\\";
