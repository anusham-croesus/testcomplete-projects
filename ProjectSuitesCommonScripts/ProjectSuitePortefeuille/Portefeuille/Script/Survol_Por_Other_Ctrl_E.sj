...
Par la suite, le mailler vers le module portefeuille (menuBar-Modules-Portefeuille-Chaîner vers).Rechercher une position avec le symbol CBL170 (other).
Afficher la fenêtre Info  par Ctrl+E. Fermer la fenêtre par X */
 
function Survol_Por_Other_Ctrl_E()
{
  var type="other";
