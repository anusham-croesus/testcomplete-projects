...
Cliquer sur WhatIf_MenuBar_EditFunctions_Save .Vérifier vérifier la présence des contrôles.Fermer la fenêtre par X */

function Survol_Por_WhatIf_MenuBar_EditFunctions_Save()
{
