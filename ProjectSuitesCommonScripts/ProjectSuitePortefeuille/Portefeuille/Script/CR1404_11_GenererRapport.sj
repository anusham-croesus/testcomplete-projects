...
function PreparationRapportClient(excelPageName, reportName, reportFolderPath)
{
...
function PreparationRapportRelation(excelPageName, reportName, reportFolderPath)
{
  Create_Folder(reportFolderPath);
  ...
  Get_WinQuickSearch_TxtSearch().keys("0005");
  Get_WinQuickSearch_BtnOK().Click();
}
