...
Par la suite, le mailler vers le module portefeuille (menuBar-Modules-Portefeuille-Chaîner vers). Afficher la fenêtre « Sommation des titres » 
en cliquant sur ToolBar-btnSum. Vérifier la présence des contrôles et des étiquetés.Fermer la fenêtre du message par Esc */

function Survol_Por_ToolBar_btnSum()
{
