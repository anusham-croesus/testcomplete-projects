...
Afficher la fenêtre « Rechercher » par clavier.  Vérifier la présence des contrôles et des étiquetés.Fermer la fenêtre par X*/

function Survol_Por_Search_KeybordSearch()
{
