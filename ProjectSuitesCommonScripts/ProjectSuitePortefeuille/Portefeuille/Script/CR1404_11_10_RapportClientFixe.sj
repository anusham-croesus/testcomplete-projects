...
function CR1404_11_10_RapportClientFixe()
{
  ...
  var excelPageName = "CR1404_11_10";
  var reportName = GetData(filePath_Portefeuille, excelPageName, 1, language);
  var reportFolderPath = Project.Path + "GENERATED_REPORTS\\CR1404\\CR1404_11_10\\";
  
  try
  {
    var reportFileName = GetData(filePath_Portefeuille, excelPageName, 6, language);
    PreparationRapportClient(excelPageName, reportName, reportFolderPath);
