...
*/
function CR1404_06_04_ColonnesPerf_Fixe()
{
  ...
  try {
    ...
    var values = ReadDataFromExcelByRowIDColumnID(filePath_Portefeuille, "ColonnesPerf", 3, columnID).split(";");
    ...
    if (client == "CIBC"){
        ...
        {
            //Log.Message("" + n + " = " + columnList[n].Content + ", " + columnList[n].WPFControlOrdinalNo);
