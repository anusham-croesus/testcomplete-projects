...
Par la suite, le mailler vers le module portefeuille (menuBar-Modules-Portefeuille-Chaîner vers).Cliquer sur What_If du menu contextuel. 
vérifier le texte des en-têtes et vérifier les contrôles dans TOOLBARTRAY. */

/*    Date: 30-12-2020
      Analyste Auto: Abdel.M
      Objectif: Combiner les différentes façons pour afficher la fenêtre Info WhatIf
*/
 
 function Survol_Por_WhatIf_Info_CombinedAccess()
 {
   try {
          ...
          var btnTypeWhatIf = ReadDataFromExcelByRowIDColumnID(filePath_Portefeuille, "Survol", "btnTypeWhatIf", language+client);
          ...
          var positionCAD = ReadDataFromExcelByRowIDColumnID(filePath_Portefeuille, "Survol", "positionCAD", language+client);
 ...
 //----------- Étape 2 : WhatIf Info par menu contextuel ---------------------------------------
          Log.PopLogFolder();
          logEtape2 = Log.AppendFolder("Étape 2: WhatIf Info par menu contextuel");
          ...
          Check_WhatIfInfo_Properties(language, typeBond) 
          Check_Existence_Of_Controls_InfoWhatif(typeBond)
          Check_PositionInfo_Properties(language, typeBond)// la fonction est dans le Survol_Por_Bond_MenuBar_EditFunctions_Info
          Check_Existence_Of_Controls_PositionInfo(typeBond,btnTypeWhatIf)// la fonction est dans le Survol_Por_Bond_MenuBar_EditFunctions_Info
  
          Get_WinPositionInfo_BtnCancel().Keys("[Esc]");
          
 //----------- Étape 3 : WhatIf Info par menuBar Edit ---------------------------------------
          Log.PopLogFolder();
          logEtape3 = Log.AppendFolder("Étape 3: WhatIf Info par menuBar Edit");
          ...
          //Les points de vérification 
          Check_WhatIfInfo_Properties(language, typeEquity) // la fonction est dans le Survol_Por_Bond_WhatIf_ContextualMenu_Functions_Info
          Check_Existence_Of_Controls_InfoWhatif(typeEquity)// la fonction est dans le Survol_Por_Bond_WhatIf_ContextualMenu_Functions_Info
          Check_PositionInfo_Properties(language, typeEquity)// la fonction est dans le Survol_Por_Bond_MenuBar_EditFunctions_Info
          Check_Existence_Of_Controls_PositionInfo(typeEquity,btnTypeWhatIf)// la fonction est dans le Survol_Por_Bond_MenuBar_EditFunctions_Info
  
          Get_WinPositionInfo_BtnCancel().Keys("[Esc]");
          
  //----------- Étape 4 : WhatIf Info Ctrl-E   ---------------------------------------
          Log.PopLogFolder();
          logEtape4 = Log.AppendFolder("Étape 4: WhatIf Info Ctrl-E");
          ...
          //Les points de vérification 
          Check_WhatIfInfo_Properties(language, typeOther) // la fonction est dans le Survol_Por_Bond_WhatIf_ContextualMenu_Functions_Info
          Check_Existence_Of_Controls_InfoWhatif(typeOther)// la fonction est dans le Survol_Por_Bond_WhatIf_ContextualMenu_Functions_Info
          Check_PositionInfo_Properties(language, typeOther)// la fonction est dans le Survol_Por_Bond_MenuBar_EditFunctions_Info
          Check_Existence_Of_Controls_PositionInfo(typeOther,btnTypeWhatIf)// la fonction est dans le Survol_Por_Bond_MenuBar_EditFunctions_Info
  
          Get_WinPositionInfo_BtnCancel().Keys("[Esc]");
          
  //----------- Étape 5 : WhatIf Info PortfolioBar button   ---------------------------------------
          Log.PopLogFolder();
          logEtape5 = Log.AppendFolder("Étape 5: WhatIf Info PortfolioBar button");
          
          Search_Position(positionCAD);
          ...
          Check_Existence_Of_Controls_Info_Cash(btnTypeWhatIf); // la fonction est dans CommonCheckpoints
