...
Afficher La fenêtre Composer en cliquant MenuBar_Tools_Internet_ComposeAddress. Vérifier la présence des contrôles dans le menu  */
 
 function Survol_Por_MenuBar_Tools_Internet_ComposeAddress()
 {
