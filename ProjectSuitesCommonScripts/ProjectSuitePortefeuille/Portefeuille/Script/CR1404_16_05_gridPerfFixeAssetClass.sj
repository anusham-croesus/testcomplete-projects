...
/**
    Description : Valider les valeurs calculées de performance pour le compte 800011-NA en période fixe, par class d'actifs.
    Auteur : Antoine Gélinas
*/
function CR1404_16_05_gridPerfFixeAssetClass()
{
  var testNumber = "16-05-";
