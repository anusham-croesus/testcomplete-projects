...
/**
    Description : Vérifie les colonnes dans le module Portefeuille avec la préférence Pref_Position_Level_Performance = 1,
...
*/
function CR1404_06_02_ColonnesPerf_CumulClassDActifs()
{
  ...
  try {
    ...
    var columnList = Get_Portfolio_AssetClassesGrid_ColumnList();
    ...
    var values = ReadDataFromExcelByRowIDColumnID(filePath_Portefeuille, "ColonnesPerf", 2, columnID).split(";");
