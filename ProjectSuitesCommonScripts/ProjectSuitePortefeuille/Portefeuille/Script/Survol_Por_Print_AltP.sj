...
Par la suite, le mailler vers le module portefeuille (menuBar-Modules-Portefeuille-Chaîner vers). Afficher la fenêtre « Print » avec AltP. 
Cliquer sur le btnCancel, Vérifier le message «Impression annulée». Fermer la fenêtre du message par X   */
 
function Survol_Por_Print_AltP()
{
