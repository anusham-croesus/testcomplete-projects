...
function CR1483_Cli_Survol_Users_Selection_TabIACodes() 
{
          ...
          CR1483_Survol_Users_Selection_TabIACodes(vServerPortefeuille,Get_ModulesBar_BtnClients(),filePath_Clients );
}
