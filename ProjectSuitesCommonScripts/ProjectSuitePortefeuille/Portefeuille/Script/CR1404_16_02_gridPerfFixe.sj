...
/**
    Description : Valider les valeurs calculées de performance pour le compte 800011-NA en période fixe.
    Auteur : Antoine Gélinas
*/
function CR1404_16_02_gridPerfFixe()
{
  var testNumber = "16-02-";
