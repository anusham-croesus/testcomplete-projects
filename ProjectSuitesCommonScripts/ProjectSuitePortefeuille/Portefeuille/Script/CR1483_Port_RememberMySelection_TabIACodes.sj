...
function CR1483_Cli_RememberMySelection_TabIACodes() {
        ...
        CR1483_RememberMySelection(vServerPortefeuille,Get_ModulesBar_BtnClients(),"IACodes", filePath_Clients, "BD88");
}