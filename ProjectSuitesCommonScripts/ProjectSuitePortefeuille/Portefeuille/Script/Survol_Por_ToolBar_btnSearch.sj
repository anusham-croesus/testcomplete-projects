...
Afficher la fenêtre « Rechercher » en cliquant sur ToolBar-btnSearch.  Vérifier la présence des contrôles et des étiquetés.Fermer la fenêtre par Esc*/

function Survol_Por_ToolBar_btnSearch()
{
