...
en cliquant sur Compare du menu contextuel. Fermer la fenêtre par X */
 
 function Survol_Por_ContextualeMenu_Functions_Compare()
 {
  ...
  Get_PortfolioGrid_ContextualMenu_Functions_Compare().Click()
  ...
  Get_WinComparisonContextChooser().Close()
