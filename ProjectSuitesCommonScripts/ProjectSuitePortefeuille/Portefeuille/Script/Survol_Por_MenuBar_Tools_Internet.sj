...
Afficher le menu contextuel en cliquant sur MenuBar-Tools- btnInternet. Vérifier la présence des contrôles dans le menu  */
 
function Survol_Por_MenuBar_Tools_Internet()
{
