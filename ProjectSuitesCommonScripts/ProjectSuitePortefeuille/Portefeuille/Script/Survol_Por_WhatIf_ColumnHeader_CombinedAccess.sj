...
/*    Date: 30-12-2020
      ...
      Objectif: Combiner les différentes façons pour vérifier les colonnes de la fenêtre WhatIf
*/
 
 function Survol_Por_WhatIf_ColumnHeader_CombinedAccess()
 {
   try {
 ...
 //----------- Étape 2 : WhatIf par menu contextuel ---------------------------------------
          Log.PopLogFolder();
          logEtape2 = Log.AppendFolder("Étape 2: WhatIf par menu contextuel");
  
          Get_PortfolioPlugin().ClickR()
          Get_PortfolioGrid_ContextualMenu_Functions().Click()
          Get_PortfolioGrid_ContextualMenu_Functions_WhatIf().Click()
 ...
 //----------- Étape 3 : WhatIf par menuBar Edit ---------------------------------------
          Log.PopLogFolder();
          logEtape3 = Log.AppendFolder("Étape 3: WhatIf par menuBar Edit");
