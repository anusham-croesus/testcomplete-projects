...
/*    Date: 29-12-2020
      ...
      Objectif: Combiner les différentes façons pour afficher la fenêtre info
*/
 
 function Survol_Por_Info_CombinedAccess()
 {
   try {
          ...
          var typeBond = ReadDataFromExcelByRowIDColumnID(filePath_Portefeuille, "Survol", "typeBond", language+client);
          var positionBond = ReadDataFromExcelByRowIDColumnID(filePath_Portefeuille, "Survol", "positionBond", language+client);
          
          var positionBtnType = ReadDataFromExcelByRowIDColumnID(filePath_Portefeuille, "Survol", "positionBtnType", language+client);
          var btnType = ReadDataFromExcelByRowIDColumnID(filePath_Portefeuille, "Survol", "btnType", language+client);
          
          var typeEquity = ReadDataFromExcelByRowIDColumnID(filePath_Portefeuille, "Survol", "typeEquity", language+client);
          var positionEquity = ReadDataFromExcelByRowIDColumnID(filePath_Portefeuille, "Survol", "positionEquity", language+client);
          
          var typeOther = ReadDataFromExcelByRowIDColumnID(filePath_Portefeuille, "Survol", "typeOther", language+client);
          var positionOther = ReadDataFromExcelByRowIDColumnID(filePath_Portefeuille, "Survol", "positionOther", language+client);
 ...
 //----------- Étape 2 : Accès à la fenêtre Info en cliquant sur MenuBar -Edit-Functions- btnInfo ---------------------------------------
          ...
          Check_Info_Properties(language, typeBond)
          Check_Details_Properties(language, typeBond)
          if(client == "US" ){
          Check_Lots_Properties(language, typeBond);// la fonction est dans le Survol_Por_Bond_MenuBar_EditFunctions_Info
          } 
          Check_PositionInfo_Properties(language, typeBond)
          Check_Existence_Of_Controls_TabInfo(typeBond)
          Check_Existence_Of_Controls_TabDetails(typeBond) 
          if(client == "US" ){
          Check_Existence_Of_Controls_TabLots(typeBond);
          } 
          Check_Existence_Of_Controls_PositionInfo(typeBond)
 ...
 //----------- Étape 3 : Accès à la fenêtre Info en cliquant sur le bouton Info ---------------------------------------
          ...
          Search_Position(positionBtnType);
  ...
  //----------- Étape 4 : Accès à la fenêtre Info par menu contextuel ---------------------------------------
          Log.PopLogFolder();
          logEtape4 = Log.AppendFolder("Étape 4: Accès à la fenêtre Info  par menu contextuel");
          
          Search_Position(positionEquity);
          ...
          //Les points de vérification 
          Check_Info_Properties(language, typeEquity)// la fonction est dans le Survol_Por_Bond_MenuBar_EditFunctions_Info
          Check_Details_Properties(language, typeEquity)// la fonction est dans le Survol_Por_Bond_MenuBar_EditFunctions_Info
          if(client == "US" ){
          Check_Lots_Properties(language, typeEquity);// la fonction est dans le Survol_Por_Bond_MenuBar_EditFunctions_Info
          } 
          Check_PositionInfo_Properties(language, typeEquity)// la fonction est dans le Survol_Por_Bond_MenuBar_EditFunctions_Info
          Check_Existence_Of_Controls_TabInfo(typeEquity)// la fonction est dans le Survol_Por_Bond_MenuBar_EditFunctions_Info
          Check_Existence_Of_Controls_TabDetails(typeEquity) // la fonction est dans le Survol_Por_Bond_MenuBar_EditFunctions_Info
          if(client == "US" ){
          Check_Existence_Of_Controls_TabLots(typeEquity);
          }
          Check_Existence_Of_Controls_PositionInfo(typeEquity)// la fonction est dans le Survol_Por_Bond_MenuBar_EditFunctions_Info
  
          Get_WinPositionInfo().Close();
          
  //----------- Étape 5 : Accès à la fenêtre Info par Ctrl-E ---------------------------------------
          Log.PopLogFolder();
          logEtape5 = Log.AppendFolder("Étape 5: Accès à la fenêtre Info  par par Ctrl-E");
          
          Search_Position(positionOther);
  
          Get_MainWindow().Keys("^e");
  
          //Les points de vérification 
          Check_Info_Properties(language, typeOther)// la fonction est dans le Survol_Por_Bond_MenuBar_EditFunctions_Info
          Check_Details_Properties(language, typeOther);
          if(client == "US" ){
          Check_Lots_Properties(language, typeOther);// la fonction est dans le Survol_Por_Bond_MenuBar_EditFunctions_Info
          } 
          Check_PositionInfo_Properties(language, typeOther)// la fonction est dans le Survol_Por_Bond_MenuBar_EditFunctions_Info
          Check_Existence_Of_Controls_TabInfo(typeOther)// la fonction est dans le Survol_Por_Bond_MenuBar_EditFunctions_Info
          Check_Existence_Of_Controls_TabDetails(typeOther); // la fonction est dans le Survol_Por_Bond_MenuBar_EditFunctions_Info
          if(client == "US" ){
          Check_Existence_Of_Controls_TabLots(typeOther);
          } 
          Check_Existence_Of_Controls_PositionInfo(typeOther)// la fonction est dans le Survol_Por_Bond_MenuBar_EditFunctions_Info
