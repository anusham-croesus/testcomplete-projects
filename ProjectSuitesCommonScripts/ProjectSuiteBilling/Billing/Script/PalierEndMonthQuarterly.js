...
function PalierEndMonthQuarterly()
{
      ...
      try {
              ...
              var RelationShipName=GetData(filePath_Billing,"RelationBilling",105,language)
           ...
           UncheckedBillableRelastionShip();
            ...
            Login(vServerBilling, userNameBilling, pswBilling, language);
              ...
              if(client == "BNC")
              {
                var  NameSheetPalierEndMonthQ  ="PalierEndMonthQBNC"
                
              }
              if(client == "US")
              {
                var  NameSheetPalierEndMonthQ  ="PalierEndMonthQ"
              }
            
            Delay(1000);
              //ouvrir le module relation
            Get_ModulesBar_BtnRelationships().Click();
            SearchRelationshipByName(GetData(filePath_Billing,"RelationBilling",105,language));
            Delay(800)
          // double click sur la relation Billing Relation
            Get_RelationshipsClientsAccountsGrid().Find("Value",GetData(filePath_Billing,"RelationBilling",105,language),100).DblClick();
            Delay(3000);
           ...
           // FillInTheBottomPartOfAccounts(16);
            FillRelationshipBillingTab([GetData(filePath_Billing,"WinAssignCompte",39,language),GetData(filePath_Billing,"WinAssignCompte",40,language)], GetData(filePath_Billing,"RelationBilling",10,language))
             ...
             if(client == "US"){
              if(count==9){
                    for(i=0;i<count;i++)
                    {
                           ...
                           var relationShipExcel=GetData(filePath_Billing,"RelationBilling",127,language)
                           
                           var messagesExcel=GetData(filePath_Billing,NameSheetPalierEndMonthQ ,2+i,language)
                           Log.Message(2+i)
...
// click sur la premiére ligne de la partie de relationShips
                    ...
                    Get_WinBilling_GrpRelationships_DgvRelationships().WPFObject("RecordListControl", "", 1).Find("Value",GetData(filePath_Billing,NameSheetPalierEndMonthQ ,17+z,language),100).Click();
                    Log.Message(17+z);
                    Delay(300);
                    ...
                    Delay(300);
                          ...
                          Delay(200)
                           ...
                           var includedExcel=GetData(filePath_Billing,NameSheetPalierEndMonthQ ,14+z,language)
                           Log.Message(14+z);
                           ...
                           var relationshipNamExel=GetData(filePath_Billing,NameSheetPalierEndMonthQ ,15+z,language);
                           Log.Message(15+z);
                           ...
                           var BilledOn=GetData(filePath_Billing,NameSheetPalierEndMonthQ ,17+z,language);
                           Log.Message(17+z);
                           ...
                           var LastBillingOn=GetData(filePath_Billing,NameSheetPalierEndMonthQ ,18+z,language);
                           Log.Message(18+z);
                           ...
                           var aumExcel=GetData(filePath_Billing,NameSheetPalierEndMonthQ ,19+z,language);
                           Log.Message(19+z);
                           ...
                           var FeesExcel=GetData(filePath_Billing,NameSheetPalierEndMonthQ ,20+z,language);
                           Log.Message(20+z);
                           ...
                           var CurrencyExcel=GetData(filePath_Billing,NameSheetPalierEndMonthQ ,21+z,language);
                           Log.Message(21+z);
                           ...
                           var aumFirmCurrencyExcel=GetData(filePath_Billing,NameSheetPalierEndMonthQ ,22+z,language);
                           Log.Message(22+z);
                           ...
                           var CurrencyfirmeExcel=GetData(filePath_Billing,NameSheetPalierEndMonthQ ,23+z,language);
                           Log.Message(23+z);
                           ...
                           var AUMExcludedExcel=GetData(filePath_Billing,NameSheetPalierEndMonthQ ,24+z,language);
                           Log.Message(24+z);
                           ...
                           var AUMForCalculationExcel=GetData(filePath_Billing,NameSheetPalierEndMonthQ ,25+z,language);
                           Log.Message(25+z);
                           ...
                           var AUMforFirmCurrExcel=GetData(filePath_Billing,NameSheetPalierEndMonthQ ,26+z,language);
                           Log.Message(26+z);
                           ...
                           var FrequencyExcel=GetData(filePath_Billing,NameSheetPalierEndMonthQ ,27+z,language);
                           Log.Message(27+z);
                           ...
                           var periodeExcel=GetData(filePath_Billing,NameSheetPalierEndMonthQ ,28+z,language);
                           Log.Message(28+z);
                           ...
                           var IAcodeExcel=GetData(filePath_Billing,NameSheetPalierEndMonthQ ,29+z,language);
                           Log.Message(29+z);
                           ...
                           var NombreCompteExcel=GetData(filePath_Billing,NameSheetPalierEndMonthQ ,30+z,language);
                           Log.Message(30+z);
                           ...
                           var CFAdjustementExcel=GetData(filePath_Billing,NameSheetPalierEndMonthQ ,31+z,language);
                           Log.Message(31+z);
...
for(var j=0;j<countFees;j++){ 
    // Vérifier la partie Fees de la ligne sélectionnée
                           ...
                           var AssetValueExcel=GetData(filePath_Billing,NameSheetPalierEndMonthQ ,32+z+i,language);
                           Log.Message(32+z+i)
                           ...
                           var RateExcel=GetData(filePath_Billing,NameSheetPalierEndMonthQ ,33+z+i,language);
                           Log.Message(33+z+i)
                           ...
                           var FeesExcel=GetData(filePath_Billing,NameSheetPalierEndMonthQ ,34+z+i,language);
                           Log.Message(34+z+i)
                           ...
                           var CurrencyRelationShipFeesExcel=GetData(filePath_Billing,NameSheetPalierEndMonthQ ,35+z+i,language);
                           Log.Message(35+z+i)
                         ...
                         // Vérifier la partie des comptes
                           ...
                           var IncludedAccomptExcel=GetData(filePath_Billing,NameSheetPalierEndMonthQ ,56+z+c,language);
                           Log.Message(56+z+c);
                           ...
                           var AccountNubrAccountExcel=GetData(filePath_Billing,NameSheetPalierEndMonthQ ,57+z+c,language);
                           Log.Message(57+z+c);
                           ...
                           var ClientNameAccountExcel=GetData(filePath_Billing,NameSheetPalierEndMonthQ ,58+z+c,language);
                           Log.Message(58+z+c);
                           ...
                           var BilledFeesAccountExcel=GetData(filePath_Billing,NameSheetPalierEndMonthQ ,59+z+c,language);
                           Log.Message(59+z+c);
                           ...
                           var SpecialFeesAccountExcel=GetData(filePath_Billing,NameSheetPalierEndMonthQ ,60+z+c,language);
                           Log.Message(60+z+c);
                          ...
                          //Vérifier Currency
                           ...
                           var CurrencyAccountExcel=GetData(filePath_Billing,NameSheetPalierEndMonthQ ,61+z+c,language);
                           Log.Message(61+z+c);
                           ...
                           var BilledAccountAccountExcel=GetData(filePath_Billing,NameSheetPalierEndMonthQ ,62+z+c,language);
                           Log.Message(62+z+c);
                           ...
                           var BilledonAccountExcel=GetData(filePath_Billing,NameSheetPalierEndMonthQ ,63+z+c,language);
                           Log.Message(63+z+c);
                           ...
                           var IACodeAccountExcel=GetData(filePath_Billing,NameSheetPalierEndMonthQ ,64+z+c,language);
                           Log.Message(64+z+c);
                           ...
                           var AUMAccountExcel=GetData(filePath_Billing,NameSheetPalierEndMonthQ ,65+z+c,language);
                           Log.Message(65+z+c);
                           ...
                           var AUMExcludedAccountExcel=GetData(filePath_Billing,NameSheetPalierEndMonthQ ,66+z+c,language);
                           Log.Message(66+z+c);
                           ...
                           var UMForCalculationAccountExcel=GetData(filePath_Billing,NameSheetPalierEndMonthQ ,67+z+c,language);
                           Log.Message(67+z+c);
                           ...
                           var WeightingAccountExcel=GetData(filePath_Billing,NameSheetPalierEndMonthQ ,68+z+c,language);
                           Log.Message(68+z+c);
                           ...
                           var CFAdjustementAccountExcel=GetData(filePath_Billing,NameSheetPalierEndMonthQ ,69+z+c,language);
                           Log.Message(69+z+c);
                           CheckEquals(VarToStr(CFAdjustementAccount),VarToStr(CFAdjustementAccountExcel), "Valeur de CF Adjustement");
                            
                          Delay(200);
                          c=c+14;}
                           var ligneselection=GetData(filePath_Billing,NameSheetPalierEndMonthQ ,17+z,language);
            ...
            Get_WinDetailedInfo_TabBillingForRelationship().Click();
            Delay(800)
            FillTheCashFlowAdjustmen (GetData(filePath_Billing,"RelationBilling",229,language),GetData(filePath_Billing,"RelationBilling",230,language),GetData(filePath_Billing,"RelationBilling",231,language),GetData(filePath_Billing,"RelationBilling",232,language))
