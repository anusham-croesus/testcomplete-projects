...
function StartOfPeriode2MonthlyIncludeInCash()
{
      ...
      try {
          ...
          /*  Activate_Inactivate_PrefBranch("0","PREF_BILLING_FEESCHEDULE","YES",vServerBilling);
            ...
            SearchRelationshipByName(GetData(filePath_Billing,"RelationBilling",114,language));
            Delay(800)
          // double click sur la relation Billing Relation
            Get_RelationshipsClientsAccountsGrid().Find("Value",GetData(filePath_Billing,"RelationBilling",114,language),100).DblClick();
            Delay(3000);
            ...
            Get_WinDetailedInfo_BtnApply().Click();
            Delay(800)
            // choisir la Fee schedul Prod interval asset
            ...
            FillRelationshipBillingTab([GetData(filePath_Billing,"WinAssignCompte",55,language)], GetData(filePath_Billing,"RelationBilling",16,language))
            Delay(1000);
            ...
            // Cliquer sur le bouton OK
             ...
             WaitUntilCroesusDialogBoxClose();
              ...
              Log.Error(" Il y a une différence entre la capture d'écran des cas des tests et ce que l'application affiche");
              if( taillegrille == 2 )
              {
               for(i=0;i<taillegrille;i++)
                    {
                           ...
                           var relationShipExcel=GetData(filePath_Billing,"Start_periode2MIncludeInCash",10,language)
                           
                           var messagesExcel=GetData(filePath_Billing,"Start_periode2MIncludeInCash",343+i,language)
                           Log.Message(343+i)
...
if(k == 9){
                 Scroll() 
                 Delay(800)} 
                    Get_WinBilling_GrpRelationships_DgvRelationships().WPFObject("RecordListControl", "", 1).Find("Value",GetData(filePath_Billing,"Start_periode2MIncludeInCash",12+z,language),100).Click();
                    Delay(300);
                    ...
                    Delay(300);
                          ...
                          Delay(200)
                           ...
                           var includedExcel=GetData(filePath_Billing,"Start_periode2MIncludeInCash",9+z,language)
                           Log.Message(9+z);
                           ...
                           var relationshipNamExel=GetData(filePath_Billing,"Start_periode2MIncludeInCash",10+z,language);
                           Log.Message(10+z);
                           ...
                           var BilledOn=GetData(filePath_Billing,"Start_periode2MIncludeInCash",12+z,language);
                           Log.Message(12+z);
                           ...
                           var LastBillingOn=GetData(filePath_Billing,"Start_periode2MIncludeInCash",13+z,language);
                           Log.Message(13+z);
                           ...
                           var aumExcel=GetData(filePath_Billing,"Start_periode2MIncludeInCash",14+z,language);
                           Log.Message(14+z);
                          ...
                          // vérifier la valeur de Fees
                           ...
                           var FeesExcel=GetData(filePath_Billing,"Start_periode2MIncludeInCash",15+z,language);
                           Log.Message(15+z);
                           ...
                           var CurrencyExcel=GetData(filePath_Billing,"Start_periode2MIncludeInCash",16+z,language);
                           Log.Message(16+z);
                           ...
                           var aumFirmCurrencyExcel=GetData(filePath_Billing,"Start_periode2MIncludeInCash",17+z,language);
                           Log.Message(17+z);
                           ...
                           var CurrencyfirmeExcel=GetData(filePath_Billing,"Start_periode2MIncludeInCash",18+z,language);
                           Log.Message(18+z);
                           ...
                           var AUMExcludedExcel=GetData(filePath_Billing,"Start_periode2MIncludeInCash",19+z,language);
                           Log.Message(19+z);
                           ...
                           var AUMForCalculationExcel=GetData(filePath_Billing,"Start_periode2MIncludeInCash",20+z,language);
                           Log.Message(20+z);
                           ...
                           var AUMforFirmCurrExcel=GetData(filePath_Billing,"Start_periode2MIncludeInCash",21+z,language);
                           Log.Message(21+z);
                           ...
                           var FrequencyExcel=GetData(filePath_Billing,"Start_periode2MIncludeInCash",22+z,language);
                           Log.Message(22+z);
                           ...
                           var periodeExcel=GetData(filePath_Billing,"Start_periode2MIncludeInCash",23+z,language);
                           Log.Message(23+z);
                           ...
                           var IAcodeExcel=GetData(filePath_Billing,"Start_periode2MIncludeInCash",24+z,language);
                           Log.Message(24+z);
                           ...
                           var NombreCompteExcel=GetData(filePath_Billing,"Start_periode2MIncludeInCash",25+z,language);
                           Log.Message(25+z);
                           ...
                           var CFAdjustementExcel=GetData(filePath_Billing,"Start_periode2MIncludeInCash",26+z,language);
                           Log.Message(26+z);
...
//for(var j=0;j<20;j++){ 
    // Vérifier la partie des comptes
                           ...
                           var IncludedAccomptExcel=GetData(filePath_Billing,"Start_periode2MIncludeInCash",9,language);
                           ...
                           var AccountNubrAccountExcel=GetData(filePath_Billing,"Start_periode2MIncludeInCash",27+z,language);
                           Log.Message(27+z);
                           ...
                           var ClientNameAccountExcel=GetData(filePath_Billing,"Start_periode2MIncludeInCash",28+z,language);
                           Log.Message(28+z);
                           ...
                           var BilledFeesAccountExcel=GetData(filePath_Billing,"Start_periode2MIncludeInCash",29+z,language);
                           Log.Message(29+z);
                           ...
                           var SpecialFeesAccountExcel=GetData(filePath_Billing,"Start_periode2MIncludeInCash",30+z,language);
                           Log.Message(30+z);
                          ...
                          //Vérifier Currency
                           ...
                           var CurrencyAccountExcel=GetData(filePath_Billing,"Start_periode2MIncludeInCash",31+z,language);
                           Log.Message(31+z);
                           ...
                           var BilledAccountAccountExcel=GetData(filePath_Billing,"Start_periode2MIncludeInCash",32+z,language);
                           Log.Message(32+z);
                           ...
                           var BilledonAccountExcel=GetData(filePath_Billing,"Start_periode2MIncludeInCash",33+z,language);
                           Log.Message(33+z);
                           ...
                           var IACodeAccountExcel=GetData(filePath_Billing,"Start_periode2MIncludeInCash",34+z,language);
                           Log.Message(34+z);
                           ...
                           var AUMAccountExcel=GetData(filePath_Billing,"Start_periode2MIncludeInCash",35+z,language);
                           Log.Message(35+z);
                           ...
                           var AUMExcludedAccountExcel=GetData(filePath_Billing,"Start_periode2MIncludeInCash",36+z,language);
                           Log.Message(36+z);
                           ...
                           var UMForCalculationAccountExcel=GetData(filePath_Billing,"Start_periode2MIncludeInCash",37+z,language);
                           Log.Message(37+z);
                           ...
                           var WeightingAccountExcel=GetData(filePath_Billing,"Start_periode2MIncludeInCash",38+z,language);
                           Log.Message(38+z);
                           ...
                           var CFAdjustementAccountExcel=GetData(filePath_Billing,"Start_periode2MIncludeInCash",39+z,language);
                           Log.Message(39+z);
                          ...
                          for(var d=0;d<countExplospluscount;d++){  
                           Log.Message(d);
                                     ...
                                     Log.Message(40+z+d+s);
                                      ...
                                      var ClassFeesAccountExcel=GetData(filePath_Billing,"Start_periode2MIncludeInCash",40+z+d+s,language);
                                      ...
                                      var AssetAccountExcel=GetData(filePath_Billing,"Start_periode2MIncludeInCash",41+z+d+s,language);
                                      ...
                                      var AssetValueAccountExcel=GetData(filePath_Billing,"Start_periode2MIncludeInCash",42+z+d+s,language);
                                      ...
                                      var RateAccountExcel=GetData(filePath_Billing,"Start_periode2MIncludeInCash",43+z+d+s,language);
                                      ...
                                      var FeeAccountExcel=GetData(filePath_Billing,"Start_periode2MIncludeInCash",44+z+d+s,language);
                                      ...
                                      var CFAdjustementAccountExcel=GetData(filePath_Billing,"Start_periode2MIncludeInCash",45+z+d+s,language);
                           ...
                           else {Log.Message("Il y a une erreur dans le nombre de la frille de Fees du compte")}
                           //Exploser le -
                          ...
                          // i=i+1
                     //      }
                           var ligneselection=GetData(filePath_Billing,"Start_periode2MIncludeInCash",12+z,language);
             ...
             aqObject.CheckProperty(Get_WinBilling_GrpSummaryCAD_TxtBillingDate(), "WPFControlText", cmpEqual, GetData(filePath_Billing,"Start_periode2MIncludeInCash",2,language));
             
             aqObject.CheckProperty(Get_WinBilling_GrpSummaryCAD_TxtTotalFees(), "Enabled", cmpEqual, true);
             aqObject.CheckProperty(Get_WinBilling_GrpSummaryCAD_TxtTotalFees(), "WPFControlText", cmpEqual, GetData(filePath_Billing,"Start_periode2MIncludeInCash",3,language));
            
             aqObject.CheckProperty( Get_WinBilling_GrpSummaryCAD_TxtIATotalFeesBD88(), "WPFControlText", cmpEqual, GetData(filePath_Billing,"Start_periode2MIncludeInCash",4,language));
             aqObject.CheckProperty( Get_WinBilling_GrpSummaryCAD_TxtIATotalFees9047763(), "WPFControlText", cmpEqual, GetData(filePath_Billing,"Start_periode2MIncludeInCash",5,language));
            ...
            FillTheCashFlowAdjustmen (GetData(filePath_Billing,"RelationBilling",295,language),GetData(filePath_Billing,"RelationBilling",296,language),GetData(filePath_Billing,"RelationBilling",297,language),GetData(filePath_Billing,"RelationBilling",298,language))
            Get_WinDetailedInfo_BtnOK().Click();
            Delay(800)
