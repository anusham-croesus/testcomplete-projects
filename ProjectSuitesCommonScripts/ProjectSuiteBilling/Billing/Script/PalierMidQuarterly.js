...
function PalierMidQuarterly()
{
// en attente de la réponse de Sofia par rapport aux captures d'écran qui sont dans le fichier excel . pour le mois de septembre j'ai les la valeur CF adjustement est différentes 
//et pour le mois de sptembre les valeurs des deux comptes sont différentes 


      try {
           
              // activer la préférence PREF_BILLING_PROCESS pour l'user 
              var RelationShipName=GetData(filePath_Billing,"RelationBilling",129,language)
      ...
      /*
           ...
           UncheckedBillableRelastionShip();
            ...
            Login(vServerBilling, userNameBilling, pswBilling, language);
             ...
             if(client == "BNC")
              {
                var  NameSheetPalierMidQ  =  "PalierMidQBNC"
                
                
              }
              if(client == "US")
              {
                var  NameSheetPalierMidQ  = "PalierMidQ"
            ...
            SearchRelationshipByName(GetData(filePath_Billing,"RelationBilling",129,language));
            Delay(800)
          // double click sur la relation Billing Relation
            Get_RelationshipsClientsAccountsGrid().Find("Value",GetData(filePath_Billing,"RelationBilling",129,language),100).DblClick();
            Delay(3000);
             ...
             if(client == "US"){
              if(count== 8 ) {
                    for(i=0;i<count;i++)
                    {
                           ...
                           var relationShipExcel=GetData(filePath_Billing,"RelationBilling",129,language)
                           
                           var messagesExcel=GetData(filePath_Billing,NameSheetPalierMidQ,2+i,language)
                           Log.Message(2+i)
...
// click sur la premiére ligne de la partie de relationShips
                    ...
                    Get_WinBilling_GrpRelationships_DgvRelationships().WPFObject("RecordListControl", "", 1).Find("Value",GetData(filePath_Billing,NameSheetPalierMidQ,17+z,language),100).Click();
                    Log.Message(17+z);
                    Delay(300);
                    ...
                    Delay(300);
                          ...
                          Delay(200)
                           ...
                           var includedExcel=GetData(filePath_Billing,NameSheetPalierMidQ,14+z,language)
                           Log.Message(14+z);
                           ...
                           var relationshipNamExel=GetData(filePath_Billing,NameSheetPalierMidQ,15+z,language);
                           Log.Message(15+z);
                           ...
                           var BilledOn=GetData(filePath_Billing,NameSheetPalierMidQ,17+z,language);
                           Log.Message(17+z);
                           ...
                           var LastBillingOn=GetData(filePath_Billing,NameSheetPalierMidQ,18+z,language);
                           Log.Message(18+z);
                           ...
                           var aumExcel=GetData(filePath_Billing,NameSheetPalierMidQ,19+z,language);
                           Log.Message(19+z);
                           ...
                           var FeesExcel=GetData(filePath_Billing,NameSheetPalierMidQ,20+z,language);
                           Log.Message(20+z);
                           ...
                           var CurrencyExcel=GetData(filePath_Billing,NameSheetPalierMidQ,21+z,language);
                           Log.Message(21+z);
                           ...
                           var aumFirmCurrencyExcel=GetData(filePath_Billing,NameSheetPalierMidQ,22+z,language);
                           Log.Message(22+z);
                           ...
                           var CurrencyfirmeExcel=GetData(filePath_Billing,NameSheetPalierMidQ,23+z,language);
                           Log.Message(23+z);
                           ...
                           var AUMExcludedExcel=GetData(filePath_Billing,NameSheetPalierMidQ,24+z,language);
                           Log.Message(24+z);
                           ...
                           var AUMForCalculationExcel=GetData(filePath_Billing,NameSheetPalierMidQ,25+z,language);
                           Log.Message(25+z);
                           ...
                           var AUMforFirmCurrExcel=GetData(filePath_Billing,NameSheetPalierMidQ,26+z,language);
                           Log.Message(26+z);
                           ...
                           var FrequencyExcel=GetData(filePath_Billing,NameSheetPalierMidQ,27+z,language);
                           Log.Message(27+z);
                           ...
                           var periodeExcel=GetData(filePath_Billing,NameSheetPalierMidQ,28+z,language);
                           Log.Message(28+z);
                           ...
                           var IAcodeExcel=GetData(filePath_Billing,NameSheetPalierMidQ,29+z,language);
                           Log.Message(29+z);
                           ...
                           var NombreCompteExcel=GetData(filePath_Billing,NameSheetPalierMidQ,30+z,language);
                           Log.Message(30+z);
                           ...
                           var CFAdjustementExcel=GetData(filePath_Billing,NameSheetPalierMidQ,31+z,language);
                           Log.Message(31+z);
...
for(var j=0;j<countFees;j++){ 
    // Vérifier la partie Fees de la ligne sélectionnée
                           ...
                           var AssetValueExcel=GetData(filePath_Billing,NameSheetPalierMidQ,32+z+i,language);
                           Log.Message(32+z+i)
                           ...
                           var RateExcel=GetData(filePath_Billing,NameSheetPalierMidQ,33+z+i,language);
                           Log.Message(33+z+i)
                           ...
                           var FeesExcel=GetData(filePath_Billing,NameSheetPalierMidQ,34+z+i,language);
                           Log.Message(34+z+i)
                           ...
                           var CurrencyRelationShipFeesExcel=GetData(filePath_Billing,NameSheetPalierMidQ,35+z+i,language);
                           Log.Message(35+z+i)
                         ...
                         // Vérifier la partie des comptes
                           ...
                           var IncludedAccomptExcel=GetData(filePath_Billing,NameSheetPalierMidQ,56+z+c,language);
                           Log.Message(56+z+c);
                           ...
                           var AccountNubrAccountExcel=GetData(filePath_Billing,NameSheetPalierMidQ,57+z+c,language);
                           Log.Message(57+z+c);
                           ...
                           var ClientNameAccountExcel=GetData(filePath_Billing,NameSheetPalierMidQ,58+z+c,language);
                           Log.Message(58+z+c);
                           ...
                           var BilledFeesAccountExcel=GetData(filePath_Billing,NameSheetPalierMidQ,59+z+c,language);
                           Log.Message(59+z+c);
                           ...
                           var SpecialFeesAccountExcel=GetData(filePath_Billing,NameSheetPalierMidQ,60+z+c,language);
                           Log.Message(60+z+c);
                          ...
                          //Vérifier Currency
                           ...
                           var CurrencyAccountExcel=GetData(filePath_Billing,NameSheetPalierMidQ,61+z+c,language);
                           Log.Message(61+z+c);
                           ...
                           var BilledAccountAccountExcel=GetData(filePath_Billing,NameSheetPalierMidQ,62+z+c,language);
                           Log.Message(62+z+c);
                           ...
                           var BilledonAccountExcel=GetData(filePath_Billing,NameSheetPalierMidQ,63+z+c,language);
                           Log.Message(63+z+c);
                           ...
                           var IACodeAccountExcel=GetData(filePath_Billing,NameSheetPalierMidQ,64+z+c,language);
                           Log.Message(64+z+c);
                           ...
                           var AUMAccountExcel=GetData(filePath_Billing,NameSheetPalierMidQ,65+z+c,language);
                           Log.Message(65+z+c);
                           ...
                           var AUMExcludedAccountExcel=GetData(filePath_Billing,NameSheetPalierMidQ,66+z+c,language);
                           Log.Message(66+z+c);
                           ...
                           var UMForCalculationAccountExcel=GetData(filePath_Billing,NameSheetPalierMidQ,67+z+c,language);
                           Log.Message(67+z+c);
                           ...
                           var WeightingAccountExcel=GetData(filePath_Billing,NameSheetPalierMidQ,68+z+c,language);
                           Log.Message(68+z+c);
                           ...
                           var CFAdjustementAccountExcel=GetData(filePath_Billing,NameSheetPalierMidQ,69+z+c,language);
                           Log.Message(69+z+c);
                           CheckEquals(VarToStr(CFAdjustementAccount),VarToStr(CFAdjustementAccountExcel), "Valeur de CF Adjustement");
                            
                          Delay(200);
                          c=c+14;}
                           var ligneselection=GetData(filePath_Billing,NameSheetPalierMidQ,17+z,language);
            ...
            Get_WinDetailedInfo_TabBillingForRelationship().Click();
            Delay(800)
            FillTheCashFlowAdjustmen (GetData(filePath_Billing,"RelationBilling",247,language),GetData(filePath_Billing,"RelationBilling",248,language),GetData(filePath_Billing,"RelationBilling",249,language),GetData(filePath_Billing,"RelationBilling",250,language))
