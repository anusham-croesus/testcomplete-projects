...
/* Description : 
- Ajouter une relation R6 puis OK;
- Selctionner R6 puis cocher 'Billable Relationship' puis 'Apply'
- Selectionner l'onglet billing.
- Remplir les valeurs d'entrées. 
- Cliquer sur le bouton 'history'.
- Apply puis OK.
- Aller a Tools/billing 
- Month-end billing:Décembre 2009 puis cocher Quarterly OK
...
Comptes:80059-SF, 800284-OB et 800072-SF
Billing Start Date:01 Mars 2009
...
Analyste d'automatisation: Sana Ayaz */
 ...
 function CR1006_1006_2_Creat_Relati_Billabl_Quarterly_Methodofcalculationbylevel()
  {
      try {
      
           EmptyBillingHistory();
           var reportName = "Management Fees_Billing_KEYNEJ_1006_2";
          ...
          // activer la préférence PREF_BILLING_PROCESS pour l'user KEYNEJ
           /* Activate_Inactivate_PrefBranch("0","PREF_BILLING_PROCESS","SYSADM,FIRMADM",vServerBilling);
            ...
            UncheckedAUMBillable();
             ...
             var RelationshipName=GetData(filePath_Billing,"RelationBilling",26,language)
            var IACode=GetData(filePath_Billing,"RelationBilling",15,language)
            
            var CmbFrequency= GetData(filePath_Billing,"RelationBilling",8,language)
            var CmbFrequency_Month=GetData(filePath_Billing,"RelationBilling",32,language)
            ...
            SearchRelationshipByName(GetData(filePath_Billing,"RelationBilling",26,language));
            Delay(3000)
          //Assigner les trois compts suivants: 800077-SF,800238-OB et 800238-SF  a la relation relationship Billing

            
            JoinAccountToRelationship(GetData(filePath_Billing,"WinAssignCompte",13,language),RelationshipName)
            JoinAccountToRelationship(GetData(filePath_Billing,"WinAssignCompte",17,language),RelationshipName)
            JoinAccountToRelationship(GetData(filePath_Billing,"WinAssignCompte",11,language),RelationshipName)
            Delay(3000)
        
            // double click sur la relation Billing Relation
            Get_RelationshipsClientsAccountsGrid().Find("Value",GetData(filePath_Billing,"RelationBilling",26,language),100).DblClick();
            ...
            Delay(3000)
             ...
             FillInTheBottomPartOfAccounts(442);
            ...
            var countBilling = Get_WinBillingHistory_GrpBilling_DgvBilling().WPFObject("RecordListControl", "", 1).Items.Count;
             if(countBilling == "4") Log.Checkpoint("Le nombre des éléments de la grille de billing est correcte");
          ...
          var BilledOn=GetData(filePath_Billing,"CR1006-2",2+z,language);
          ...
          CheckEquals(VarToString(Billed),BilledOn, "Valeur de Billed on");
           ...
           var aumExcel=GetData(filePath_Billing,"CR1006-2",3+z,language);
          ...
          var FeesExcel=GetData(filePath_Billing,"CR1006-2",4+z,language);
          ...
          CheckEquals(VarToFloat(Fees),VarToFloat(FeesExcel), "Valeur de Fees");
           ...
           var periodeExcel=GetData(filePath_Billing,"CR1006-2",5+z,language);
         ...
         var relationshipNamExel=GetData(filePath_Billing,"CR1006-2",6+z,language);
         ...
         CheckEquals(relationshipNam,relationshipNamExel, "Le nom de la relation");
          ...
          var CFAdjustementExcel=GetData(filePath_Billing,"CR1006-2",7+z,language);
         ...
         for(var i=0;i<countAcccount;i++){ 
                           ...
                           var IncludedAccomptExcel=GetData(filePath_Billing,"CR1006-2",31+j,language);
                           ...
                           var AccountNubrAccountExcel=GetData(filePath_Billing,"CR1006-2",32+j,language);
                           ...
                           var ClientNameAccountExcel=GetData(filePath_Billing,"CR1006-2",33+j,language);
                           ...
                           var BilledFeesAccountExcel=GetData(filePath_Billing,"CR1006-2",34+j,language);
                           ...
                           var SpecialFeesAccountExcel=GetData(filePath_Billing,"CR1006-2",35+j,language);
                          ...
                          //Vérifier Currency
                           ...
                           var CurrencyAccountExcel=GetData(filePath_Billing,"CR1006-2",36+j,language);
                           ...
                           var BilledAccountAccountExcel=GetData(filePath_Billing,"CR1006-2",37+j,language);
                           ...
                           var BilledonAccountExcel=GetData(filePath_Billing,"CR1006-2",38+j,language);
                           ...
                           var IACodeAccountExcel=GetData(filePath_Billing,"CR1006-2",39+j,language);
                           ...
                           var AUMAccountExcel=GetData(filePath_Billing,"CR1006-2",40+j,language);
                           ...
                           var AUMExcludedAccountExcel=GetData(filePath_Billing,"CR1006-2",41+j,language);
                           ...
                           var UMForCalculationAccountExcel=GetData(filePath_Billing,"CR1006-2",42+j,language);
                           ...
                           var WeightingAccountExcel=GetData(filePath_Billing,"CR1006-2",43+j,language);
                           ...
                           var CFAdjustementAccountExcel=GetData(filePath_Billing,"CR1006-2",44+j,language);
  ...
  //Vérifier les données de Summary
         ...
         aqObject.CheckProperty(Get_WinBillingHistory_GrpSummary_LblCurrentAUM(), "WPFControlText", cmpEqual, GetData(filePath_Billing,"CR1006-2",80,language));
         aqObject.CheckProperty(Get_WinBillingHistory_GrpSummary_LlbCalculate(), "Enabled", cmpEqual, true);
         aqObject.CheckProperty(Get_WinBillingHistory_GrpSummary_LlbCalculate(), "WPFControlText", cmpEqual, GetData(filePath_Billing,"CR1006-2",81,language));
         
         
         aqObject.CheckProperty(Get_WinBillingHistory_GrpSummary_LblLastBillingAUM(), "Enabled", cmpEqual, true);
         aqObject.CheckProperty(Get_WinBillingHistory_GrpSummary_LblLastBillingAUM(), "WPFControlText", cmpEqual, GetData(filePath_Billing,"CR1006-2",82,language));
         aqObject.CheckProperty(Get_WinBillingHistory_GrpSummary_TxtLastBillingAUM(), "Enabled", cmpEqual, true);
         aqObject.CheckProperty(Get_WinBillingHistory_GrpSummary_TxtLastBillingAUM(), "WPFControlText", cmpEqual, GetData(filePath_Billing,"CR1006-2",83,language)); 
         
         aqObject.CheckProperty(Get_WinBillingHistory_GrpSummary_LblLastBillingDate(), "Enabled", cmpEqual, true);
         aqObject.CheckProperty(Get_WinBillingHistory_GrpSummary_LblLastBillingDate(), "WPFControlText", cmpEqual, GetData(filePath_Billing,"CR1006-2",84,language));
         aqObject.CheckProperty(Get_WinBillingHistory_GrpSummary_TxtLastBillingDate(), "Enabled", cmpEqual, true);
         aqObject.CheckProperty(Get_WinBillingHistory_GrpSummary_TxtLastBillingDate(), "Text", cmpEqual, GetData(filePath_Billing,"CR1006-2",85,language));
         
         aqObject.CheckProperty(Get_WinBillingHistory_GrpSummary_LblFeesSinceTheBeginning(), "Enabled", cmpEqual, true);
         aqObject.CheckProperty(Get_WinBillingHistory_GrpSummary_LblFeesSinceTheBeginning(), "Text", cmpEqual, GetData(filePath_Billing,"CR1006-2",86,language));
         aqObject.CheckProperty(Get_WinBillingHistory_GrpSummary_TxtFeesSinceTheBeginning(), "Enabled", cmpEqual, true);
         aqObject.CheckProperty(Get_WinBillingHistory_GrpSummary_TxtFeesSinceTheBeginning(), "Text", cmpEqual, GetData(filePath_Billing,"CR1006-2",87,language));
         
         aqObject.CheckProperty(Get_WinBillingHistory_GrpSummary_LblFeesSinceTheBeginningOfTheYear(), "Enabled", cmpEqual, true);
         aqObject.CheckProperty(Get_WinBillingHistory_GrpSummary_LblFeesSinceTheBeginningOfTheYear(), "Text", cmpEqual, GetData(filePath_Billing,"CR1006-2",88,language));
         aqObject.CheckProperty(Get_WinBillingHistory_GrpSummary_TxtFeesSinceTheBeginningOfTheYear(), "Enabled", cmpEqual, true); 
         aqObject.CheckProperty(Get_WinBillingHistory_GrpSummary_TxtFeesSinceTheBeginningOfTheYear(), "Text", cmpEqual, GetData(filePath_Billing,"CR1006-2",89,language));
         ...
         aqObject.CheckProperty(Get_WinBillingHistory_GrpSummary_LblMessage(), "WPFControlText", cmpEqual, "The fees displayed have been generated but not necessarily billed.\r\nVerify all transactions on the statement to confirm fees have been billed.");
           ...
           Terminate_CroesusProcess();
            ...
            Login(vServerBilling, userNameBilling, pswBilling, language);
            DeleteRelationship(GetData(filePath_Billing,"RelationBilling",26,language));
            Close_Croesus_MenuBar();
