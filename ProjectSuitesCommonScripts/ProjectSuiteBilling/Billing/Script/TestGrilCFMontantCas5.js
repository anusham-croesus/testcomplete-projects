...
-Cash Flow Adjustement: percentage/Inflow : 100, percentage/Outflow:100, Amount/Inflow:1,000.00 et Amount/OutFlow=16,131.16
...
-Il faut vérifier que sur la partie des Messages il y a 2 messages qui sont affichés
...
Analyste d'automatisation: Sana Ayaz */
 ...
 function TestGrilCFMontantCas5()
  {
      try {
            ...
            var TxtAmountInflow=GetData(filePath_Billing,"RelationBilling",53,language)
            var TxtAmountOutflow=GetData(filePath_Billing,"RelationBilling",89,language)	
           ...
           WaitUntilCroesusDialogBoxClose();
             ...
             if(count==2)
             {
                    for(i=0;i<count;i++)
                    {
                           ...
                           var messagesExcel=GetData(filePath_Billing,"RelationBilling",86+i,language)
                 ...
                 if(count==2)
             {
                    for(i=0;i<count;i++)
                    {
                           ...
                           var messagesExcel=GetData(filePath_Billing,"RelationBilling",388+i,language)
