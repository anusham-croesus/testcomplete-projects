...
function PalierDailyAvergeMonthly()
{
      ...
      try {
              ...
              var RelationShipName=GetData(filePath_Billing,"RelationBilling",110,language)
      ...
      /*
           ...
           UncheckedBillableRelastionShip();
            ...
            if(client == "BNC")
              {
                var  NameSheetPalierDailyAvergeMonth  ="PalierDailyAvergeMonthBNC"
                
              }
              if(client == "US")
              {
                var  NameSheetPalierDailyAvergeMonth  ="PalierDailyAvergeMonth"
              }
            
            Delay(1000);
              //ouvrir le module relation
            Get_ModulesBar_BtnRelationships().Click();
            SearchRelationshipByName(GetData(filePath_Billing,"RelationBilling",110,language));
            Delay(800)
          // double click sur la relation Billing Relation
            Get_RelationshipsClientsAccountsGrid().Find("Value",GetData(filePath_Billing,"RelationBilling",110,language),100).DblClick();
            Delay(3000);
           ...
           // FillInTheBottomPartOfAccounts(16);
            FillRelationshipBillingTab([GetData(filePath_Billing,"WinAssignCompte",46,language)], GetData(filePath_Billing,"RelationBilling",63,language))
...
// click sur la premiére ligne de la partie de relationShips
                    ...
                    Get_WinBilling_GrpRelationships_DgvRelationships().WPFObject("RecordListControl", "", 1).Find("Value",GetData(filePath_Billing,NameSheetPalierDailyAvergeMonth,17+z,language),100).Click();
                    Log.Message(17+z);
                    Delay(300);
                    ...
                    Delay(300);
                          ...
                          Delay(200)
                           ...
                           var includedExcel=GetData(filePath_Billing,NameSheetPalierDailyAvergeMonth,14+z,language)
                           Log.Message(14+z);
                           ...
                           var relationshipNamExel=GetData(filePath_Billing,NameSheetPalierDailyAvergeMonth,15+z,language);
                           Log.Message(15+z);
                           ...
                           var BilledOn=GetData(filePath_Billing,NameSheetPalierDailyAvergeMonth,17+z,language);
                           Log.Message(17+z);
                           ...
                           var LastBillingOn=GetData(filePath_Billing,NameSheetPalierDailyAvergeMonth,18+z,language);
                           Log.Message(18+z);
                           ...
                           var aumExcel=GetData(filePath_Billing,NameSheetPalierDailyAvergeMonth,19+z,language);
                           Log.Message(19+z);
                           ...
                           var FeesExcel=GetData(filePath_Billing,NameSheetPalierDailyAvergeMonth,20+z,language);
                           Log.Message(20+z);
                           ...
                           var CurrencyExcel=GetData(filePath_Billing,NameSheetPalierDailyAvergeMonth,21+z,language);
                           Log.Message(21+z);
                           ...
                           var aumFirmCurrencyExcel=GetData(filePath_Billing,NameSheetPalierDailyAvergeMonth,22+z,language);
                           Log.Message(22+z);
                           ...
                           var CurrencyfirmeExcel=GetData(filePath_Billing,NameSheetPalierDailyAvergeMonth,23+z,language);
                           Log.Message(23+z);
                           ...
                           var AUMExcludedExcel=GetData(filePath_Billing,NameSheetPalierDailyAvergeMonth,24+z,language);
                           Log.Message(24+z);
                           ...
                           var AUMForCalculationExcel=GetData(filePath_Billing,NameSheetPalierDailyAvergeMonth,25+z,language);
                           Log.Message(25+z);
                           ...
                           var AUMforFirmCurrExcel=GetData(filePath_Billing,NameSheetPalierDailyAvergeMonth,26+z,language);
                           Log.Message(26+z);
                           ...
                           var FrequencyExcel=GetData(filePath_Billing,NameSheetPalierDailyAvergeMonth,27+z,language);
                           Log.Message(27+z);
                           ...
                           var periodeExcel=GetData(filePath_Billing,NameSheetPalierDailyAvergeMonth,28+z,language);
                           Log.Message(28+z);
                           ...
                           var IAcodeExcel=GetData(filePath_Billing,NameSheetPalierDailyAvergeMonth,29+z,language);
                           Log.Message(29+z);
                           ...
                           var NombreCompteExcel=GetData(filePath_Billing,NameSheetPalierDailyAvergeMonth,30+z,language);
                           Log.Message(30+z);
                           ...
                           var CFAdjustementExcel=GetData(filePath_Billing,NameSheetPalierDailyAvergeMonth,31+z,language);
                           Log.Message(31+z);
...
for(var j=0;j<countFees;j++){ 
    // Vérifier la partie Fees de la ligne sélectionnée
                           ...
                           var AssetValueExcel=GetData(filePath_Billing,NameSheetPalierDailyAvergeMonth,32+z+i,language);
                           Log.Message(32+z+i)
                           ...
                           var RateExcel=GetData(filePath_Billing,NameSheetPalierDailyAvergeMonth,33+z+i,language);
                           Log.Message(33+z+i)
                           ...
                           var FeesExcel=GetData(filePath_Billing,NameSheetPalierDailyAvergeMonth,34+z+i,language);
                           Log.Message(34+z+i)
                           ...
                           var CurrencyRelationShipFeesExcel=GetData(filePath_Billing,NameSheetPalierDailyAvergeMonth,35+z+i,language);
                           Log.Message(35+z+i)
                         ...
                         // Vérifier la partie des comptes
                           ...
                           var IncludedAccomptExcel=GetData(filePath_Billing,NameSheetPalierDailyAvergeMonth,56+z,language);
                           Log.Message(56+z);
                           ...
                           var AccountNubrAccountExcel=GetData(filePath_Billing,NameSheetPalierDailyAvergeMonth,57+z,language);
                           Log.Message(57+z);
                           ...
                           var ClientNameAccountExcel=GetData(filePath_Billing,NameSheetPalierDailyAvergeMonth,58+z,language);
                           Log.Message(58+z);
                           ...
                           var BilledFeesAccountExcel=GetData(filePath_Billing,NameSheetPalierDailyAvergeMonth,59+z,language);
                           Log.Message(59+z);
                           ...
                           var SpecialFeesAccountExcel=GetData(filePath_Billing,NameSheetPalierDailyAvergeMonth,60+z,language);
                           Log.Message(60+z);
                          ...
                          //Vérifier Currency
                           ...
                           var CurrencyAccountExcel=GetData(filePath_Billing,NameSheetPalierDailyAvergeMonth,61+z,language);
                           Log.Message(61+z);
                           ...
                           var BilledAccountAccountExcel=GetData(filePath_Billing,NameSheetPalierDailyAvergeMonth,62+z,language);
                           Log.Message(62+z);
                           ...
                           var BilledonAccountExcel=GetData(filePath_Billing,NameSheetPalierDailyAvergeMonth,63+z,language);
                           Log.Message(63+z);
                           ...
                           var IACodeAccountExcel=GetData(filePath_Billing,NameSheetPalierDailyAvergeMonth,64+z,language);
                           Log.Message(64+z);
                           ...
                           var AUMAccountExcel=GetData(filePath_Billing,NameSheetPalierDailyAvergeMonth,65+z,language);
                           Log.Message(65+z);
                           ...
                           var AUMExcludedAccountExcel=GetData(filePath_Billing,NameSheetPalierDailyAvergeMonth,66+z,language);
                           Log.Message(66+z);
                           ...
                           var UMForCalculationAccountExcel=GetData(filePath_Billing,NameSheetPalierDailyAvergeMonth,67+z,language);
                           Log.Message(67+z);
                           ...
                           var WeightingAccountExcel=GetData(filePath_Billing,NameSheetPalierDailyAvergeMonth,68+z,language);
                           Log.Message(68+z);
                           ...
                           var CFAdjustementAccountExcel=GetData(filePath_Billing,NameSheetPalierDailyAvergeMonth,69+z,language);
                           Log.Message(69+z);
                           CheckEquals(VarToStr(CFAdjustementAccount),VarToStr(CFAdjustementAccountExcel), "Valeur de CF Adjustement");
                            
                          Delay(200);
                  
                           var ligneselection=GetData(filePath_Billing,NameSheetPalierDailyAvergeMonth,17+z,language);
