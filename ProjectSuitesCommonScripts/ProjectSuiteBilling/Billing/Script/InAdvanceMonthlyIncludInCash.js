...
function InAdvanceMonthlyIncludInCash()
{
      ...
      try {
          ...
          // double click sur la relation Billing Relation
           ...
           CheckPointsMessageByMonthInAdvanceMIncludCas("03","InAdvanceMonthlyMarsIncludInCas",123,2)
           CheckPointsRelationsShipsAccountsBillingIntervalOneAccount("InAdvanceMonthlyMarsIncludInCas");
           ...
           //Choisir le mois avril 
            ...
            ChangeFrequencyDateBillingParameters(Get_WinBillingParameters_RdoInAdvance(),Get_Calendar_LstYears_Item("2009"),Get_Calendar_LstMonths_ItemApril(),Get_WinBillingParameters_GrpFrequencies_ChkMonthly())
              ...
              // Les points de vérifications pour les messages affichés sur la partie Messages de la fenêtre Billing
           CheckPointsMessageByMonthInAdvanceMIncludCas("04","InAdvanceMonthlyAvriIncludInCas",123,2)
           CheckPointsRelationsShipsAccountsBillingIntervalOneAccount("InAdvanceMonthlyAvriIncludInCas");
           GeneratExportPDFCloseReport();
            ...
            ChangeFrequencyDateBillingParameters(Get_WinBillingParameters_RdoInAdvance(),Get_Calendar_LstYears_Item("2009"),Get_Calendar_LstMonths_ItemMay(),Get_WinBillingParameters_GrpFrequencies_ChkMonthly())
              ...
              // Les points de vérifications pour les messages affichés sur la partie Messages de la fenêtre Billing
           CheckPointsMessageByMonthInAdvanceMIncludCas("05","InAdvanceMonthlyMaiIncludInCas","123","2")
           CheckPointsRelationsShipsAccountsBillingIntervalOneAccount("InAdvanceMonthlyMaiIncludInCas");
           GeneratExportPDFCloseReport();
           ...
           //Choisir le mois Juin 
            ...
            ChangeFrequencyDateBillingParameters(Get_WinBillingParameters_RdoInAdvance(),Get_Calendar_LstYears_Item("2009"),Get_Calendar_LstMonths_ItemJune(),Get_WinBillingParameters_GrpFrequencies_ChkMonthly())
              ...
              // Les points de vérifications pour les messages affichés sur la partie Messages de la fenêtre Billing
           CheckPointsMessageByMonthInAdvanceMIncludCas("06","InAdvanceMonthlyJuinIncludInCas","123","2")
           CheckPointsRelationsShipsAccountsBillingIntervalOneAccount("InAdvanceMonthlyJuinIncludInCas");
           GeneratExportPDFCloseReport();
           ...
           CheckPointsMessageByMonthInAdvanceMIncludCas("07","InAdvanceMonthlyJuilIncludInCas","123","2")
           CheckPointsRelationsShipsAccountsBillingIntervalOneAccount("InAdvanceMonthlyJuilIncludInCas");
           GeneratExportPDFCloseReport();
           ...
           //Choisir le mois aout 
            ...
            ChangeFrequencyDateBillingParameters(Get_WinBillingParameters_RdoInAdvance(),Get_Calendar_LstYears_Item("2009"),Get_Calendar_LstMonths_ItemAugust(),Get_WinBillingParameters_GrpFrequencies_ChkMonthly())
              ...
              // Les points de vérifications pour les messages affichés sur la partie Messages de la fenêtre Billing
           CheckPointsMessageByMonthInAdvanceMIncludCas("08","InAdvanceMonthlyAugtIncludInCas","123","2")
           CheckPointsRelationsShipsAccountsBillingIntervalOneAccount("InAdvanceMonthlyAugtIncludInCas");
           GeneratExportPDFCloseReport();
           ...
           //Choisir le mois septembre 
            ...
            ChangeFrequencyDateBillingParameters(Get_WinBillingParameters_RdoInAdvance(),Get_Calendar_LstYears_Item("2009"),Get_Calendar_LstMonths_ItemSeptember(),Get_WinBillingParameters_GrpFrequencies_ChkMonthly())
              ...
              // Les points de vérifications pour les messages affichés sur la partie Messages de la fenêtre Billing
           CheckPointsMessageByMonthInAdvanceMIncludCas("09","InAdvanceMonthlySeptIncludInCas","123","2")
           CheckPointsRelationsShipsAccountsBillingIntervalOneAccount("InAdvanceMonthlySeptIncludInCas");
