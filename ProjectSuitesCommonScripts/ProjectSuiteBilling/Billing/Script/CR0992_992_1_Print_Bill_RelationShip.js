...
-Cocher 'Include Grid'puis OK-OK
...
Analyste d'automatisation: Sana Ayaz */
 ...
 function CR0992_992_1_Print_Bill_RelationShip()
  {
      try {
      
           EmptyBillingHistory();
          
           var reportName = "Management Fees_Billing_KEYNEJ_992_1";
           var folderName = ("Rapport" + GetVServerExcel(filePath_ExecutionVServers, "COMMON_SCRIPTS", 0, 11));
           Delay(3000);
           Log.Message(Project.Path + folderName+"\\");
           Delay(3000)
