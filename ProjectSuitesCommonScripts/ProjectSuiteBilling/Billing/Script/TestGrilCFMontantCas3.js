...
-Cash Flow Adjustement: percentage/Inflow : 100, percentage/Outflow:100, Amount/Inflow:1,000.00 et Amount/OutFlow=8,000.00
...
-Il faut vérifier que sur la partie des Messages il y a 4 messages qui sont affichés
...
Analyste d'automatisation: Sana Ayaz */
 ...
 function TestGrilCFMontantCas3()
  {
      try {
            ...
            var TxtAmountOutflow=GetData(filePath_Billing,"RelationBilling",54,language)			
            ...
            WaitUntilCroesusDialogBoxClose();
             ...
             if(count==4)
             {
                    for(i=0;i<count;i++)
                    {
                           ...
                           var messagesExcel=GetData(filePath_Billing,"RelationBilling",77+i,language)
               ...
               if(count==3)
             {
                    for(i=0;i<count;i++)
                    {
                           ...
                           var messagesExcel=GetData(filePath_Billing,"RelationBilling",373+i,language)
