...
function DailyAverg2MonIncludInAssetClass()
{
      ...
      try {
              ...
              var RelationShipName=GetData(filePath_Billing,"RelationBilling",117,language)
           ...
           UncheckedBillableRelastionShip();
            ...
            SearchRelationshipByName(GetData(filePath_Billing,"RelationBilling",117,language));
            Delay(800)
          // double click sur la relation Billing Relation
            Get_RelationshipsClientsAccountsGrid().Find("Value",GetData(filePath_Billing,"RelationBilling",117,language),100).DblClick();
            Delay(3000);
           ...
           // FillInTheBottomPartOfAccounts(16);
            FillRelationshipBillingTab([GetData(filePath_Billing,"WinAssignCompte",56,language)], GetData(filePath_Billing,"RelationBilling",10,language))
...
// click sur la premiére ligne de la partie de relationShips
                    ...
                    Get_WinBilling_GrpRelationships_DgvRelationships().WPFObject("RecordListControl", "", 1).Find("Value",GetData(filePath_Billing,"DailyAverge2MonIncludInAssetCl",17+z,language),100).Click();
                    Log.Message(17+z);
                    Delay(300);
                    ...
                    Delay(300);
                          ...
                          Delay(200)
                           ...
                           var includedExcel=GetData(filePath_Billing,"DailyAverge2MonIncludInAssetCl",14+z,language)
                           Log.Message(14+z);
                           ...
                           var relationshipNamExel=GetData(filePath_Billing,"DailyAverge2MonIncludInAssetCl",15+z,language);
                           Log.Message(15+z);
                           ...
                           var BilledOn=GetData(filePath_Billing,"DailyAverge2MonIncludInAssetCl",17+z,language);
                           Log.Message(17+z);
                           ...
                           var LastBillingOn=GetData(filePath_Billing,"DailyAverge2MonIncludInAssetCl",18+z,language);
                           Log.Message(18+z);
                           ...
                           var aumExcel=GetData(filePath_Billing,"DailyAverge2MonIncludInAssetCl",19+z,language);
                           Log.Message(19+z);
                           ...
                           var FeesExcel=GetData(filePath_Billing,"DailyAverge2MonIncludInAssetCl",20+z,language);
                           Log.Message(20+z);
                           ...
                           var CurrencyExcel=GetData(filePath_Billing,"DailyAverge2MonIncludInAssetCl",21+z,language);
                           Log.Message(21+z);
                           ...
                           var aumFirmCurrencyExcel=GetData(filePath_Billing,"DailyAverge2MonIncludInAssetCl",22+z,language);
                           Log.Message(22+z);
                           ...
                           var CurrencyfirmeExcel=GetData(filePath_Billing,"DailyAverge2MonIncludInAssetCl",23+z,language);
                           Log.Message(23+z);
                           ...
                           var AUMExcludedExcel=GetData(filePath_Billing,"DailyAverge2MonIncludInAssetCl",24+z,language);
                           Log.Message(24+z);
                           ...
                           var AUMForCalculationExcel=GetData(filePath_Billing,"DailyAverge2MonIncludInAssetCl",25+z,language);
                           Log.Message(25+z);
                           ...
                           var AUMforFirmCurrExcel=GetData(filePath_Billing,"DailyAverge2MonIncludInAssetCl",26+z,language);
                           Log.Message(26+z);
                           ...
                           var FrequencyExcel=GetData(filePath_Billing,"DailyAverge2MonIncludInAssetCl",27+z,language);
                           Log.Message(27+z);
                           ...
                           var periodeExcel=GetData(filePath_Billing,"DailyAverge2MonIncludInAssetCl",28+z,language);
                           Log.Message(28+z);
                           ...
                           var IAcodeExcel=GetData(filePath_Billing,"DailyAverge2MonIncludInAssetCl",29+z,language);
                           Log.Message(29+z);
                           ...
                           var NombreCompteExcel=GetData(filePath_Billing,"DailyAverge2MonIncludInAssetCl",30+z,language);
                           Log.Message(30+z);
                           ...
                           var CFAdjustementExcel=GetData(filePath_Billing,"DailyAverge2MonIncludInAssetCl",31+z,language);
                           Log.Message(31+z);
...
for(var j=0;j<countFees;j++){ 
    // Vérifier la partie Fees de la ligne sélectionnée
                           ...
                           var AssetValueExcel=GetData(filePath_Billing,"DailyAverge2MonIncludInAssetCl",32+z+i,language);
                           Log.Message(32+z+i)
                           ...
                           var RateExcel=GetData(filePath_Billing,"DailyAverge2MonIncludInAssetCl",33+z+i,language);
                           Log.Message(33+z+i)
                           ...
                           var FeesExcel=GetData(filePath_Billing,"DailyAverge2MonIncludInAssetCl",34+z+i,language);
                           Log.Message(34+z+i)
                           ...
                           var CurrencyRelationShipFeesExcel=GetData(filePath_Billing,"DailyAverge2MonIncludInAssetCl",35+z+i,language);
                           Log.Message(35+z+i)
                         ...
                         // Vérifier la partie des comptes
                           ...
                           var IncludedAccomptExcel=GetData(filePath_Billing,"DailyAverge2MonIncludInAssetCl",56+z,language);
                           Log.Message(56+z);
                           ...
                           var AccountNubrAccountExcel=GetData(filePath_Billing,"DailyAverge2MonIncludInAssetCl",57+z,language);
                           Log.Message(57+z);
                           ...
                           var ClientNameAccountExcel=GetData(filePath_Billing,"DailyAverge2MonIncludInAssetCl",58+z,language);
                           Log.Message(58+z);
                           ...
                           var BilledFeesAccountExcel=GetData(filePath_Billing,"DailyAverge2MonIncludInAssetCl",59+z,language);
                           Log.Message(59+z);
                           ...
                           var SpecialFeesAccountExcel=GetData(filePath_Billing,"DailyAverge2MonIncludInAssetCl",60+z,language);
                           Log.Message(60+z);
                          ...
                          //Vérifier Currency
                           ...
                           var CurrencyAccountExcel=GetData(filePath_Billing,"DailyAverge2MonIncludInAssetCl",61+z,language);
                           Log.Message(61+z);
                           ...
                           var BilledAccountAccountExcel=GetData(filePath_Billing,"DailyAverge2MonIncludInAssetCl",62+z,language);
                           Log.Message(62+z);
                           ...
                           var BilledonAccountExcel=GetData(filePath_Billing,"DailyAverge2MonIncludInAssetCl",63+z,language);
                           Log.Message(63+z);
                           ...
                           var IACodeAccountExcel=GetData(filePath_Billing,"DailyAverge2MonIncludInAssetCl",64+z,language);
                           Log.Message(64+z);
                           ...
                           var AUMAccountExcel=GetData(filePath_Billing,"DailyAverge2MonIncludInAssetCl",65+z,language);
                           Log.Message(65+z);
                           ...
                           var AUMExcludedAccountExcel=GetData(filePath_Billing,"DailyAverge2MonIncludInAssetCl",66+z,language);
                           Log.Message(66+z);
                           ...
                           var UMForCalculationAccountExcel=GetData(filePath_Billing,"DailyAverge2MonIncludInAssetCl",67+z,language);
                           Log.Message(67+z);
                           ...
                           var WeightingAccountExcel=GetData(filePath_Billing,"DailyAverge2MonIncludInAssetCl",68+z,language);
                           Log.Message(68+z);
                           ...
                           var CFAdjustementAccountExcel=GetData(filePath_Billing,"DailyAverge2MonIncludInAssetCl",69+z,language);
                           Log.Message(69+z);
                           CheckEquals(VarToStr(CFAdjustementAccount),VarToStr(CFAdjustementAccountExcel), "Valeur de CF Adjustement");
                            
                          Delay(200);
                  
                           var ligneselection=GetData(filePath_Billing,"DailyAverge2MonIncludInAssetCl",17+z,language);
             ...
             aqObject.CheckProperty(Get_WinBilling_GrpSummaryCAD_TxtBillingDate(), "WPFControlText", cmpEqual, GetData(filePath_Billing,"DailyAverge2MonIncludInAssetCl",193,language));
             
             aqObject.CheckProperty(Get_WinBilling_GrpSummaryCAD_TxtTotalFees(), "Enabled", cmpEqual, true);
             aqObject.CheckProperty(Get_WinBilling_GrpSummaryCAD_TxtTotalFees(), "WPFControlText", cmpEqual, GetData(filePath_Billing,"DailyAverge2MonIncludInAssetCl",194,language));
            
             aqObject.CheckProperty( Get_WinBilling_GrpSummaryCAD_TxtIATotalFeesBD88(), "WPFControlText", cmpEqual, GetData(filePath_Billing,"DailyAverge2MonIncludInAssetCl",195,language));
             aqObject.CheckProperty( Get_WinBilling_GrpSummaryCAD_TxtIATotalFees9047763(), "WPFControlText", cmpEqual, GetData(filePath_Billing,"DailyAverge2MonIncludInAssetCl",196,language));
