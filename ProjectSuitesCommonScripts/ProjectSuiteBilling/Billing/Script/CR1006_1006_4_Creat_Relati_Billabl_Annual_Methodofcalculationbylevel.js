...
- Month-end billing: April, 2009 puis cocher Annual OK
...
Comptes:800047-SF, 800039-OB et 800063-OB
...
Analyste d'automatisation: Sana Ayaz */
 ...
 function CR1006_1006_4_Creat_Relati_Billabl_Annual_Methodofcalculationbylevel()
  {
      try {
           EmptyBillingHistory();
           var reportName = "Management Fees_Billing_KEYNEJ_1006_4";
         ...
         /* Activate_Inactivate_PrefBranch("0","PREF_BILLING_PROCESS","SYSADM,FIRMADM",vServerBilling);
            ...
            var CmbFrequency_Month=GetData(filePath_Billing,"RelationBilling",34,language)
...
//click sur le bouton maximiser pour agrandir la fenêtre Billing History
            ...
            var countBilling = Get_WinBillingHistory_GrpBilling_DgvBilling().WPFObject("RecordListControl", "", 1).Items.Count;
             if(countBilling == "1") Log.Checkpoint("Le nombre des éléments de la grille de billing est correcte");
          ...
          var BilledOn=GetData(filePath_Billing,"CR1006-4",2+z,language);
          ...
          CheckEquals(VarToString(Billed),BilledOn, "Valeur de Billed on");
           ...
           var aumExcel=GetData(filePath_Billing,"CR1006-4",3+z,language);
          ...
          var FeesExcel=GetData(filePath_Billing,"CR1006-4",4+z,language);
          ...
          CheckEquals(VarToFloat(Fees),VarToFloat(FeesExcel), "Valeur de Fees");
           ...
           var periodeExcel=GetData(filePath_Billing,"CR1006-4",5+z,language);
         ...
         var relationshipNamExel=GetData(filePath_Billing,"CR1006-4",6+z,language);
         ...
         CheckEquals(relationshipNam,relationshipNamExel, "Le nom de la relation");
          ...
          var CFAdjustementExcel=GetData(filePath_Billing,"CR1006-4",7+z,language);
         ...
         for(var i=0;i<countAcccount;i++){ 
                           ...
                           var IncludedAccomptExcel=GetData(filePath_Billing,"CR1006-4",14+j,language);
                           ...
                           var AccountNubrAccountExcel=GetData(filePath_Billing,"CR1006-4",15+j,language);
                           ...
                           var ClientNameAccountExcel=GetData(filePath_Billing,"CR1006-4",16+j,language);
                           ...
                           var BilledFeesAccountExcel=GetData(filePath_Billing,"CR1006-4",17+j,language);
                           ...
                           var SpecialFeesAccountExcel=GetData(filePath_Billing,"CR1006-4",18+j,language);
                          ...
                          //Vérifier Currency
                           ...
                           var CurrencyAccountExcel=GetData(filePath_Billing,"CR1006-4",19+j,language);
                           ...
                           var BilledAccountAccountExcel=GetData(filePath_Billing,"CR1006-4",20+j,language);
                           ...
                           var BilledonAccountExcel=GetData(filePath_Billing,"CR1006-4",21+j,language);
                           ...
                           var IACodeAccountExcel=GetData(filePath_Billing,"CR1006-4",22+j,language);
                           ...
                           var AUMAccountExcel=GetData(filePath_Billing,"CR1006-4",23+j,language);
                           ...
                           var AUMExcludedAccountExcel=GetData(filePath_Billing,"CR1006-4",24+j,language);
                           ...
                           var UMForCalculationAccountExcel=GetData(filePath_Billing,"CR1006-4",25+j,language);
                           ...
                           var WeightingAccountExcel=GetData(filePath_Billing,"CR1006-4",26+j,language);
                           ...
                           var CFAdjustementAccountExcel=GetData(filePath_Billing,"CR1006-4",27+j,language);
  ...
  //Vérifier les données de Summary
         ...
         aqObject.CheckProperty(Get_WinBillingHistory_GrpSummary_LblCurrentAUM(), "WPFControlText", cmpEqual, GetData(filePath_Billing,"CR1006-4",62,language));
         aqObject.CheckProperty(Get_WinBillingHistory_GrpSummary_LlbCalculate(), "Enabled", cmpEqual, true);
         aqObject.CheckProperty(Get_WinBillingHistory_GrpSummary_LlbCalculate(), "WPFControlText", cmpEqual, GetData(filePath_Billing,"CR1006-4",63,language));
         
         
         aqObject.CheckProperty(Get_WinBillingHistory_GrpSummary_LblLastBillingAUM(), "Enabled", cmpEqual, true);
         aqObject.CheckProperty(Get_WinBillingHistory_GrpSummary_LblLastBillingAUM(), "WPFControlText", cmpEqual, GetData(filePath_Billing,"CR1006-4",64,language));
         aqObject.CheckProperty(Get_WinBillingHistory_GrpSummary_TxtLastBillingAUM(), "Enabled", cmpEqual, true);
         aqObject.CheckProperty(Get_WinBillingHistory_GrpSummary_TxtLastBillingAUM(), "WPFControlText", cmpEqual, GetData(filePath_Billing,"CR1006-4",65,language)); 
         
         aqObject.CheckProperty(Get_WinBillingHistory_GrpSummary_LblLastBillingDate(), "Enabled", cmpEqual, true);
         aqObject.CheckProperty(Get_WinBillingHistory_GrpSummary_LblLastBillingDate(), "WPFControlText", cmpEqual, GetData(filePath_Billing,"CR1006-4",66,language));
         aqObject.CheckProperty(Get_WinBillingHistory_GrpSummary_TxtLastBillingDate(), "Enabled", cmpEqual, true);
         aqObject.CheckProperty(Get_WinBillingHistory_GrpSummary_TxtLastBillingDate(), "Text", cmpEqual, GetData(filePath_Billing,"CR1006-4",67,language));
         
         aqObject.CheckProperty(Get_WinBillingHistory_GrpSummary_LblFeesSinceTheBeginning(), "Enabled", cmpEqual, true);
         aqObject.CheckProperty(Get_WinBillingHistory_GrpSummary_LblFeesSinceTheBeginning(), "Text", cmpEqual, GetData(filePath_Billing,"CR1006-4",68,language));
         aqObject.CheckProperty(Get_WinBillingHistory_GrpSummary_TxtFeesSinceTheBeginning(), "Enabled", cmpEqual, true);
         aqObject.CheckProperty(Get_WinBillingHistory_GrpSummary_TxtFeesSinceTheBeginning(), "Text", cmpEqual, GetData(filePath_Billing,"CR1006-4",69,language));
         
         aqObject.CheckProperty(Get_WinBillingHistory_GrpSummary_LblFeesSinceTheBeginningOfTheYear(), "Enabled", cmpEqual, true);
         aqObject.CheckProperty(Get_WinBillingHistory_GrpSummary_LblFeesSinceTheBeginningOfTheYear(), "Text", cmpEqual, GetData(filePath_Billing,"CR1006-4",70,language));
         aqObject.CheckProperty(Get_WinBillingHistory_GrpSummary_TxtFeesSinceTheBeginningOfTheYear(), "Enabled", cmpEqual, true); 
         aqObject.CheckProperty(Get_WinBillingHistory_GrpSummary_TxtFeesSinceTheBeginningOfTheYear(), "Text", cmpEqual, GetData(filePath_Billing,"CR1006-4",71,language));
