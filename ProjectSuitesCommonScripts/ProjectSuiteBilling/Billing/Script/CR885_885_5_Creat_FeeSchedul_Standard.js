...
(Name:Standard. 
Access:User 
Rate Pattern:Standard(Intervals & Asset Class))
...
Analyste d'automatisation: Sana Ayaz */
 ...
 function CR885_885_5_Creat_FeeSchedul_Standard()
  {
      ...
      try {          
        // activer la préférence PREF_BILLING_GRID pour l'user Darwic
         ...
         //  Activ_Desact_Pref_Billing("0","PREF_BILLING_FEESCHEDULE","YES",vServerBilling);
           ...
           Login(vServerBilling, userNameBilling, pswBilling, language);
            // Choisir Tools/Configurations/Billing/Manage Billing
             ...
             var NamExcel=GetData(filePath_Billing,"CR885",80,language);
            // Choisir Tools/Configurations/Billing/Manage Billing
         ...
         Delay(400)
          ...
          Get_WinConfigurations().Close();
           ...
           Get_WinFeeTemplateEdit_TxtName().Keys(GetData(filePath_Billing,"CR885",80,language));
          ...
          for (var i=1;i<count+2;i++)
              {
                  ...
                  if(Name==NamExcel)
                      ...
                      aqObject.CheckProperty(Get_WinBillingConfiguration_TabFeeSchedule_DgvFeeTemplateManager().FindChild(["ClrClassName", "WPFControlOrdinalNo"], ["DataRecordPresenter", i], 10).FindChild(["ClrClassName", "WPFControlOrdinalNo"], ["CellValuePresenter", 2], 10).WPFObject("XamTextEditor", "", 1).Value, "OleValue", cmpEqual, GetData(filePath_Billing,"CR885",80,language));
                      ...
                      aqObject.CheckProperty(Get_WinBillingConfiguration_TabFeeSchedule_DgvFeeTemplateManager().FindChild(["ClrClassName", "WPFControlOrdinalNo"], ["DataRecordPresenter", i], 10).FindChild(["ClrClassName", "WPFControlOrdinalNo"], ["CellValuePresenter", 4], 10).WPFObject("XamTextEditor", "", 1).Value, "OleValue", cmpEqual, GetData(filePath_Billing,"CR885",81,language));
        ...
        Login(vServerBilling, userNameBilling, pswBilling, language);
        InitializDataBaseeeFeeSchedul_Standard(NamExcel,count)
  ...
  function Cas885_5()
{
   ...
   function  InitializDataBaseeeFeeSchedul_Standard(NamExcel,count)
  {   
     ClickWinConfigurationsManageBilling();
