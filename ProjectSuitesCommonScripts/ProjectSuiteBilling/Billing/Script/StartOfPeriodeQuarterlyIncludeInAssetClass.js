...
function StartOfPeriodeQuarterlyIncludeInAssetClass()
{
      ...
      try {
         ...
         /*   Activate_Inactivate_PrefBranch("0","PREF_BILLING_FEESCHEDULE","YES",vServerBilling);
          ...
          // double click sur la relation Billing Relation
            ...
            x=7*(Get_WinBillingParameters().get_ActualWidth()/8);
            y=Get_WinBillingParameters().get_ActualHeight()/7;
            Get_WinBillingParameters().Click(x, y)
             ...
             // Les points de vérifications pour les messages affichés sur la partie Messages de la fenêtre Billing
                var count = Get_WinBilling_MessagesDgv().WPFObject("RecordListControl", "", 1).Items.Count;
                    for(i=0;i<count;i++)
                    {
                           ...
                           var relationShipExcel=GetData(filePath_Billing,"RelationBilling",21,language)
                           
                           var messagesExcel=GetData(filePath_Billing,"Start_periode_QIncludeInAssetCl",i+2,language)
...
// click sur la premiére ligne de la partie de relationShips
                    ...
                    Get_WinBilling_GrpRelationships_DgvRelationships().WPFObject("RecordListControl", "", 1).Find("Value",GetData(filePath_Billing,"Start_periode_QIncludeInAssetCl",12+z,language),100).Click();
                    Delay(300);
                    ...
                    Delay(300);
                          ...
                          Delay(200)
                           ...
                           var includedExcel=GetData(filePath_Billing,"Start_periode_QIncludeInAssetCl",9+z,language)
                           Log.Message(9+z);
                           ...
                           var relationshipNamExel=GetData(filePath_Billing,"Start_periode_QIncludeInAssetCl",10+z,language);
                           Log.Message(10+z);
                           ...
                           var BilledOn=GetData(filePath_Billing,"Start_periode_QIncludeInAssetCl",12+z,language);
                           Log.Message(12+z);
                           ...
                           var LastBillingOn=GetData(filePath_Billing,"Start_periode_QIncludeInAssetCl",13+z,language);
                           Log.Message(13+z);
                           ...
                           var aumExcel=GetData(filePath_Billing,"Start_periode_QIncludeInAssetCl",14+z,language);
                           Log.Message(14+z);
                          ...
                          // vérifier la valeur de Fees
                           ...
                           var FeesExcel=GetData(filePath_Billing,"Start_periode_QIncludeInAssetCl",15+z,language);
                           Log.Message(15+z);
                           ...
                           var CurrencyExcel=GetData(filePath_Billing,"Start_periode_QIncludeInAssetCl",16+z,language);
                           Log.Message(16+z);
                           ...
                           var aumFirmCurrencyExcel=GetData(filePath_Billing,"Start_periode_QIncludeInAssetCl",17+z,language);
                           Log.Message(17+z);
                           ...
                           var CurrencyfirmeExcel=GetData(filePath_Billing,"Start_periode_QIncludeInAssetCl",18+z,language);
                           Log.Message(18+z);
                           ...
                           var AUMExcludedExcel=GetData(filePath_Billing,"Start_periode_QIncludeInAssetCl",19+z,language);
                           Log.Message(19+z);
                           ...
                           var AUMForCalculationExcel=GetData(filePath_Billing,"Start_periode_QIncludeInAssetCl",20+z,language);
                           Log.Message(20+z);
                           ...
                           var AUMforFirmCurrExcel=GetData(filePath_Billing,"Start_periode_QIncludeInAssetCl",21+z,language);
                           Log.Message(21+z);
                           ...
                           var FrequencyExcel=GetData(filePath_Billing,"Start_periode_QIncludeInAssetCl",22+z,language);
                           Log.Message(22+z);
                           ...
                           var periodeExcel=GetData(filePath_Billing,"Start_periode_QIncludeInAssetCl",23+z,language);
                           Log.Message(23+z);
                           ...
                           var IAcodeExcel=GetData(filePath_Billing,"Start_periode_QIncludeInAssetCl",24+z,language);
                           Log.Message(24+z);
                           ...
                           var NombreCompteExcel=GetData(filePath_Billing,"Start_periode_QIncludeInAssetCl",25+z,language);
                           Log.Message(25+z);
                           ...
                           var CFAdjustementExcel=GetData(filePath_Billing,"Start_periode_QIncludeInAssetCl",26+z,language);
                           Log.Message(26+z);
...
for(var j=0;j<20;j++){ 
    // Vérifier la partie des comptes
                           ...
                           var IncludedAccomptExcel=GetData(filePath_Billing,"Start_periode_QIncludeInAssetCl",9,language);
                           ...
                           var AccountNubrAccountExcel=GetData(filePath_Billing,"Start_periode_QIncludeInAssetCl",27+j+z,language);
                           Log.Message(27+j+z);
                           ...
                           var ClientNameAccountExcel=GetData(filePath_Billing,"Start_periode_QIncludeInAssetCl",28+j+z,language);
                           Log.Message(28+j+z);
                           ...
                           var BilledFeesAccountExcel=GetData(filePath_Billing,"Start_periode_QIncludeInAssetCl",29+j+z,language);
                           Log.Message(29+j+z);
                           ...
                           var SpecialFeesAccountExcel=GetData(filePath_Billing,"Start_periode_QIncludeInAssetCl",30+j+z,language);
                           Log.Message(30+j+z);
                          ...
                          //Vérifier Currency
                           ...
                           var CurrencyAccountExcel=GetData(filePath_Billing,"Start_periode_QIncludeInAssetCl",31+j+z,language);
                           Log.Message(31+j+z);
                           ...
                           var BilledAccountAccountExcel=GetData(filePath_Billing,"Start_periode_QIncludeInAssetCl",32+j+z,language);
                           Log.Message(32+j+z);
                           ...
                           var BilledonAccountExcel=GetData(filePath_Billing,"Start_periode_QIncludeInAssetCl",33+j+z,language);
                           Log.Message(33+j+z);
                           ...
                           var IACodeAccountExcel=GetData(filePath_Billing,"Start_periode_QIncludeInAssetCl",34+j+z,language);
                           Log.Message(34+j+z);
                           ...
                           var AUMAccountExcel=GetData(filePath_Billing,"Start_periode_QIncludeInAssetCl",35+j+z,language);
                           ...
                           var AUMExcludedAccountExcel=GetData(filePath_Billing,"Start_periode_QIncludeInAssetCl",36+j+z,language);
                           Log.Message(36+j+z);
                           ...
                           var UMForCalculationAccountExcel=GetData(filePath_Billing,"Start_periode_QIncludeInAssetCl",37+j+z,language);
                           Log.Message(37+j+z);
                           ...
                           var WeightingAccountExcel=GetData(filePath_Billing,"Start_periode_QIncludeInAssetCl",38+j+z,language);
                           Log.Message(38+j+z);
                           ...
                           var CFAdjustementAccountExcel=GetData(filePath_Billing,"Start_periode_QIncludeInAssetCl",39+j+z,language);
                           Log.Message(39+j+z);
                          ...
                          Delay(400);
                           ...
                           var ClassFeesAccountExcel=GetData(filePath_Billing,"Start_periode_QIncludeInAssetCl",40+j+z,language);
                           Log.Message(40+j+z);
                           ...
                           var AssetAccountExcel=GetData(filePath_Billing,"Start_periode_QIncludeInAssetCl",41+j+z,language);
                           Log.Message(41+j+z);
                           ...
                           var AssetValueAccountExcel=GetData(filePath_Billing,"Start_periode_QIncludeInAssetCl",42+j+z,language);
                           Log.Message(42+j+z);
                           ...
                           var RateAccountExcel=GetData(filePath_Billing,"Start_periode_QIncludeInAssetCl",43+j+z,language);
                           Log.Message(43+j+z);
                           ...
                           var FeeAccountExcel=GetData(filePath_Billing,"Start_periode_QIncludeInAssetCl",44+j+z,language);
                           Log.Message(44+j+z);
                           ...
                           var CFAdjustementAccountExcel=GetData(filePath_Billing,"Start_periode_QIncludeInAssetCl",45+j+z,language);
                           Log.Message(45+j+z);
                           CheckEquals(VarToFloat(CFAdjustementAccount),VarToFloat(CFAdjustementAccountExcel), "Valeur de CF Adjustement");
                           //Exploser le -
                          ...
                          Delay(200);
                           ...
                           var ligneselection=GetData(filePath_Billing,"Start_periode_QIncludeInAssetCl",12+z,language);
             ...
             aqObject.CheckProperty(Get_WinBilling_GrpSummaryCAD_TxtBillingDate(), "WPFControlText", cmpEqual, GetData(filePath_Billing,"Start_periode_QIncludeInAssetCl",2,language));
             
             aqObject.CheckProperty(Get_WinBilling_GrpSummaryCAD_TxtTotalFees(), "Enabled", cmpEqual, true);
             aqObject.CheckProperty(Get_WinBilling_GrpSummaryCAD_TxtTotalFees(), "WPFControlText", cmpEqual, GetData(filePath_Billing,"Start_periode_QIncludeInAssetCl",3,language));
            
             aqObject.CheckProperty( Get_WinBilling_GrpSummaryCAD_TxtIATotalFeesBD88(), "WPFControlText", cmpEqual, GetData(filePath_Billing,"Start_periode_QIncludeInAssetCl",4,language));
             aqObject.CheckProperty( Get_WinBilling_GrpSummaryCAD_TxtIATotalFees9047763(), "WPFControlText", cmpEqual, GetData(filePath_Billing,"Start_periode_QIncludeInAssetCl",5,language));
