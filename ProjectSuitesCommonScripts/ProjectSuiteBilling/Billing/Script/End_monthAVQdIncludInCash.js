...
function End_monthAVQdIncludInCash()
{
      ...
      try {
           ...
           UncheckedBillableRelastionShip();
            ...
            Delay(800)
             if(client == "BNC")
              {
                var  NameSheetEndMonthAverageMToQIncludCash ="EndMonthAverageMToQIncludCasBNC"
                
              }
              if(client == "US")
              {
                var  NameSheetEndMonthAverageMToQIncludCash ="EndMonthAverageMToQIncludCash"
              }
         ...
         //   AssignAccountToRelationShip(51,100);
          // double click sur la relation Billing Relation
           ...
           Get_WinDetailedInfo_TabBillingForRelationship_GrpParameters_CmbFrequency_Month().Keys(GetData(filePath_Billing,"RelationBilling",326,language));
            ...
            FillRelationshipBillingTab([GetData(filePath_Billing,"WinAssignCompte",14,language),GetData(filePath_Billing,"WinAssignCompte",57,language)], GetData(filePath_Billing,"RelationBilling",11,language))
...
// click sur la premiére ligne de la partie de relationShips
                    ...
                    Get_WinBilling_GrpRelationships_DgvRelationships().WPFObject("RecordListControl", "", 1).Find("Value",GetData(filePath_Billing,NameSheetEndMonthAverageMToQIncludCash ,5+z,language),100).Click();
                    Delay(300);
                    ...
                    Delay(300);
                          ...
                          Delay(200)
                           ...
                           var includedExcel=GetData(filePath_Billing,NameSheetEndMonthAverageMToQIncludCash ,2+z,language)
                           Log.Message(2+z);
                           ...
                           var relationshipNamExel=GetData(filePath_Billing,NameSheetEndMonthAverageMToQIncludCash ,3+z,language);
                           Log.Message(3+z);
                           ...
                           var BilledOn=GetData(filePath_Billing,NameSheetEndMonthAverageMToQIncludCash ,5+z,language);
                           Log.Message(5+z)
                           ...
                           var LastBillingOn=GetData(filePath_Billing,NameSheetEndMonthAverageMToQIncludCash ,6+z,language);
                          Log.Message(6+z);
                           ...
                           var aumExcel=GetData(filePath_Billing,NameSheetEndMonthAverageMToQIncludCash ,7+z,language);
                           Log.Message(7+z);
                           ...
                           var FeesExcel=GetData(filePath_Billing,NameSheetEndMonthAverageMToQIncludCash ,8+z,language);
                           Log.Message(8+z);
                           ...
                           var CurrencyExcel=GetData(filePath_Billing,NameSheetEndMonthAverageMToQIncludCash ,9+z,language);
                           Log.Message(9+z);
                           ...
                           var aumFirmCurrencyExcel=GetData(filePath_Billing,NameSheetEndMonthAverageMToQIncludCash ,10+z,language);
                           Log.Message(10+z);
                           ...
                           var CurrencyfirmeExcel=GetData(filePath_Billing,NameSheetEndMonthAverageMToQIncludCash ,11+z,language);
                           Log.Message(11+z);
                           ...
                           var AUMExcludedExcel=GetData(filePath_Billing,NameSheetEndMonthAverageMToQIncludCash ,12+z,language);
                           Log.Message(12+z);
                           ...
                           var AUMForCalculationExcel=GetData(filePath_Billing,NameSheetEndMonthAverageMToQIncludCash ,13+z,language);
                           Log.Message(13+z);
                           ...
                           var AUMforFirmCurrExcel=GetData(filePath_Billing,NameSheetEndMonthAverageMToQIncludCash ,14+z,language);
                           Log.Message(14+z);
                           ...
                           var FrequencyExcel=GetData(filePath_Billing,NameSheetEndMonthAverageMToQIncludCash ,15+z,language);
                           Log.Message(15+z);
                           ...
                           var periodeExcel=GetData(filePath_Billing,NameSheetEndMonthAverageMToQIncludCash ,16+z,language);
                           Log.Message(16+z);
                           ...
                           var IAcodeExcel=GetData(filePath_Billing,NameSheetEndMonthAverageMToQIncludCash ,17+z,language);
                           Log.Message(17+z);
                           ...
                           var NombreCompteExcel=GetData(filePath_Billing,NameSheetEndMonthAverageMToQIncludCash ,18+z,language);
                           Log.Message(18+z);
                           ...
                           var CFAdjustementExcel=GetData(filePath_Billing,NameSheetEndMonthAverageMToQIncludCash ,19+z,language);
                           Log.Message(19+z);
...
for(var j=0;j<20;j++){ 
    // Vérifier la partie des comptes
                           ...
                           var IncludedAccomptExcel=GetData(filePath_Billing,NameSheetEndMonthAverageMToQIncludCash ,2,language);
                           ...
                           var AccountNubrAccountExcel=GetData(filePath_Billing,NameSheetEndMonthAverageMToQIncludCash ,20+j+z,language);
                           Log.Message(20+j+z);
                           ...
                           var ClientNameAccountExcel=GetData(filePath_Billing,NameSheetEndMonthAverageMToQIncludCash ,21+j+z,language);
                           Log.Message(21+j+z);
                           ...
                           var BilledFeesAccountExcel=GetData(filePath_Billing,NameSheetEndMonthAverageMToQIncludCash ,22+j+z,language);
                           Log.Message(22+j+z);
                           ...
                           var SpecialFeesAccountExcel=GetData(filePath_Billing,NameSheetEndMonthAverageMToQIncludCash ,23+j+z,language);
                           Log.Message(23+j+z);
                          ...
                          //Vérifier Currency
                           ...
                           var CurrencyAccountExcel=GetData(filePath_Billing,NameSheetEndMonthAverageMToQIncludCash ,24+j+z,language);
                           Log.Message(24+j+z);
                           ...
                           var BilledAccountAccountExcel=GetData(filePath_Billing,NameSheetEndMonthAverageMToQIncludCash ,25+j+z,language);
                           Log.Message(25+j+z);
                           ...
                           var BilledonAccountExcel=GetData(filePath_Billing,NameSheetEndMonthAverageMToQIncludCash ,26+j+z,language);
                           Log.Message(26+j+z);
                           ...
                           var IACodeAccountExcel=GetData(filePath_Billing,NameSheetEndMonthAverageMToQIncludCash ,27+j+z,language);
                           Log.Message(27+j+z);
                           ...
                           var AUMAccountExcel=GetData(filePath_Billing,NameSheetEndMonthAverageMToQIncludCash ,28+j+z,language);
                           Log.Message(28+j+z);
                           ...
                           var AUMExcludedAccountExcel=GetData(filePath_Billing,NameSheetEndMonthAverageMToQIncludCash ,29+j+z,language);
                           Log.Message(29+j+z);
                           ...
                           var UMForCalculationAccountExcel=GetData(filePath_Billing,NameSheetEndMonthAverageMToQIncludCash ,30+j+z,language);
                           Log.Message(30+j+z);
                           ...
                           var WeightingAccountExcel=GetData(filePath_Billing,NameSheetEndMonthAverageMToQIncludCash ,31+j+z,language);
                           Log.Message(31+j+z);
                           ...
                           var CFAdjustementAccountExcel=GetData(filePath_Billing,NameSheetEndMonthAverageMToQIncludCash ,32+j+z,language);
                           Log.Message(32+j+z);
                          ...
                          Delay(400);
                           ...
                           var ClassFeesAccountExcel=GetData(filePath_Billing,NameSheetEndMonthAverageMToQIncludCash ,33+j+z,language);
                           Log.Message(33+j+z);
                           ...
                           var AssetAccountExcel=GetData(filePath_Billing,NameSheetEndMonthAverageMToQIncludCash ,34+j+z,language);
                           Log.Message(34+j+z);
                           ...
                           var AssetValueAccountExcel=GetData(filePath_Billing,NameSheetEndMonthAverageMToQIncludCash ,35+j+z,language);
                           Log.Message(35+j+z);
                           ...
                           var RateAccountExcel=GetData(filePath_Billing,NameSheetEndMonthAverageMToQIncludCash ,36+j+z,language);
                           Log.Message(36+j+z);
                           ...
                           var FeeAccountExcel=GetData(filePath_Billing,NameSheetEndMonthAverageMToQIncludCash ,37+j+z,language);
                           Log.Message(37+j+z);
                           ...
                           var CFAdjustementAccountExcel=GetData(filePath_Billing,NameSheetEndMonthAverageMToQIncludCash ,38+j+z,language);
                           Log.Message(38+j+z);
                           CheckEquals(VarToFloat(CFAdjustementAccount),VarToFloat(CFAdjustementAccountExcel), "Valeur de CF Adjustement");
                           //Exploser le -
                          ...
                          Delay(200);
                           ...
                           var ligneselection=GetData(filePath_Billing,NameSheetEndMonthAverageMToQIncludCash ,5+z,language);
                           Log.Message(5+z);
             ...
             aqObject.CheckProperty(Get_WinBilling_GrpSummaryCAD_TxtBillingDate(), "WPFControlText", cmpEqual, GetData(filePath_Billing,NameSheetEndMonthAverageMToQIncludCash ,180,language));
             
             aqObject.CheckProperty(Get_WinBilling_GrpSummaryCAD_TxtTotalFees(), "Enabled", cmpEqual, true);
             aqObject.CheckProperty(Get_WinBilling_GrpSummaryCAD_TxtTotalFees(), "WPFControlText", cmpEqual, GetData(filePath_Billing,NameSheetEndMonthAverageMToQIncludCash ,181,language));
            
             aqObject.CheckProperty( Get_WinBilling_GrpSummaryCAD_TxtIATotalFeesBD88(), "WPFControlText", cmpEqual, GetData(filePath_Billing,NameSheetEndMonthAverageMToQIncludCash ,182,language));
             aqObject.CheckProperty( Get_WinBilling_GrpSummaryCAD_TxtIATotalFees9047763(), "WPFControlText", cmpEqual, GetData(filePath_Billing,NameSheetEndMonthAverageMToQIncludCash ,183,language));
            ...
            Delay(800)
            Get_RelationshipsClientsAccountsGrid().Find("Value",GetData(filePath_Billing,"RelationBilling",99,language),100).DblClick();
            WaitObject(Get_WinDetailedInfo(), ["Uid",  "VisibleOnScreen"], ["Button_ddd2", true]);// attendre le bouton ajouter de la fenêtre info relation
             // choisir l'onglet billing
            Get_WinDetailedInfo_TabBillingForRelationship().Click();
            Delay(3000);
