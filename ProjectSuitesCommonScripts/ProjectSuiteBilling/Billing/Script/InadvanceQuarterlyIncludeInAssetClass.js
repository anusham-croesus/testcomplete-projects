...
function InadvanceQuarterlyIncludeInAssetClass()
{
      ...
      try {
           ...
           UncheckedBillableRelastionShip();
            ...
            Delay(1000);
             if(client == "BNC")
              {
                var  NameSheetInAdvanceQMarsIncludInAss  ="InAdvanceQMarsIncludInAssBNC"
                var  NameSheetInAdvanceQJuinIncludInAss  ="InAdvanceQJuinIncludInAssBNC"
                var  NameSheetInAdvanceQSeptemIncludInAss ="InAdvanceQSeptemIncludInAssBNC"
                var  NameSheetInAdvanceQDembreIncludInAss ="InAdvanceQDembreIncludInAssBNC"
              }
              if(client == "US")
              {
                var  NameSheetInAdvanceQMarsIncludInAss  ="InAdvanceQMarsIncludInAss"
                var  NameSheetInAdvanceQJuinIncludInAss  ="InAdvanceQJuinIncludInAss"
                var  NameSheetInAdvanceQSeptemIncludInAss ="InAdvanceQSeptemIncludInAss"
                 var  NameSheetInAdvanceQDembreIncludInAss ="InAdvanceQDembreIncludInAss"
              }
          ...
          // double click sur la relation Billing Relation
           ...
           CheckPointsRelationsShipsAccountsBillingIntervalOneAccount(NameSheetInAdvanceQMarsIncludInAss);
           ...
           //Choisir le mois juin 
            ...
            ChangeFrequencyDateBillingParameters(Get_WinBillingParameters_RdoInAdvance(),Get_Calendar_LstYears_Item("2009"),Get_Calendar_LstMonths_ItemJune(),Get_WinBillingParameters_GrpFrequencies_ChkQuarterly())
              ...
              // Les points de vérifications pour les messages affichés sur la partie Messages de la fenêtre Billing
           CheckPointsMessageByMonthInAdvanceMIncludInAssetAsset()
           CheckPointsRelationsShipsAccountsBillingIntervalOneAccount(NameSheetInAdvanceQJuinIncludInAss);
           GeneratExportPDFCloseReport();
            ...
            ChangeFrequencyDateBillingParameters(Get_WinBillingParameters_RdoInAdvance(),Get_Calendar_LstYears_Item("2009"),Get_Calendar_LstMonths_ItemSeptember(),Get_WinBillingParameters_GrpFrequencies_ChkQuarterly())
              ...
              // Les points de vérifications pour les messages affichés sur la partie Messages de la fenêtre Billing
           CheckPointsMessageByMonthInAdvanceMIncludInAssetAsset()
           CheckPointsRelationsShipsAccountsBillingIntervalOneAccount(NameSheetInAdvanceQSeptemIncludInAss);
           GeneratExportPDFCloseReport();
           ...
           //Choisir le mois Décembre 
            ...
            ChangeFrequencyDateBillingParameters(Get_WinBillingParameters_RdoInAdvance(),Get_Calendar_LstYears_Item("2009"),Get_Calendar_LstMonths_ItemDecember(),Get_WinBillingParameters_GrpFrequencies_ChkQuarterly())
              ...
              // Les points de vérifications pour les messages affichés sur la partie Messages de la fenêtre Billing
           CheckPointsMessageByMonthInAdvanceMIncludInAssetAsset()
           CheckPointsRelationsShipsAccountsBillingIntervalOneAccount(NameSheetInAdvanceQDembreIncludInAss);
