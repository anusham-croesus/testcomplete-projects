...
-Cash Flow Adjustement: percentage/Inflow : 100, percentage/Outflow:100, Amount/Inflow:1,000.01 et Amount/OutFlow=8,000.01
...
Analyste d'automatisation: Sana Ayaz */
 ...
 function TestGrilCFMontantCas4()
  {
      try {
            ...
            var TxtAmountInflow=GetData(filePath_Billing,"RelationBilling",55,language)
            var TxtAmountOutflow=GetData(filePath_Billing,"RelationBilling",56,language)			
            ...
            // Cliquer sur le bouton OK
             ...
             if(count==2)
             {
                    for(i=0;i<count;i++)
                    {
                           ...
                           var messagesExcel=GetData(filePath_Billing,"RelationBilling",83+i,language)
                ...
                if(count==3)
             {
                    for(i=0;i<count;i++)
                    {
                           ...
                           var messagesExcel=GetData(filePath_Billing,"RelationBilling",380+i,language)
