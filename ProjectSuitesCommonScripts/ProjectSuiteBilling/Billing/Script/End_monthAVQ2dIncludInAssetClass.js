...
function End_monthAVQ2dIncludInAssetClass()
{
      ...
      try {
           ...
           UncheckedBillableRelastionShip();
            ...
            Delay(800)
              if(client == "BNC")
              {
                var  NameSheetEnd_month_averag_Q ="End_month_averag_QBNC"
                
              }
              if(client == "US")
              {
                var  NameSheetEnd_month_averag_Q ="End_month_averag_Q"
              }
            ...
            SearchRelationshipByName(GetData(filePath_Billing,"RelationBilling",100,language));
            Delay(800)
            JoinAccountToRelationship(GetData(filePath_Billing,"WinAssignCompte",51,language), GetData(filePath_Billing,"RelationBilling",100,language))
            Delay(800)
          // double click sur la relation Billing Relation
            Get_RelationshipsClientsAccountsGrid().Find("Value",GetData(filePath_Billing,"RelationBilling",100,language),100).DblClick();
            Delay(3000);
            ...
            Delay(3000);
            Get_WinDetailedInfo_BtnApply().Click();
             FillRelationshipBillingTab([GetData(filePath_Billing,"WinAssignCompte",51,language),GetData(filePath_Billing,"WinAssignCompte",52,language),GetData(filePath_Billing,"WinAssignCompte",53,language)], GetData(filePath_Billing,"RelationBilling",10,language))
             ...
             Log.Message("Le nombre des éléments de la grille de la grille des messages est"+count);
              if(count==3){
                    for(i=0;i<count;i++)
                    {
                           ...
                           var NumAccount=Get_WinBilling_MessagesDgv().WPFObject("RecordListControl", "", 1). Items.Item(i).DataItem.AccountNumber.OleValue
                           
                           var relationShipExcel=GetData(filePath_Billing,"RelationBilling",122,language)
                           var messagesExcel=GetData(filePath_Billing,NameSheetEnd_month_averag_Q ,234+i,language)
                           var NumAccountExcel=GetData(filePath_Billing,"WinAssignCompte",52,language)
...
// click sur la premiére ligne de la partie de relationShips
                    ...
                    Get_WinBilling_GrpRelationships_DgvRelationships().WPFObject("RecordListControl", "", 1).Find("Value",GetData(filePath_Billing,NameSheetEnd_month_averag_Q ,5+z,language),100).Click();
                    Delay(300);
                    ...
                    Delay(300);
                          ...
                          Delay(200)
                           ...
                           var includedExcel=GetData(filePath_Billing,NameSheetEnd_month_averag_Q ,2+z,language)
                           Log.Message(2+z);
                           ...
                           var relationshipNamExel=GetData(filePath_Billing,NameSheetEnd_month_averag_Q ,3+z,language);
                           Log.Message(3+z);
                           ...
                           var BilledOn=GetData(filePath_Billing,NameSheetEnd_month_averag_Q ,5+z,language);
                           Log.Message(5+z)
                           ...
                           var LastBillingOn=GetData(filePath_Billing,NameSheetEnd_month_averag_Q ,6+z,language);
                          Log.Message(6+z);
                           ...
                           var aumExcel=GetData(filePath_Billing,NameSheetEnd_month_averag_Q ,7+z,language);
                           Log.Message(7+z);
                           ...
                           var FeesExcel=GetData(filePath_Billing,NameSheetEnd_month_averag_Q ,8+z,language);
                           Log.Message(8+z);
                           ...
                           var CurrencyExcel=GetData(filePath_Billing,NameSheetEnd_month_averag_Q ,9+z,language);
                           Log.Message(9+z);
                           ...
                           var aumFirmCurrencyExcel=GetData(filePath_Billing,NameSheetEnd_month_averag_Q ,10+z,language);
                           Log.Message(10+z);
                           ...
                           var CurrencyfirmeExcel=GetData(filePath_Billing,NameSheetEnd_month_averag_Q ,11+z,language);
                           Log.Message(11+z);
                           ...
                           var AUMExcludedExcel=GetData(filePath_Billing,NameSheetEnd_month_averag_Q ,12+z,language);
                           Log.Message(12+z);
                           ...
                           var AUMForCalculationExcel=GetData(filePath_Billing,NameSheetEnd_month_averag_Q ,13+z,language);
                           Log.Message(13+z);
                           ...
                           var AUMforFirmCurrExcel=GetData(filePath_Billing,NameSheetEnd_month_averag_Q ,14+z,language);
                           Log.Message(14+z);
                           ...
                           var FrequencyExcel=GetData(filePath_Billing,NameSheetEnd_month_averag_Q ,15+z,language);
                           Log.Message(15+z);
                           ...
                           var periodeExcel=GetData(filePath_Billing,NameSheetEnd_month_averag_Q ,16+z,language);
                           Log.Message(16+z);
                           ...
                           var IAcodeExcel=GetData(filePath_Billing,NameSheetEnd_month_averag_Q ,17+z,language);
                           Log.Message(17+z);
                           ...
                           var NombreCompteExcel=GetData(filePath_Billing,NameSheetEnd_month_averag_Q ,18+z,language);
                           Log.Message(18+z);
                           ...
                           var CFAdjustementExcel=GetData(filePath_Billing,NameSheetEnd_month_averag_Q ,19+z,language);
                           Log.Message(19+z);
...
for(var j=0;j<41;j++){ 
    // Vérifier la partie des comptes
                           ...
                           var IncludedAccomptExcel=GetData(filePath_Billing,NameSheetEnd_month_averag_Q ,2,language);
                           ...
                           var AccountNubrAccountExcel=GetData(filePath_Billing,NameSheetEnd_month_averag_Q ,20+j+z,language);
                           Log.Message(20+j+z);
                           ...
                           var ClientNameAccountExcel=GetData(filePath_Billing,NameSheetEnd_month_averag_Q ,21+j+z,language);
                           Log.Message(21+j+z);
                           ...
                           var BilledFeesAccountExcel=GetData(filePath_Billing,NameSheetEnd_month_averag_Q ,22+j+z,language);
                           Log.Message(22+j+z);
                           ...
                           var SpecialFeesAccountExcel=GetData(filePath_Billing,NameSheetEnd_month_averag_Q ,23+j+z,language);
                           Log.Message(23+j+z);
                          ...
                          //Vérifier Currency
                           ...
                           var CurrencyAccountExcel=GetData(filePath_Billing,NameSheetEnd_month_averag_Q ,24+j+z,language);
                           Log.Message(24+j+z);
                           ...
                           var BilledAccountAccountExcel=GetData(filePath_Billing,NameSheetEnd_month_averag_Q ,25+j+z,language);
                           Log.Message(25+j+z);
                           ...
                           var BilledonAccountExcel=GetData(filePath_Billing,NameSheetEnd_month_averag_Q ,26+j+z,language);
                           Log.Message(26+j+z);
                           ...
                           var IACodeAccountExcel=GetData(filePath_Billing,NameSheetEnd_month_averag_Q ,27+j+z,language);
                           Log.Message(27+j+z);
                           ...
                           var AUMAccountExcel=GetData(filePath_Billing,NameSheetEnd_month_averag_Q ,28+j+z,language);
                           Log.Message(28+j+z);
                           ...
                           var AUMExcludedAccountExcel=GetData(filePath_Billing,NameSheetEnd_month_averag_Q ,29+j+z,language);
                           Log.Message(29+j+z);
                           ...
                           var UMForCalculationAccountExcel=GetData(filePath_Billing,NameSheetEnd_month_averag_Q ,30+j+z,language);
                           Log.Message(30+j+z);
                           ...
                           var WeightingAccountExcel=GetData(filePath_Billing,NameSheetEnd_month_averag_Q ,31+j+z,language);
                           Log.Message(31+j+z);
                           ...
                           var CFAdjustementAccountExcel=GetData(filePath_Billing,NameSheetEnd_month_averag_Q ,32+j+z,language);
                           Log.Message(32+j+z);
                          ...
                          Delay(400);
                           ...
                           var ClassFeesAccountExcel=GetData(filePath_Billing,NameSheetEnd_month_averag_Q ,33+j+z,language);
                           Log.Message(33+j+z);
                           ...
                           var AssetAccountExcel=GetData(filePath_Billing,NameSheetEnd_month_averag_Q ,34+j+z,language);
                           Log.Message(34+j+z);
                           ...
                           var AssetValueAccountExcel=GetData(filePath_Billing,NameSheetEnd_month_averag_Q ,35+j+z,language);
                           Log.Message(35+j+z);
                           ...
                           var RateAccountExcel=GetData(filePath_Billing,NameSheetEnd_month_averag_Q ,36+j+z,language);
                           Log.Message(36+j+z);
                           ...
                           var FeeAccountExcel=GetData(filePath_Billing,NameSheetEnd_month_averag_Q ,37+j+z,language);
                           Log.Message(37+j+z);
                           ...
                           var CFAdjustementAccountExcel=GetData(filePath_Billing,NameSheetEnd_month_averag_Q ,38+j+z,language);
                           Log.Message(38+j+z);
                           CheckEquals(VarToFloat(CFAdjustementAccount),VarToFloat(CFAdjustementAccountExcel), "Valeur de CF Adjustement");
                           //Exploser le -
                          ...
                          Delay(200);
                           ...
                           var ligneselection=GetData(filePath_Billing,NameSheetEnd_month_averag_Q ,5+z,language);
                           Log.Message(5+z);
             ...
             aqObject.CheckProperty(Get_WinBilling_GrpSummaryCAD_TxtBillingDate(), "WPFControlText", cmpEqual, GetData(filePath_Billing,NameSheetEnd_month_averag_Q ,153,language));
             
             aqObject.CheckProperty(Get_WinBilling_GrpSummaryCAD_TxtTotalFees(), "Enabled", cmpEqual, true);
             aqObject.CheckProperty(Get_WinBilling_GrpSummaryCAD_TxtTotalFees(), "WPFControlText", cmpEqual, GetData(filePath_Billing,NameSheetEnd_month_averag_Q ,154,language));
            
             aqObject.CheckProperty( Get_WinBilling_GrpSummaryCAD_TxtIATotalFeesBD88(), "WPFControlText", cmpEqual, GetData(filePath_Billing,NameSheetEnd_month_averag_Q ,155,language));
             aqObject.CheckProperty( Get_WinBilling_GrpSummaryCAD_TxtIATotalFees9047763(), "WPFControlText", cmpEqual, GetData(filePath_Billing,NameSheetEnd_month_averag_Q ,156,language));
