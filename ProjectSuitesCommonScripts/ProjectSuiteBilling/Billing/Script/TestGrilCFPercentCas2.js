...
-Cash Flow Adjustement: percentage/Inflow : 0, percentage/Outflow:0, Amount/Inflow:99,999,999.99 et Amount/OutFlow=99,999,999.99.
...
-Il faut vérifier qu'il y a trois message qui sont affichés
...
Analyste d'automatisation: Sana Ayaz */
 ...
 function TestGrilCFPercentCas2()
  {
      try {
            ...
            var TxtPercentageInflow=GetData(filePath_Billing,"RelationBilling",43,language)
            var TxtPercentageOutflow=GetData(filePath_Billing,"RelationBilling",43,language)
            ...
            // Cliquer sur le bouton OK
             ...
             if(count==3)
             {
                    for(i=0;i<count;i++)
                    {
                           ...
                           var messagesExcel=GetData(filePath_Billing,"RelationBilling",58+i,language)
