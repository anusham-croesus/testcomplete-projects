...
function StartOfPeriodeMonthlyIncludeInAssetClass()
{
...
// click sur la premiére ligne de la partie de relationShips
                    ...
                    Get_WinBilling_GrpRelationships_DgvRelationships().WPFObject("RecordListControl", "", 1).Find("Value",GetData(filePath_Billing,"Start_periode_MIncludeInAssetCl",12+z,language),100).Click();
                    Delay(300);
                    ...
                    Delay(300);
                          ...
                          Delay(200)
                           ...
                           var includedExcel=GetData(filePath_Billing,"Start_periode_MIncludeInAssetCl",9+z,language)
                           Log.Message(9+z);
                           ...
                           var relationshipNamExel=GetData(filePath_Billing,"Start_periode_MIncludeInAssetCl",10+z,language);
                           Log.Message(10+z);
                           ...
                           var BilledOn=GetData(filePath_Billing,"Start_periode_MIncludeInAssetCl",12+z,language);
                           Log.Message(12+z);
                           ...
                           var LastBillingOn=GetData(filePath_Billing,"Start_periode_MIncludeInAssetCl",13+z,language);
                           Log.Message(13+z);
                           ...
                           var aumExcel=GetData(filePath_Billing,"Start_periode_MIncludeInAssetCl",14+z,language);
                           Log.Message(14+z);
                          ...
                          // vérifier la valeur de Fees
                           ...
                           var FeesExcel=GetData(filePath_Billing,"Start_periode_MIncludeInAssetCl",15+z,language);
                           Log.Message(15+z);
                           ...
                           var CurrencyExcel=GetData(filePath_Billing,"Start_periode_MIncludeInAssetCl",16+z,language);
                           Log.Message(16+z);
                           ...
                           var aumFirmCurrencyExcel=GetData(filePath_Billing,"Start_periode_MIncludeInAssetCl",17+z,language);
                           Log.Message(17+z);
                           ...
                           var CurrencyfirmeExcel=GetData(filePath_Billing,"Start_periode_MIncludeInAssetCl",18+z,language);
                           Log.Message(18+z);
                           ...
                           var AUMExcludedExcel=GetData(filePath_Billing,"Start_periode_MIncludeInAssetCl",19+z,language);
                           Log.Message(19+z);
                           ...
                           var AUMForCalculationExcel=GetData(filePath_Billing,"Start_periode_MIncludeInAssetCl",20+z,language);
                           Log.Message(20+z);
                           ...
                           var AUMforFirmCurrExcel=GetData(filePath_Billing,"Start_periode_MIncludeInAssetCl",21+z,language);
                           Log.Message(21+z);
                           ...
                           var FrequencyExcel=GetData(filePath_Billing,"Start_periode_MIncludeInAssetCl",22+z,language);
                           Log.Message(22+z);
                           ...
                           var periodeExcel=GetData(filePath_Billing,"Start_periode_MIncludeInAssetCl",23+z,language);
                           Log.Message(23+z);
                           ...
                           var IAcodeExcel=GetData(filePath_Billing,"Start_periode_MIncludeInAssetCl",24+z,language);
                           Log.Message(24+z);
                           ...
                           var NombreCompteExcel=GetData(filePath_Billing,"Start_periode_MIncludeInAssetCl",25+z,language);
                           Log.Message(25+z);
                           ...
                           var CFAdjustementExcel=GetData(filePath_Billing,"Start_periode_MIncludeInAssetCl",26+z,language);
                           Log.Message(26+z);
...
//for(var j=0;j<20;j++){ 
    // Vérifier la partie des comptes
                           ...
                           var IncludedAccomptExcel=GetData(filePath_Billing,"Start_periode_MIncludeInAssetCl",9,language);
                           ...
                           var AccountNubrAccountExcel=GetData(filePath_Billing,"Start_periode_MIncludeInAssetCl",27+z,language);
                           Log.Message(27+z);
                           ...
                           var ClientNameAccountExcel=GetData(filePath_Billing,"Start_periode_MIncludeInAssetCl",28+z,language);
                           Log.Message(28+z);
                           ...
                           var BilledFeesAccountExcel=GetData(filePath_Billing,"Start_periode_MIncludeInAssetCl",29+z,language);
                           Log.Message(29+z);
                           ...
                           var SpecialFeesAccountExcel=GetData(filePath_Billing,"Start_periode_MIncludeInAssetCl",30+z,language);
                           Log.Message(30+z);
                          ...
                          //Vérifier Currency
                           ...
                           var CurrencyAccountExcel=GetData(filePath_Billing,"Start_periode_MIncludeInAssetCl",31+z,language);
                           Log.Message(31+z);
                           ...
                           var BilledAccountAccountExcel=GetData(filePath_Billing,"Start_periode_MIncludeInAssetCl",32+z,language);
                           Log.Message(32+z);
                           ...
                           var BilledonAccountExcel=GetData(filePath_Billing,"Start_periode_MIncludeInAssetCl",33+z,language);
                           Log.Message(33+z);
                           ...
                           var IACodeAccountExcel=GetData(filePath_Billing,"Start_periode_MIncludeInAssetCl",34+z,language);
                           Log.Message(34+z);
                           ...
                           var AUMAccountExcel=GetData(filePath_Billing,"Start_periode_MIncludeInAssetCl",35+z,language);
                           Log.Message(35+z);
                           ...
                           var AUMExcludedAccountExcel=GetData(filePath_Billing,"Start_periode_MIncludeInAssetCl",36+z,language);
                           Log.Message(36+z);
                           ...
                           var UMForCalculationAccountExcel=GetData(filePath_Billing,"Start_periode_MIncludeInAssetCl",37+z,language);
                           Log.Message(37+z);
                           ...
                           var WeightingAccountExcel=GetData(filePath_Billing,"Start_periode_MIncludeInAssetCl",38+z,language);
                           Log.Message(38+z);
                           ...
                           var CFAdjustementAccountExcel=GetData(filePath_Billing,"Start_periode_MIncludeInAssetCl",39+z,language);
                           Log.Message(39+z);
                          ...
                          Delay(400);
                           ...
                           var ClassFeesAccountExcel=GetData(filePath_Billing,"Start_periode_MIncludeInAssetCl",40+z,language);
                           Log.Message(40+z);
                           ...
                           var AssetAccountExcel=GetData(filePath_Billing,"Start_periode_MIncludeInAssetCl",41+z,language);
                           Log.Message(41+z);
                           ...
                           var AssetValueAccountExcel=GetData(filePath_Billing,"Start_periode_MIncludeInAssetCl",42+z,language);
                           Log.Message(42+z);
                           ...
                           var RateAccountExcel=GetData(filePath_Billing,"Start_periode_MIncludeInAssetCl",43+z,language);
                           Log.Message(43+z);
                           ...
                           var FeeAccountExcel=GetData(filePath_Billing,"Start_periode_MIncludeInAssetCl",44+z,language);
                           Log.Message(44+z);
                           ...
                           var CFAdjustementAccountExcel=GetData(filePath_Billing,"Start_periode_MIncludeInAssetCl",45+z,language);
                           Log.Message(45+z);
                           CheckEquals(VarToFloat(CFAdjustementAccount),VarToFloat(CFAdjustementAccountExcel), "Valeur de CF Adjustement");
                           //Exploser le -
                          ...
                          // i=i+1
                     //      }
                           var ligneselection=GetData(filePath_Billing,"Start_periode_MIncludeInAssetCl",12+z,language);
             ...
             aqObject.CheckProperty(Get_WinBilling_GrpSummaryCAD_TxtBillingDate(), "WPFControlText", cmpEqual, GetData(filePath_Billing,"Start_periode_MIncludeInAssetCl",2,language));
             
             aqObject.CheckProperty(Get_WinBilling_GrpSummaryCAD_TxtTotalFees(), "Enabled", cmpEqual, true);
             aqObject.CheckProperty(Get_WinBilling_GrpSummaryCAD_TxtTotalFees(), "WPFControlText", cmpEqual, GetData(filePath_Billing,"Start_periode_MIncludeInAssetCl",3,language));
            
             aqObject.CheckProperty( Get_WinBilling_GrpSummaryCAD_TxtIATotalFeesBD88(), "WPFControlText", cmpEqual, GetData(filePath_Billing,"Start_periode_MIncludeInAssetCl",4,language));
             aqObject.CheckProperty( Get_WinBilling_GrpSummaryCAD_TxtIATotalFees9047763(), "WPFControlText", cmpEqual, GetData(filePath_Billing,"Start_periode_MIncludeInAssetCl",5,language));
