...
function EndOfPeriodeQuarterlyIncludeInCash()
{
           ...
           /* Activate_Inactivate_PrefBranch("0","PREF_BILLING_FEESCHEDULE","YES",vServerBilling);
            ...
            Login(vServerBilling, userNameBilling, pswBilling, language);
             Delay(800)
              if(client == "BNC")
              {
                var  NameSheetEndOfPeriodQIncludInCash ="EndOfPeriodQIncludInCashBNC"
                
              }
              if(client == "US")
              {
                var  NameSheetEndOfPeriodQIncludInCash ="EndOfPeriodQIncludInCash"
              }
            ...
            // Cliquer sur le bouton OK
             ...
             if(client == "US"){
              if(count == 1){
                           ...
                           var messagesExcel=GetData(filePath_Billing,NameSheetEndOfPeriodQIncludInCash,168,language)
                           Log.Message(168)
...
// click sur la premiére ligne de la partie de relationShips
                    ...
                    Get_WinBilling_GrpRelationships_DgvRelationships().WPFObject("RecordListControl", "", 1).Find("Value",GetData(filePath_Billing,NameSheetEndOfPeriodQIncludInCash,12+z,language),100).Click();
                    Delay(300);
                    ...
                    Delay(300);
                          ...
                          Delay(200)
                           ...
                           var includedExcel=GetData(filePath_Billing,NameSheetEndOfPeriodQIncludInCash,9+z,language)
                           Log.Message(9+z);
                           ...
                           var relationshipNamExel=GetData(filePath_Billing,NameSheetEndOfPeriodQIncludInCash,10+z,language);
                           Log.Message(10+z);
                           ...
                           var BilledOn=GetData(filePath_Billing,NameSheetEndOfPeriodQIncludInCash,12+z,language);
                           Log.Message(12+z);
                           ...
                           var LastBillingOn=GetData(filePath_Billing,NameSheetEndOfPeriodQIncludInCash,13+z,language);
                           Log.Message(13+z);
                           ...
                           var aumExcel=GetData(filePath_Billing,NameSheetEndOfPeriodQIncludInCash,14+z,language);
                           Log.Message(14+z);
                          ...
                          // vérifier la valeur de Fees
                           ...
                           var FeesExcel=GetData(filePath_Billing,NameSheetEndOfPeriodQIncludInCash,15+z,language);
                           Log.Message(15+z);
                           ...
                           var CurrencyExcel=GetData(filePath_Billing,NameSheetEndOfPeriodQIncludInCash,16+z,language);
                           Log.Message(16+z);
                           ...
                           var aumFirmCurrencyExcel=GetData(filePath_Billing,NameSheetEndOfPeriodQIncludInCash,17+z,language);
                           Log.Message(17+z);
                           ...
                           var CurrencyfirmeExcel=GetData(filePath_Billing,NameSheetEndOfPeriodQIncludInCash,18+z,language);
                           Log.Message(18+z);
                           ...
                           var AUMExcludedExcel=GetData(filePath_Billing,NameSheetEndOfPeriodQIncludInCash,19+z,language);
                           Log.Message(19+z);
                           ...
                           var AUMForCalculationExcel=GetData(filePath_Billing,NameSheetEndOfPeriodQIncludInCash,20+z,language);
                           Log.Message(20+z);
                           ...
                           var AUMforFirmCurrExcel=GetData(filePath_Billing,NameSheetEndOfPeriodQIncludInCash,21+z,language);
                           Log.Message(21+z);
                           ...
                           var FrequencyExcel=GetData(filePath_Billing,NameSheetEndOfPeriodQIncludInCash,22+z,language);
                           Log.Message(22+z);
                           ...
                           var periodeExcel=GetData(filePath_Billing,NameSheetEndOfPeriodQIncludInCash,23+z,language);
                           Log.Message(23+z);
                           ...
                           var IAcodeExcel=GetData(filePath_Billing,NameSheetEndOfPeriodQIncludInCash,24+z,language);
                           Log.Message(24+z);
                           ...
                           var NombreCompteExcel=GetData(filePath_Billing,NameSheetEndOfPeriodQIncludInCash,25+z,language);
                           Log.Message(25+z);
                           ...
                           var CFAdjustementExcel=GetData(filePath_Billing,NameSheetEndOfPeriodQIncludInCash,26+z,language);
                           Log.Message(26+z);
...
//for(var j=0;j<20;j++){ 
    // Vérifier la partie des comptes
                           ...
                           var IncludedAccomptExcel=GetData(filePath_Billing,NameSheetEndOfPeriodQIncludInCash,9,language);
                           ...
                           var AccountNubrAccountExcel=GetData(filePath_Billing,NameSheetEndOfPeriodQIncludInCash,27+z,language);
                           Log.Message(27+z);
                           ...
                           var ClientNameAccountExcel=GetData(filePath_Billing,NameSheetEndOfPeriodQIncludInCash,28+z,language);
                           Log.Message(28+z);
                           ...
                           var BilledFeesAccountExcel=GetData(filePath_Billing,NameSheetEndOfPeriodQIncludInCash,29+z,language);
                           Log.Message(29+z);
                           ...
                           var SpecialFeesAccountExcel=GetData(filePath_Billing,NameSheetEndOfPeriodQIncludInCash,30+z,language);
                           Log.Message(30+z);
                          ...
                          //Vérifier Currency
                           ...
                           var CurrencyAccountExcel=GetData(filePath_Billing,NameSheetEndOfPeriodQIncludInCash,31+z,language);
                           Log.Message(31+z);
                           ...
                           var BilledAccountAccountExcel=GetData(filePath_Billing,NameSheetEndOfPeriodQIncludInCash,32+z,language);
                           Log.Message(32+z);
                           ...
                           var BilledonAccountExcel=GetData(filePath_Billing,NameSheetEndOfPeriodQIncludInCash,33+z,language);
                           Log.Message(33+z);
                           ...
                           var IACodeAccountExcel=GetData(filePath_Billing,NameSheetEndOfPeriodQIncludInCash,34+z,language);
                           Log.Message(34+z);
                           ...
                           var AUMAccountExcel=GetData(filePath_Billing,NameSheetEndOfPeriodQIncludInCash,35+z,language);
                           Log.Message(35+z);
                           ...
                           var AUMExcludedAccountExcel=GetData(filePath_Billing,NameSheetEndOfPeriodQIncludInCash,36+z,language);
                           Log.Message(36+z);
                           ...
                           var UMForCalculationAccountExcel=GetData(filePath_Billing,NameSheetEndOfPeriodQIncludInCash,37+z,language);
                           Log.Message(37+z);
                           ...
                           var WeightingAccountExcel=GetData(filePath_Billing,NameSheetEndOfPeriodQIncludInCash,38+z,language);
                           Log.Message(38+z);
                           ...
                           var CFAdjustementAccountExcel=GetData(filePath_Billing,NameSheetEndOfPeriodQIncludInCash,39+z,language);
                           Log.Message(39+z);
                          ...
                          for(var d=0;d<countExplospluscount;d++){  
                                     ...
                                     Log.Message(40+z+d+s);
                                      ...
                                      var ClassFeesAccountExcel=GetData(filePath_Billing,NameSheetEndOfPeriodQIncludInCash,40+z+d+s,language);
                                      ...
                                      var AssetAccountExcel=GetData(filePath_Billing,NameSheetEndOfPeriodQIncludInCash,41+z+d+s,language);
                                      ...
                                      var AssetValueAccountExcel=GetData(filePath_Billing,NameSheetEndOfPeriodQIncludInCash,42+z+d+s,language);
                                      ...
                                      var RateAccountExcel=GetData(filePath_Billing,NameSheetEndOfPeriodQIncludInCash,43+z+d+s,language);
                                      ...
                                      var FeeAccountExcel=GetData(filePath_Billing,NameSheetEndOfPeriodQIncludInCash,44+z+d+s,language);
                                      ...
                                      var CFAdjustementAccountExcel=GetData(filePath_Billing,NameSheetEndOfPeriodQIncludInCash,45+z+d+s,language);
                           ...
                           var ligneselection=GetData(filePath_Billing,NameSheetEndOfPeriodQIncludInCash,12+z,language);
             ...
             aqObject.CheckProperty(Get_WinBilling_GrpSummaryCAD_TxtBillingDate(), "WPFControlText", cmpEqual, GetData(filePath_Billing,NameSheetEndOfPeriodQIncludInCash,2,language));
             
             aqObject.CheckProperty(Get_WinBilling_GrpSummaryCAD_TxtTotalFees(), "Enabled", cmpEqual, true);
             aqObject.CheckProperty(Get_WinBilling_GrpSummaryCAD_TxtTotalFees(), "WPFControlText", cmpEqual, GetData(filePath_Billing,NameSheetEndOfPeriodQIncludInCash,3,language));
            
             aqObject.CheckProperty( Get_WinBilling_GrpSummaryCAD_TxtIATotalFeesBD88(), "WPFControlText", cmpEqual, GetData(filePath_Billing,NameSheetEndOfPeriodQIncludInCash,4,language));
             aqObject.CheckProperty( Get_WinBilling_GrpSummaryCAD_TxtIATotalFees9047763(), "WPFControlText", cmpEqual, GetData(filePath_Billing,NameSheetEndOfPeriodQIncludInCash,5,language));
          ...
          // double click sur la relation Billing Relation
            ...
            FillTheCashFlowAdjustmen (GetData(filePath_Billing,"RelationBilling",313,language),GetData(filePath_Billing,"RelationBilling",314,language),GetData(filePath_Billing,"RelationBilling",315,language),GetData(filePath_Billing,"RelationBilling",316,language))
