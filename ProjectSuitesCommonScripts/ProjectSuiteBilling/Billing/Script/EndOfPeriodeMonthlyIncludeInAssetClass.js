...
function EndOfPeriodeMonthlyIncludeInAssetClass()
{
          ...
          // activer la préférence PREF_BILLING_PROCESS pour l'user 
           /* Activate_Inactivate_PrefBranch("0","PREF_BILLING_FEESCHEDULE","YES",vServerBilling);
            ...
            Login(vServerBilling, userNameBilling, pswBilling, language);
             ...
             if(client == "BNC")
              {
                var  NameSheetEndOfPeriodMIncludInAssetClass ="EndOfPeriodMIncludInAssetClaBNC"
                
              }
              if(client == "US")
              {
                var  NameSheetEndOfPeriodMIncludInAssetClass ="EndOfPeriodMIncludInAssetClass"
              }
...
if( k == 0 || k == 1 || k == 5 || k == 9 || k == 10 ){
if(k == 9){
                 Scroll() } 

                    Get_WinBilling_GrpRelationships_DgvRelationships().WPFObject("RecordListControl", "", 1).Find("Value",GetData(filePath_Billing,NameSheetEndOfPeriodMIncludInAssetClass,12+z,language),100).Click();
                    Delay(300);
                    ...
                    Delay(300);
                          ...
                          Delay(200)
                           ...
                           var includedExcel=GetData(filePath_Billing,NameSheetEndOfPeriodMIncludInAssetClass,9+z,language)
                           Log.Message(9+z);
                           ...
                           var relationshipNamExel=GetData(filePath_Billing,NameSheetEndOfPeriodMIncludInAssetClass,10+z,language);
                           Log.Message(10+z);
                           ...
                           var BilledOn=GetData(filePath_Billing,NameSheetEndOfPeriodMIncludInAssetClass,12+z,language);
                           Log.Message(12+z);
                           ...
                           var LastBillingOn=GetData(filePath_Billing,NameSheetEndOfPeriodMIncludInAssetClass,13+z,language);
                           Log.Message(13+z);
                           ...
                           var aumExcel=GetData(filePath_Billing,NameSheetEndOfPeriodMIncludInAssetClass,14+z,language);
                           Log.Message(14+z);
                          ...
                          // vérifier la valeur de Fees
                           ...
                           var FeesExcel=GetData(filePath_Billing,NameSheetEndOfPeriodMIncludInAssetClass,15+z,language);
                           Log.Message(15+z);
                           ...
                           var CurrencyExcel=GetData(filePath_Billing,NameSheetEndOfPeriodMIncludInAssetClass,16+z,language);
                           Log.Message(16+z);
                           ...
                           var aumFirmCurrencyExcel=GetData(filePath_Billing,NameSheetEndOfPeriodMIncludInAssetClass,17+z,language);
                           Log.Message(17+z);
                           ...
                           var CurrencyfirmeExcel=GetData(filePath_Billing,NameSheetEndOfPeriodMIncludInAssetClass,18+z,language);
                           Log.Message(18+z);
                           ...
                           var AUMExcludedExcel=GetData(filePath_Billing,NameSheetEndOfPeriodMIncludInAssetClass,19+z,language);
                           Log.Message(19+z);
                           ...
                           var AUMForCalculationExcel=GetData(filePath_Billing,NameSheetEndOfPeriodMIncludInAssetClass,20+z,language);
                           Log.Message(20+z);
                           ...
                           var AUMforFirmCurrExcel=GetData(filePath_Billing,NameSheetEndOfPeriodMIncludInAssetClass,21+z,language);
                           Log.Message(21+z);
                           ...
                           var FrequencyExcel=GetData(filePath_Billing,NameSheetEndOfPeriodMIncludInAssetClass,22+z,language);
                           Log.Message(22+z);
                           ...
                           var periodeExcel=GetData(filePath_Billing,NameSheetEndOfPeriodMIncludInAssetClass,23+z,language);
                           Log.Message(23+z);
                           ...
                           var IAcodeExcel=GetData(filePath_Billing,NameSheetEndOfPeriodMIncludInAssetClass,24+z,language);
                           Log.Message(24+z);
                           ...
                           var NombreCompteExcel=GetData(filePath_Billing,NameSheetEndOfPeriodMIncludInAssetClass,25+z,language);
                           Log.Message(25+z);
                           ...
                           var CFAdjustementExcel=GetData(filePath_Billing,NameSheetEndOfPeriodMIncludInAssetClass,26+z,language);
                           Log.Message(26+z);
...
for(var j=0;j<45;j++){ 
    // Vérifier la partie des comptes
                           ...
                           var IncludedAccomptExcel=GetData(filePath_Billing,NameSheetEndOfPeriodMIncludInAssetClass,9,language);
                           ...
                           var AccountNubrAccountExcel=GetData(filePath_Billing,NameSheetEndOfPeriodMIncludInAssetClass,27+j+z,language);
                           Log.Message(27+j+z);
                           ...
                           var ClientNameAccountExcel=GetData(filePath_Billing,NameSheetEndOfPeriodMIncludInAssetClass,28+j+z,language);
                           Log.Message(28+j+z);
                           ...
                           var BilledFeesAccountExcel=GetData(filePath_Billing,NameSheetEndOfPeriodMIncludInAssetClass,29+j+z,language);
                           Log.Message(29+j+z);
                           ...
                           var SpecialFeesAccountExcel=GetData(filePath_Billing,NameSheetEndOfPeriodMIncludInAssetClass,30+j+z,language);
                           Log.Message(30+j+z);
                          ...
                          //Vérifier Currency
                           ...
                           var CurrencyAccountExcel=GetData(filePath_Billing,NameSheetEndOfPeriodMIncludInAssetClass,31+j+z,language);
                           Log.Message(31+j+z);
                           ...
                           var BilledAccountAccountExcel=GetData(filePath_Billing,NameSheetEndOfPeriodMIncludInAssetClass,32+j+z,language);
                           Log.Message(32+j+z);
                           ...
                           var BilledonAccountExcel=GetData(filePath_Billing,NameSheetEndOfPeriodMIncludInAssetClass,33+j+z,language);
                           Log.Message(33+j+z);
                           ...
                           var IACodeAccountExcel=GetData(filePath_Billing,NameSheetEndOfPeriodMIncludInAssetClass,34+j+z,language);
                           Log.Message(34+j+z);
                           ...
                           var AUMAccountExcel=GetData(filePath_Billing,NameSheetEndOfPeriodMIncludInAssetClass,35+j+z,language);
                           Log.Message(35+j+z);
                           ...
                           var AUMExcludedAccountExcel=GetData(filePath_Billing,NameSheetEndOfPeriodMIncludInAssetClass,36+j+z,language);
                           Log.Message(36+j+z);
                           ...
                           var UMForCalculationAccountExcel=GetData(filePath_Billing,NameSheetEndOfPeriodMIncludInAssetClass,37+j+z,language);
                           Log.Message(37+j+z);
                           ...
                           var WeightingAccountExcel=GetData(filePath_Billing,NameSheetEndOfPeriodMIncludInAssetClass,38+j+z,language);
                           Log.Message(38+j+z);
                           ...
                           var CFAdjustementAccountExcel=GetData(filePath_Billing,NameSheetEndOfPeriodMIncludInAssetClass,39+j+z,language);
                           Log.Message(39+j+z);
                          ...
                          Delay(400);
                           ...
                           var ClassFeesAccountExcel=GetData(filePath_Billing,NameSheetEndOfPeriodMIncludInAssetClass,40+j+z+d+s,language);
                           ...
                           var AssetAccountExcel=GetData(filePath_Billing,NameSheetEndOfPeriodMIncludInAssetClass,41+j+z+d+s,language);
                           ...
                           var AssetValueAccountExcel=GetData(filePath_Billing,NameSheetEndOfPeriodMIncludInAssetClass,42+j+z+d+s,language);
                           ...
                           var RateAccountExcel=GetData(filePath_Billing,NameSheetEndOfPeriodMIncludInAssetClass,43+j+z+d+s,language);
                           ...
                           var FeeAccountExcel=GetData(filePath_Billing,NameSheetEndOfPeriodMIncludInAssetClass,44+j+z+d+s,language);
                           ...
                           var CFAdjustementAccountExcel=GetData(filePath_Billing,NameSheetEndOfPeriodMIncludInAssetClass,45+j+z+d+s,language);
                          ...
                          Delay(200);
                           ...
                           var ligneselection=GetData(filePath_Billing,NameSheetEndOfPeriodMIncludInAssetClass,12+z,language);
            ...
            //   else { Continue();} 
             ...
             aqObject.CheckProperty(Get_WinBilling_GrpSummaryCAD_TxtBillingDate(), "WPFControlText", cmpEqual, GetData(filePath_Billing,NameSheetEndOfPeriodMIncludInAssetClass,561,language));
             
             aqObject.CheckProperty(Get_WinBilling_GrpSummaryCAD_TxtTotalFees(), "Enabled", cmpEqual, true);
             aqObject.CheckProperty(Get_WinBilling_GrpSummaryCAD_TxtTotalFees(), "WPFControlText", cmpEqual, GetData(filePath_Billing,NameSheetEndOfPeriodMIncludInAssetClass,562,language));
            
             aqObject.CheckProperty( Get_WinBilling_GrpSummaryCAD_TxtIATotalFeesBD88(), "WPFControlText", cmpEqual, GetData(filePath_Billing,NameSheetEndOfPeriodMIncludInAssetClass,563,language));
             aqObject.CheckProperty( Get_WinBilling_GrpSummaryCAD_TxtIATotalFees9047763(), "WPFControlText", cmpEqual, GetData(filePath_Billing,NameSheetEndOfPeriodMIncludInAssetClass,564,language));
