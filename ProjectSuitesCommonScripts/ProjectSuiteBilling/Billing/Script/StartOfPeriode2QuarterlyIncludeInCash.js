...
function StartOfPeriode2QuarterlyIncludeInCash()
{
           ...
           /* Activate_Inactivate_PrefBranch("0","PREF_BILLING_FEESCHEDULE","YES",vServerBilling);
            ...
            Login(vServerBilling, userNameBilling, pswBilling, language);
             Delay(800)
              if(client == "BNC")
              {
                var  NameSheetStart_period2_QIncludeInCash ="Start_period2_QIncludeInCashBNC"
                
              }
              if(client == "US")
              {
                var  NameSheetStart_period2_QIncludeInCash ="Start_period2_QIncludeInCash"
              }
...
// click sur la premiére ligne de la partie de relationShips
                    ...
                    Get_WinBilling_GrpRelationships_DgvRelationships().WPFObject("RecordListControl", "", 1).Find("Value",GetData(filePath_Billing,NameSheetStart_period2_QIncludeInCash,12+z,language),100).Click();
                    Delay(300);
                    ...
                    Delay(300);
                          ...
                          Delay(200)
                           ...
                           var includedExcel=GetData(filePath_Billing,NameSheetStart_period2_QIncludeInCash,9+z,language)
                           Log.Message(9+z);
                           ...
                           var relationshipNamExel=GetData(filePath_Billing,NameSheetStart_period2_QIncludeInCash,10+z,language);
                           Log.Message(10+z);
                           ...
                           var BilledOn=GetData(filePath_Billing,NameSheetStart_period2_QIncludeInCash,12+z,language);
                           Log.Message(12+z);
                           ...
                           var LastBillingOn=GetData(filePath_Billing,NameSheetStart_period2_QIncludeInCash,13+z,language);
                           Log.Message(13+z);
                           ...
                           var aumExcel=GetData(filePath_Billing,NameSheetStart_period2_QIncludeInCash,14+z,language);
                           Log.Message(14+z);
                          ...
                          // vérifier la valeur de Fees
                           ...
                           var FeesExcel=GetData(filePath_Billing,NameSheetStart_period2_QIncludeInCash,15+z,language);
                           Log.Message(15+z);
                           ...
                           var CurrencyExcel=GetData(filePath_Billing,NameSheetStart_period2_QIncludeInCash,16+z,language);
                           Log.Message(16+z);
                           ...
                           var aumFirmCurrencyExcel=GetData(filePath_Billing,NameSheetStart_period2_QIncludeInCash,17+z,language);
                           Log.Message(17+z);
                           ...
                           var CurrencyfirmeExcel=GetData(filePath_Billing,NameSheetStart_period2_QIncludeInCash,18+z,language);
                           Log.Message(18+z);
                           ...
                           var AUMExcludedExcel=GetData(filePath_Billing,NameSheetStart_period2_QIncludeInCash,19+z,language);
                           Log.Message(19+z);
                           ...
                           var AUMForCalculationExcel=GetData(filePath_Billing,NameSheetStart_period2_QIncludeInCash,20+z,language);
                           Log.Message(20+z);
                           ...
                           var AUMforFirmCurrExcel=GetData(filePath_Billing,NameSheetStart_period2_QIncludeInCash,21+z,language);
                           Log.Message(21+z);
                           ...
                           var FrequencyExcel=GetData(filePath_Billing,NameSheetStart_period2_QIncludeInCash,22+z,language);
                           Log.Message(22+z);
                           ...
                           var periodeExcel=GetData(filePath_Billing,NameSheetStart_period2_QIncludeInCash,23+z,language);
                           Log.Message(23+z);
                           ...
                           var IAcodeExcel=GetData(filePath_Billing,NameSheetStart_period2_QIncludeInCash,24+z,language);
                           Log.Message(24+z);
                           ...
                           var NombreCompteExcel=GetData(filePath_Billing,NameSheetStart_period2_QIncludeInCash,25+z,language);
                           Log.Message(25+z);
                           ...
                           var CFAdjustementExcel=GetData(filePath_Billing,NameSheetStart_period2_QIncludeInCash,26+z,language);
                           Log.Message(26+z);
...
for(var j=0;j<44;j++){ 
    // Vérifier la partie des comptes
                           ...
                           var IncludedAccomptExcel=GetData(filePath_Billing,NameSheetStart_period2_QIncludeInCash,9,language);
                           ...
                           var AccountNubrAccountExcel=GetData(filePath_Billing,NameSheetStart_period2_QIncludeInCash,27+j+z,language);
                           Log.Message(27+j+z);
                           ...
                           var ClientNameAccountExcel=GetData(filePath_Billing,NameSheetStart_period2_QIncludeInCash,28+j+z,language);
                           Log.Message(28+j+z);
                           ...
                           var BilledFeesAccountExcel=GetData(filePath_Billing,NameSheetStart_period2_QIncludeInCash,29+j+z,language);
                           Log.Message(29+j+z);
                           ...
                           var SpecialFeesAccountExcel=GetData(filePath_Billing,NameSheetStart_period2_QIncludeInCash,30+j+z,language);
                           Log.Message(30+j+z);
                          ...
                          //Vérifier Currency
                           ...
                           var CurrencyAccountExcel=GetData(filePath_Billing,NameSheetStart_period2_QIncludeInCash,31+j+z,language);
                           Log.Message(31+j+z);
                           ...
                           var BilledAccountAccountExcel=GetData(filePath_Billing,NameSheetStart_period2_QIncludeInCash,32+j+z,language);
                           Log.Message(32+j+z);
                           ...
                           var BilledonAccountExcel=GetData(filePath_Billing,NameSheetStart_period2_QIncludeInCash,33+j+z,language);
                           Log.Message(33+j+z);
                           ...
                           var IACodeAccountExcel=GetData(filePath_Billing,NameSheetStart_period2_QIncludeInCash,34+j+z,language);
                           Log.Message(34+j+z);
                           ...
                           var AUMAccountExcel=GetData(filePath_Billing,NameSheetStart_period2_QIncludeInCash,35+j+z,language);
                           Log.Message(35+j+z);
                           ...
                           var AUMExcludedAccountExcel=GetData(filePath_Billing,NameSheetStart_period2_QIncludeInCash,36+j+z,language);
                           Log.Message(36+j+z);
                           ...
                           var UMForCalculationAccountExcel=GetData(filePath_Billing,NameSheetStart_period2_QIncludeInCash,37+j+z,language);
                           Log.Message(37+j+z);
                           ...
                           var WeightingAccountExcel=GetData(filePath_Billing,NameSheetStart_period2_QIncludeInCash,38+j+z,language);
                           Log.Message(38+j+z);
                           ...
                           var CFAdjustementAccountExcel=GetData(filePath_Billing,NameSheetStart_period2_QIncludeInCash,39+j+z,language);
                           Log.Message(39+j+z);
                       ...
                       if( GetData(filePath_Billing,NameSheetStart_period2_QIncludeInCash,27+j+z,language) ==  GetData(filePath_Billing,NameSheetStart_period2_QIncludeInCash,27,language)  && countExplospluscount == 5)
                           {
                         
                           Log.Checkpoint("Le nombre des élements de la grille Feees est correcte")
                            }
                           else if (GetData(filePath_Billing,NameSheetStart_period2_QIncludeInCash,27+j+z,language) ==  GetData(filePath_Billing,NameSheetStart_period2_QIncludeInCash,70,language) && countExplospluscount == 3)
                           {
                           Log.Checkpoint("Le nombre des élements de la grille Feees est correcte");}
                           
                           else {
                           if(GetData(filePath_Billing,NameSheetStart_period2_QIncludeInCash,27+j+z,language) ==  GetData(filePath_Billing,NameSheetStart_period2_QIncludeInCash,27,language) && countExplospluscount == 4){
                             Log.Checkpoint("Le nombre des élements de la grille Feees est correcte" )
                           } 
                           else {
                          ...
                          Log.Message(" Le nombre de la grille de Feees")
                           ...
                           Log.Message(countExplospluscount);
                                     ...
                                     //Vérifier  Class de Fees
                                      ...
                                      var ClassFeesAccountExcel=GetData(filePath_Billing,NameSheetStart_period2_QIncludeInCash,40+z+d+s+j,language);
                                      ...
                                      var AssetAccountExcel=GetData(filePath_Billing,NameSheetStart_period2_QIncludeInCash,41+z+d+s+j,language);
                                      ...
                                      var AssetValueAccountExcel=GetData(filePath_Billing,NameSheetStart_period2_QIncludeInCash,42+z+d+s+j,language);
                                      ...
                                      var RateAccountExcel=GetData(filePath_Billing,NameSheetStart_period2_QIncludeInCash,43+z+d+s+j,language);
                                      ...
                                      var FeeAccountExcel=GetData(filePath_Billing,NameSheetStart_period2_QIncludeInCash,44+z+d+s+j,language);
                                      ...
                                      var CFAdjustementAccountExcel=GetData(filePath_Billing,NameSheetStart_period2_QIncludeInCash,45+z+d+s+j,language);
                          ...
                          Delay(200);
                           ...
                           var ligneselection=GetData(filePath_Billing,NameSheetStart_period2_QIncludeInCash,12+z,language);
             ...
             aqObject.CheckProperty(Get_WinBilling_GrpSummaryCAD_TxtBillingDate(), "WPFControlText", cmpEqual, GetData(filePath_Billing,NameSheetStart_period2_QIncludeInCash,327,language));
             
             aqObject.CheckProperty(Get_WinBilling_GrpSummaryCAD_TxtTotalFees(), "Enabled", cmpEqual, true);
             aqObject.CheckProperty(Get_WinBilling_GrpSummaryCAD_TxtTotalFees(), "WPFControlText", cmpEqual, GetData(filePath_Billing,NameSheetStart_period2_QIncludeInCash,328,language));
            
             aqObject.CheckProperty( Get_WinBilling_GrpSummaryCAD_TxtIATotalFeesBD88(), "WPFControlText", cmpEqual, GetData(filePath_Billing,NameSheetStart_period2_QIncludeInCash,329,language));
             aqObject.CheckProperty( Get_WinBilling_GrpSummaryCAD_TxtIATotalFees9047763(), "WPFControlText", cmpEqual, GetData(filePath_Billing,NameSheetStart_period2_QIncludeInCash,330,language));
