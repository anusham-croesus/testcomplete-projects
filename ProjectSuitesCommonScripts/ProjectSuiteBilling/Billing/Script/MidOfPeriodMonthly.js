...
function MidOfPeriodMonthly()
{
      ...
      try {
          ...
          // Activer la préférence PREF_BILLING_PROCESS pour l'user 
           /* Activate_Inactivate_PrefBranch("0","PREF_BILLING_FEESCHEDULE","YES",vServerBilling);
            ...
            Login(vServerBilling, userNameBilling, pswBilling, language);
             if(client == "BNC")
              {
                var  NameSheetMidOfPeriodM ="MidOfPeriodMBNC"
                
              }
              if(client == "US")
              {
                var  NameSheetMidOfPeriodM = "MidOfPeriodM"
              }
            Delay(1000);
          ...
          // double click sur la relation Billing Relation
            ...
            FillInTheBottomPartOfAccounts(173);
            Delay(1000);
          ...
          if(client == "US"){
             if(count==12)
             {
                    for(i=0;i<count;i++)
                    {
                           ...
                           var relationShipExcel=GetData(filePath_Billing,"RelationBilling",97,language)
                           
                           var messagesExcel=GetData(filePath_Billing,NameSheetMidOfPeriodM,2+i,language)
                           Log.Message(2+i);
...
// click sur la premiére ligne de la partie de relationShips
                    ...
                    Get_WinBilling_GrpRelationships_DgvRelationships().WPFObject("RecordListControl", "", 1).Find("Value",GetData(filePath_Billing,NameSheetMidOfPeriodM,18+z,language),100).Click();
                    Delay(300);
                    ...
                    Delay(300);
                          ...
                          Delay(200)
                           ...
                           var includedExcel=GetData(filePath_Billing,NameSheetMidOfPeriodM,15+z,language)
                           ...
                           var relationshipNamExel=GetData(filePath_Billing,NameSheetMidOfPeriodM,16+z,language);
                           ...
                           var BilledOn=GetData(filePath_Billing,NameSheetMidOfPeriodM,18+z,language);
                           ...
                           var LastBillingOn=GetData(filePath_Billing,NameSheetMidOfPeriodM,19+z,language);
                           ...
                           var aumExcel=GetData(filePath_Billing,NameSheetMidOfPeriodM,20+z,language);
                           ...
                           var FeesExcel=GetData(filePath_Billing,NameSheetMidOfPeriodM,21+z,language);
                           ...
                           var CurrencyExcel=GetData(filePath_Billing,NameSheetMidOfPeriodM,22+z,language);
                           ...
                           var aumFirmCurrencyExcel=GetData(filePath_Billing,NameSheetMidOfPeriodM,23+z,language);
                           ...
                           var CurrencyfirmeExcel=GetData(filePath_Billing,NameSheetMidOfPeriodM,24+z,language);
                           ...
                           var AUMExcludedExcel=GetData(filePath_Billing,NameSheetMidOfPeriodM,25+z,language);
                           ...
                           var AUMForCalculationExcel=GetData(filePath_Billing,NameSheetMidOfPeriodM,26+z,language);
                           ...
                           var AUMforFirmCurrExcel=GetData(filePath_Billing,NameSheetMidOfPeriodM,27+z,language);
                           ...
                           var FrequencyExcel=GetData(filePath_Billing,NameSheetMidOfPeriodM,28+z,language);
                           ...
                           var periodeExcel=GetData(filePath_Billing,NameSheetMidOfPeriodM,29+z,language);
                           ...
                           var IAcodeExcel=GetData(filePath_Billing,NameSheetMidOfPeriodM,30+z,language);
                           ...
                           var NombreCompteExcel=GetData(filePath_Billing,NameSheetMidOfPeriodM,31+z,language);
                           ...
                           var CFAdjustementExcel=GetData(filePath_Billing,NameSheetMidOfPeriodM,32+z,language);
...
//for(var j=0;j<33;j++){ 
    // Vérifier la partie des comptes
                           ...
                           var IncludedAccomptExcel=GetData(filePath_Billing,NameSheetMidOfPeriodM,15,language);
                           ...
                           var AccountNubrAccountExcel=GetData(filePath_Billing,NameSheetMidOfPeriodM,33+z,language);
                           ...
                           var ClientNameAccountExcel=GetData(filePath_Billing,NameSheetMidOfPeriodM,34+z,language);
                           ...
                           var BilledFeesAccountExcel=GetData(filePath_Billing,NameSheetMidOfPeriodM,35+z,language);
                           ...
                           var SpecialFeesAccountExcel=GetData(filePath_Billing,NameSheetMidOfPeriodM,36+z,language);
                          ...
                          //Vérifier Currency
                           ...
                           var CurrencyAccountExcel=GetData(filePath_Billing,NameSheetMidOfPeriodM,37+z,language);
                           ...
                           var BilledAccountAccountExcel=GetData(filePath_Billing,NameSheetMidOfPeriodM,38+z,language);
                           ...
                           var BilledonAccountExcel=GetData(filePath_Billing,NameSheetMidOfPeriodM,39+z,language);
                           ...
                           var IACodeAccountExcel=GetData(filePath_Billing,NameSheetMidOfPeriodM,40+z,language);
                           ...
                           var AUMAccountExcel=GetData(filePath_Billing,NameSheetMidOfPeriodM,41+z,language);
                           ...
                           var AUMExcludedAccountExcel=GetData(filePath_Billing,NameSheetMidOfPeriodM,42+z,language);
                           ...
                           var UMForCalculationAccountExcel=GetData(filePath_Billing,NameSheetMidOfPeriodM,43+z,language);
                           ...
                           var WeightingAccountExcel=GetData(filePath_Billing,NameSheetMidOfPeriodM,44+z,language);
                           ...
                           var CFAdjustementAccountExcel=GetData(filePath_Billing,NameSheetMidOfPeriodM,45+z,language);
                          ...
                          for(var d=0;d<countExplospluscount;d++){  
                                     ...
                                     Log.Message(46+z+s);
                                      ...
                                      var ClassFeesAccountExcel=GetData(filePath_Billing,NameSheetMidOfPeriodM,46+z+s,language);
                                      ...
                                      var AssetAccountExcel=GetData(filePath_Billing,NameSheetMidOfPeriodM,47+z+s,language);
                                      ...
                                      var AssetValueAccountExcel=GetData(filePath_Billing,NameSheetMidOfPeriodM,48+z+s,language);
                                      ...
                                      var RateAccountExcel=GetData(filePath_Billing,NameSheetMidOfPeriodM,49+z+s,language);
                                      ...
                                      var FeeAccountExcel=GetData(filePath_Billing,NameSheetMidOfPeriodM,50+z+s,language);
                                      ...
                                      var CFAdjustementAccountExcel=GetData(filePath_Billing,NameSheetMidOfPeriodM,51+z+s,language);
                          ...
                          // j=j+30;
                           i=i+1
                          // }
                           var ligneselection=GetData(filePath_Billing,NameSheetMidOfPeriodM,18+z,language);
                           Log.Message("Fin de test du ligne"+VarToStr(ligneselection));
						   z=z+37
						  }}
               else {Log.Error("Il y a une erreur dans le nombre des éléments de la grille RelationShip"); }  
             aqObject.CheckProperty(Get_WinBilling_GrpSummaryCAD_TxtBillingDate(), "WPFControlText", cmpEqual, GetData(filePath_Billing,NameSheetMidOfPeriodM,464,language));
             
             aqObject.CheckProperty(Get_WinBilling_GrpSummaryCAD_TxtTotalFees(), "Enabled", cmpEqual, true);
             aqObject.CheckProperty(Get_WinBilling_GrpSummaryCAD_TxtTotalFees(), "WPFControlText", cmpEqual, GetData(filePath_Billing,NameSheetMidOfPeriodM,465,language));
            
             aqObject.CheckProperty( Get_WinBilling_GrpSummaryCAD_TxtIATotalFeesBD88(), "WPFControlText", cmpEqual, GetData(filePath_Billing,NameSheetMidOfPeriodM,466,language));
             aqObject.CheckProperty( Get_WinBilling_GrpSummaryCAD_TxtIATotalFees9047763(), "WPFControlText", cmpEqual, GetData(filePath_Billing,NameSheetMidOfPeriodM,467,language)); 
            ...
            Get_WinDetailedInfo_TabBillingForRelationship().Click();
            Delay(800)
            FillTheCashFlowAdjustmen (GetData(filePath_Billing,"RelationBilling",159,language),GetData(filePath_Billing,"RelationBilling",159,language),GetData(filePath_Billing,"RelationBilling",161,language),GetData(filePath_Billing,"RelationBilling",161,language));
