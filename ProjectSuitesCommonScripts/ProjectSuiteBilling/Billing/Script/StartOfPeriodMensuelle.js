...
function StartOfPeriodMensuelle()
{
      ...
      try {
              ...
              var RelationShipName=GetData(filePath_Billing,"RelationBilling",93,language)
          ...
          /*   Activate_Inactivate_PrefBranch("0","PREF_BILLING_FEESCHEDULE","YES",vServerBilling);
           ...
           UncheckedBillableRelastionShip();
            ...
            Login(vServerBilling, userNameBilling, pswBilling, language);
             if(client == "BNC")
              {
                var  NameSheetStartOfPeriodMensuelle ="StartOfPeriodMensuelleBNC"
                
              }
              if(client == "US")
              {
                var  NameSheetStartOfPeriodMensuelle  ="StartOfPeriodMensuelle"
              }
            Delay(1000);
              //ouvrir le module relation
            Get_ModulesBar_BtnRelationships().Click();
            SearchRelationshipByName(GetData(filePath_Billing,"RelationBilling",93,language));
            Delay(800)
          // double click sur la relation Billing Relation
            Get_RelationshipsClientsAccountsGrid().Find("Value",GetData(filePath_Billing,"RelationBilling",93,language),100).DblClick();
            Delay(3000);
            ...
            FillTheCashFlowAdjustmen (GetData(filePath_Billing,"RelationBilling",158,language),GetData(filePath_Billing,"RelationBilling",158,language),GetData(filePath_Billing,"RelationBilling",159,language),GetData(filePath_Billing,"RelationBilling",159,language));
             ...
             Log.Message("Le nombre des éléments de la grille de la grille des messages est"+count);
              ...
              if(client == "US"){
                    for(i=0;i<count;i++)
                    {
                           ...
                           var relationShipExcel=GetData(filePath_Billing,"RelationBilling",93,language)
                           
                           var messagesExcel=GetData(filePath_Billing,"CR885",268+i,language)
                           Log.Message(268+i)
                  ...
                  { for(i=0;i<count;i++)
                    {
                           ...
                           var messagesExcel=GetData(filePath_Billing,"CR885",358+i,language)
                           Log.Message(358+i)
...
// click sur la premiére ligne de la partie de relationShips
                    ...
                    Get_WinBilling_GrpRelationships_DgvRelationships().WPFObject("RecordListControl", "", 1).Find("Value",GetData(filePath_Billing,NameSheetStartOfPeriodMensuelle,5+z,language),100).Click();
                    Delay(300);
                    ...
                    Delay(300);
                          ...
                          Delay(200)
                           ...
                           var includedExcel=GetData(filePath_Billing,NameSheetStartOfPeriodMensuelle,2+z,language)
                           Log.Message(2+z)
                           ...
                           var relationshipNamExel=GetData(filePath_Billing,NameSheetStartOfPeriodMensuelle,3+z,language);
                           Log.Message(3+z)
                           ...
                           var BilledOn=GetData(filePath_Billing,NameSheetStartOfPeriodMensuelle,5+z,language);
                           Log.Message(5+z)
                           ...
                           var LastBillingOn=GetData(filePath_Billing,NameSheetStartOfPeriodMensuelle,6+z,language);
                           Log.Message(6+z)
                           ...
                           var aumExcel=GetData(filePath_Billing,NameSheetStartOfPeriodMensuelle,7+z,language);
                           Log.Message(7+z)
                           ...
                           var FeesExcel=GetData(filePath_Billing,NameSheetStartOfPeriodMensuelle,8+z,language);
                           Log.Message(8+z)
                           ...
                           var CurrencyExcel=GetData(filePath_Billing,NameSheetStartOfPeriodMensuelle,9+z,language);
                           Log.Message(9+z)
                           ...
                           var aumFirmCurrencyExcel=GetData(filePath_Billing,NameSheetStartOfPeriodMensuelle,10+z,language);
                           Log.Message(10+z)
                           ...
                           var CurrencyfirmeExcel=GetData(filePath_Billing,NameSheetStartOfPeriodMensuelle,11+z,language);
                           Log.Message(11+z)
                           ...
                           var AUMExcludedExcel=GetData(filePath_Billing,NameSheetStartOfPeriodMensuelle,12+z,language);
                           Log.Message(12+z)
                           ...
                           var AUMForCalculationExcel=GetData(filePath_Billing,NameSheetStartOfPeriodMensuelle,13+z,language);
                           Log.Message(13+z)
                           ...
                           var AUMforFirmCurrExcel=GetData(filePath_Billing,NameSheetStartOfPeriodMensuelle,14+z,language);
                           Log.Message(14+z)
                           ...
                           var FrequencyExcel=GetData(filePath_Billing,NameSheetStartOfPeriodMensuelle,15+z,language);
                           Log.Message(15+z)
                           ...
                           var periodeExcel=GetData(filePath_Billing,NameSheetStartOfPeriodMensuelle,16+z,language);
                           Log.Message(16+z)
                           ...
                           var IAcodeExcel=GetData(filePath_Billing,NameSheetStartOfPeriodMensuelle,17+z,language);
                           Log.Message(17+z)
                           ...
                           var NombreCompteExcel=GetData(filePath_Billing,NameSheetStartOfPeriodMensuelle,18+z,language);
                           Log.Message(18+z)
                           ...
                           var CFAdjustementExcel=GetData(filePath_Billing,NameSheetStartOfPeriodMensuelle,19+z,language);
                           Log.Message(19+z)
...
for(var j=0;j<20;j++){ 
    // Vérifier la partie des comptes
                           ...
                           var IncludedAccomptExcel=GetData(filePath_Billing,NameSheetStartOfPeriodMensuelle,2,language);
                           Log.Message(2);
                           ...
                           var AccountNubrAccountExcel=GetData(filePath_Billing,NameSheetStartOfPeriodMensuelle,20+j+z,language);
                           Log.Message(20+j+z)
                           ...
                           var ClientNameAccountExcel=GetData(filePath_Billing,NameSheetStartOfPeriodMensuelle,21+j+z,language);
                           Log.Message(21+j+z)
                           ...
                           var BilledFeesAccountExcel=GetData(filePath_Billing,NameSheetStartOfPeriodMensuelle,22+j+z,language);
                           Log.Message(22+j+z)
                           ...
                           var SpecialFeesAccountExcel=GetData(filePath_Billing,NameSheetStartOfPeriodMensuelle,23+j+z,language);
                           Log.Message(23+j+z)
                           CheckEquals(VarToStr(BilledFeesAccount),VarToStr(BilledFeesAccountExcel), "Valeur de Special Fees");
                          ...
                          //Vérifier Currency
                           ...
                           var CurrencyAccountExcel=GetData(filePath_Billing,NameSheetStartOfPeriodMensuelle,24+j+z,language);
                           Log.Message(24+j+z)
                           ...
                           var BilledAccountAccountExcel=GetData(filePath_Billing,NameSheetStartOfPeriodMensuelle,25+j+z,language);
                           Log.Message(25+j+z)
                           ...
                           var BilledonAccountExcel=GetData(filePath_Billing,NameSheetStartOfPeriodMensuelle,26+j+z,language);
                           Log.Message(26+j+z)
                           ...
                           var IACodeAccountExcel=GetData(filePath_Billing,NameSheetStartOfPeriodMensuelle,27+j+z,language);
                           Log.Message(27+j+z)
                           ...
                           var AUMAccountExcel=GetData(filePath_Billing,NameSheetStartOfPeriodMensuelle,28+j+z,language);
                           Log.Message(28+j+z)
                           ...
                           var AUMExcludedAccountExcel=GetData(filePath_Billing,NameSheetStartOfPeriodMensuelle,29+j+z,language);
                           Log.Message(28+j+z)
                           ...
                           var UMForCalculationAccountExcel=GetData(filePath_Billing,NameSheetStartOfPeriodMensuelle,30+j+z,language);
                           Log.Message(30+j+z)
                           ...
                           var WeightingAccountExcel=GetData(filePath_Billing,NameSheetStartOfPeriodMensuelle,31+j+z,language);
                           Log.Message(31+j+z)
                           ...
                           var CFAdjustementAccountExcel=GetData(filePath_Billing,NameSheetStartOfPeriodMensuelle,32+j+z,language);
                           Log.Message(32+j+z)
                          ...
                          Delay(400);
                           ...
                           var ClassFeesAccountExcel=GetData(filePath_Billing,NameSheetStartOfPeriodMensuelle,33+j+z,language);
                           Log.Message(33+j+z)
                           ...
                           var AssetAccountExcel=GetData(filePath_Billing,NameSheetStartOfPeriodMensuelle,34+j+z,language);
                           Log.Message(34+j+z)
                           ...
                           var AssetValueAccountExcel=GetData(filePath_Billing,NameSheetStartOfPeriodMensuelle,35+j+z,language);
                           Log.Message(35+j+z)
                           ...
                           var RateAccountExcel=GetData(filePath_Billing,NameSheetStartOfPeriodMensuelle,36+j+z,language);
                           Log.Message(36+j+z)
                           ...
                           var FeeAccountExcel=GetData(filePath_Billing,NameSheetStartOfPeriodMensuelle,37+j+z,language);
                           Log.Message(37+j+z)
                           ...
                           var CFAdjustementAccountExcel=GetData(filePath_Billing,NameSheetStartOfPeriodMensuelle,38+j+z,language);
                           Log.Message(38+j+z)
                           CheckEquals(VarToFloat(CFAdjustementAccount),VarToFloat(CFAdjustementAccountExcel), "Valeur de CF Adjustement");
                           //Exploser le -
                          ...
                          Delay(200);
                           ...
                           var ligneselection=GetData(filePath_Billing,NameSheetStartOfPeriodMensuelle,5+z,language);
                           Log.Message("Fin de test du ligne"+VarToStr(ligneselection));
						   z=z+56
						  }}
              else {Log.Error("Il y a une erreur dans le nombre des éléments de la grille de la RelationShip"); } 
             ...
             aqObject.CheckProperty(Get_WinBilling_GrpSummaryCAD_TxtBillingDate(), "WPFControlText", cmpEqual, GetData(filePath_Billing,NameSheetStartOfPeriodMensuelle,679,language));
             
             aqObject.CheckProperty(Get_WinBilling_GrpSummaryCAD_TxtTotalFees(), "Enabled", cmpEqual, true);
             aqObject.CheckProperty(Get_WinBilling_GrpSummaryCAD_TxtTotalFees(), "WPFControlText", cmpEqual, GetData(filePath_Billing,NameSheetStartOfPeriodMensuelle,680,language));
            
             aqObject.CheckProperty( Get_WinBilling_GrpSummaryCAD_TxtIATotalFeesBD88(), "WPFControlText", cmpEqual, GetData(filePath_Billing,NameSheetStartOfPeriodMensuelle,681,language));
             aqObject.CheckProperty( Get_WinBilling_GrpSummaryCAD_TxtIATotalFees9047763(), "WPFControlText", cmpEqual, GetData(filePath_Billing,NameSheetStartOfPeriodMensuelle,682,language));
            ...
            Get_WinDetailedInfo_TabBillingForRelationship().Click();
            Delay(800)
            FillTheCashFlowAdjustmen (GetData(filePath_Billing,"RelationBilling",158,language),GetData(filePath_Billing,"RelationBilling",158,language),GetData(filePath_Billing,"RelationBilling",161,language),GetData(filePath_Billing,"RelationBilling",161,language));
