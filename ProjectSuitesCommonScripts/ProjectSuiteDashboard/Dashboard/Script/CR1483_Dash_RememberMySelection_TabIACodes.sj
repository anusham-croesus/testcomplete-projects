...
function CR1483_Dash_RememberMySelection_TabIACodes() 
{
            ...
            CR1483_RememberMySelection(vServerDashboard,Get_ModulesBar_BtnDashboard(),"IACodes", filePath_Dashboard, "BD88");
}