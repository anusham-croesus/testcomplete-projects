...
function CR1483_Dash_Survol_Users_Selection_TabUsers() 
{
            ...
            CR1483_Survol_Users_Selection_TabUsers(vServerDashboard,Get_ModulesBar_BtnDashboard(),filePath_Dashboard);
}
