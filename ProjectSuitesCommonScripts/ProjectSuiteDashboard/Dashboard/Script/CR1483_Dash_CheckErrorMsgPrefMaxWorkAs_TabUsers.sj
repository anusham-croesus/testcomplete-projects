...
function CR1483_Dash_CheckErrorMsgPrefMaxWorkAs_TabUsers() 
{
            ...
            CR1483_CheckErrorMsgPrefMaxWorkAs(vServerDashboard ,Get_ModulesBar_BtnDashboard(),"Users",filePath_Dashboard,"CR1483_WinSelection_TabUsers_ErrorMsg" );    
}
