...
/* Description : À partir du module « Dashboard », afficher la fenêtre « Gestion de portefeuilles » en cliquant sur Toolbar - BtnQLockTheApplication . 
 Vérifier la présence des contrôles et des étiquettes. Par la suite, remplie un bonne psw cliquer sur le btn Ok, vérifier que l’application n’a pas été fermée */
  
function Survol_Dash_ToolBar_BtnLockTheApplication_BtnOk_WithPSW()
{
