          ...
          try {
                    ...
                    }else
                    {
                        ...
                        }else
                        {
                            ...
                            //Valider les codes de CP affichés dans les grilles Dashboard que juste "BD88"
                            var PosCashBalSum = Aliases.CroesusApp.winMain.DashboardPlugin.Dashboard.WPFObject("ScrollableContainer", "", 1).WPFObject("ScrollViewer").WPFObject("UpperCashBalanceSummaryBoard", "", 1).WPFObject("_dashboardGrid").WPFObject("RecordListControl", "", 1);
                            var NegCashBalSum = Aliases.CroesusApp.winMain.DashboardPlugin.Dashboard.WPFObject("ScrollableContainer", "", 1).WPFObject("ScrollViewer").WPFObject("LowerCashBalanceSummaryBoard", "", 1).WPFObject("_dashboardGrid").WPFObject("RecordListControl", "", 1);
                            var InvObjVar = Aliases.CroesusApp.winMain.DashboardPlugin.Dashboard.WPFObject("ScrollableContainer", "", 1).WPFObject("ScrollViewer").WPFObject("UnsynchronizedAccountsBoard", "", 1).WPFObject("_dashboardGrid").WPFObject("RecordListControl", "", 1);
                            
                            Log.Message("Validation des codes CP pour la grille Positive Cash Balance Summary");
                            CheckSelectedIACodes(ItemSelection,PosCashBalSum); 
                            Log.Message("Validation des codes CP pour la grille Negative Cash Balance Summary");
                            CheckSelectedIACodes(ItemSelection,NegCashBalSum);
                            Log.Message("Validation des codes CP pour la grille Investment Objective Variation");
                            CheckSelectedIACodes(ItemSelection,InvObjVar);
                            Log.Message("La grille Birthdays est vide");
...
function CheckSelectedIACodes(IACode,Grid){
    
    var NbrItem = Grid.Items.Count;
    Log.Message("Le nombre de items qui ont le code de CP "+IACode+" est : "+NbrItem);
    for (var i=0; i<NbrItem; i++)
    {
      var Item = Grid.Items.Item(i).DataItem.RepresentativeNumber;
...
function CR1483_Check_BranchSelection_IACodes(vServer,Button,BranchSelection) {
          ...
          try {
                   ...
                   // var BranchSelection = "Toronto";
                    ...
                    //Valider dans les  grilles client que seulement les code de CP qui commence par AC sont affichés
                    var PosCashBalSum = Aliases.CroesusApp.winMain.DashboardPlugin.Dashboard.WPFObject("ScrollableContainer", "", 1).WPFObject("ScrollViewer").WPFObject("UpperCashBalanceSummaryBoard", "", 1).WPFObject("_dashboardGrid").WPFObject("RecordListControl", "", 1);
                    var NegCashBalSum = Aliases.CroesusApp.winMain.DashboardPlugin.Dashboard.WPFObject("ScrollableContainer", "", 1).WPFObject("ScrollViewer").WPFObject("LowerCashBalanceSummaryBoard", "", 1).WPFObject("_dashboardGrid").WPFObject("RecordListControl", "", 1);
                    var InvObjVar = Aliases.CroesusApp.winMain.DashboardPlugin.Dashboard.WPFObject("ScrollableContainer", "", 1).WPFObject("ScrollViewer").WPFObject("UnsynchronizedAccountsBoard", "", 1).WPFObject("_dashboardGrid").WPFObject("RecordListControl", "", 1);
                    var Birthdays = Aliases.CroesusApp.winMain.DashboardPlugin.Dashboard.WPFObject("ScrollableContainer", "", 1).WPFObject("ScrollViewer").WPFObject("ScheduleBoard", "", 1).WPFObject("TabContainer", "", 1).WPFObject("Birthdays", "", 1).WPFObject("_dashboardGrid").WPFObject("RecordListControl", "", 1);
                    
                    Log.Message("Validation des codes CP pour la grille Positive Cash Balance Summary");
                    CheckSelectedBranchIACodes(BranchSelection,PosCashBalSum); 
                    Log.Message("Validation des codes CP pour la grille Negative Cash Balance Summary");
                    CheckSelectedBranchIACodes(BranchSelection,NegCashBalSum);
                    Log.Message("Validation des codes CP pour la grille Investment Objective Variation");
                    CheckSelectedBranchIACodes(BranchSelection,InvObjVar);
                    Log.Message("Validation des codes CP pour la grille Birthdays");
                    CheckSelectedBranchIACodes(BranchSelection,Birthdays);  
...
function CheckSelectedBranchIACodes(BranchName,Grid){
    
    var NbrItem = Grid.Items.Count;
    Log.Message("Le nombre de Items pour la succursale "+BranchName+" est : "+NbrItem);
    for (var i=0; i<NbrItem; i++)
    {
      var Item = Grid.Items.Item(i).DataItem.RepresentativeNumber;
...
function CR1483_Check_UserSelection_IACodes(vServer,Button,UserSelection,IACode1, IACode2) {
          ...
          try {
                    ...
                    if (Button.Pad.Text.OleValue != Get_ModulesBar_BtnDashboard().Pad.Text.OleValue )
                      Login(vServer, userNameUNI00, passwordUNI00, language);
                    Button.Click();
                    Button.WaitProperty("IsChecked", true, 30000);  
                    Get_MainWindow().Maximize();
                    ...
                    //Valider dans les grilles Dashboard que seulement les code de CP "BD88" et "OAED" sont affichés
                    var PosCashBalSum = Aliases.CroesusApp.winMain.DashboardPlugin.Dashboard.WPFObject("ScrollableContainer", "", 1).WPFObject("ScrollViewer").WPFObject("UpperCashBalanceSummaryBoard", "", 1).WPFObject("_dashboardGrid").WPFObject("RecordListControl", "", 1);
                    var NegCashBalSum = Aliases.CroesusApp.winMain.DashboardPlugin.Dashboard.WPFObject("ScrollableContainer", "", 1).WPFObject("ScrollViewer").WPFObject("LowerCashBalanceSummaryBoard", "", 1).WPFObject("_dashboardGrid").WPFObject("RecordListControl", "", 1);
                    var InvObjVar = Aliases.CroesusApp.winMain.DashboardPlugin.Dashboard.WPFObject("ScrollableContainer", "", 1).WPFObject("ScrollViewer").WPFObject("UnsynchronizedAccountsBoard", "", 1).WPFObject("_dashboardGrid").WPFObject("RecordListControl", "", 1);
                    var Birthdays = Aliases.CroesusApp.winMain.DashboardPlugin.Dashboard.WPFObject("ScrollableContainer", "", 1).WPFObject("ScrollViewer").WPFObject("ScheduleBoard", "", 1).WPFObject("TabContainer", "", 1).WPFObject("Birthdays", "", 1).WPFObject("_dashboardGrid").WPFObject("RecordListControl", "", 1);
                    Log.Message("Validation des codes CP pour la grille Positive Cash Balance Summary");
                    CheckSelectedMultiIACodes(IACode1,IACode2,PosCashBalSum); 
                    Log.Message("Validation des codes CP pour la grille Negative Cash Balance Summary");
                    CheckSelectedMultiIACodes(IACode1,IACode2,NegCashBalSum);
                    Log.Message("Validation des codes CP pour la grille Investment Objective Variation");
                    CheckSelectedMultiIACodes(IACode1,IACode2,InvObjVar);
                    Log.Message("Validation des codes CP pour la grille Birthdays");
                    CheckSelectedMultiIACodes(IACode1,IACode2,Birthdays); 
...
function CheckSelectedMultiIACodes(IACode1,IACode2,Grid){
    
    var NbrItem = Grid.Items.Count;
    Log.Message("Le nombre des items qui ont le code de CP "+IACode1+" et "+ IACode2+" est : "+NbrItem);
    for (var i=0; i<NbrItem; i++)
    {
      var Item = Grid.Items.Item(i).DataItem.RepresentativeNumber;
...
function CR1483_Survol_Users_Selection_TabBranches(vServer,Button,filePath) {
          ...
          try {
                    ...
                    var ExpectedFolder = folderPath_Data+"ExportToExcel\\"+client+"\\ExpectedFolder\\Clients\\WinSelection\\"+language+"\\";
                    var ResultFolder = folderPath_Data+"ExportToExcel\\"+client+"\\ResultFolder\\Clients\\WinSelection\\"+language+"\\";  
...
function CR1483_Survol_Users_Selection_TabIACodes(vServer, Button, filePath) {
          ...
          try {
                    ...
                    var ExpectedFolder = folderPath_Data+"ExportToExcel\\"+client+"\\ExpectedFolder\\Dashboard\\WinSelection\\"+language+"\\";
                    var ResultFolder = folderPath_Data+"ExportToExcel\\"+client+"\\ResultFolder\\Dashboard\\WinSelection\\"+language+"\\";  
