...
/**
    ...
    Dashboard/Negative Balance Summary
...
function CROES_9345_Dash_NegBalSum_ExcelExportDoesNotRespectOrderOfColumnsInGrid() {
          ...
          try {
                    ...
                    Get_Dashboard_NegativeCashBalanceSummaryBoard_ChName().Click();
                    Get_Dashboard_NegativeCashBalanceSummaryBoard_ChName().ClickR();
                    Get_GridHeader_ContextualMenu_DefaultConfiguration().Click();
                    
                    //Click the button export excel 
                    Get_Dashboard_NegativeCashBalanceSummaryBoard().FindChild("Uid", "ContentControl_d78f", 10).Click();
                    Get_Dashboard_NegativeCashBalanceSummaryBoard().Find("Uid", "ContentControl_d78f", 10).ClickR();
                    ...
                    aqObject.CheckProperty(Get_Dashboard_NegativeCashBalanceSummaryBoard_ChCheckBoxOnOff(), "Content", cmpEqual,textArrUnquote0);
                    aqObject.CheckProperty(Get_Dashboard_NegativeCashBalanceSummaryBoard_ChBalance(), "Content", cmpEqual, textArrUnquote1);
                    aqObject.CheckProperty(Get_Dashboard_NegativeCashBalanceSummaryBoard_ChAccountNo(), "Content", cmpEqual, textArrUnquote2);
                    aqObject.CheckProperty(Get_Dashboard_NegativeCashBalanceSummaryBoard_ChName(), "Content", cmpEqual, textArrUnquote3);
                    aqObject.CheckProperty(Get_Dashboard_NegativeCashBalanceSummaryBoard_ChIACode(), "Content", cmpEqual, textArrUnquote4);
                    aqObject.CheckProperty(Get_Dashboard_NegativeCashBalanceSummaryBoard_ChTelephone1(), "Content", cmpEqual, textArrUnquote5);
                    aqObject.CheckProperty(Get_Dashboard_NegativeCashBalanceSummaryBoard_ChCurrency(), "Content", cmpEqual, textArrUnquote6);
                    aqObject.CheckProperty(Get_Dashboard_NegativeCashBalanceSummaryBoard_ChAssignedTo(), "Content", cmpEqual, textArrUnquote7);
                    ...
                    aqObject.CheckProperty(Get_Dashboard_NegativeCashBalanceSummaryBoard_ChBalance(), "Content", cmpEqual, textArrUnquote1);
                    aqObject.CheckProperty(Get_Dashboard_NegativeCashBalanceSummaryBoard_ChAccountNo(), "Content", cmpEqual, textArrUnquote2);  
                    aqObject.CheckProperty(Get_Dashboard_NegativeCashBalanceSummaryBoard_ChIACode(), "Content", cmpEqual, textArrUnquote3);
                    aqObject.CheckProperty(Get_Dashboard_NegativeCashBalanceSummaryBoard_ChTelephone1(), "Content", cmpEqual, textArrUnquote4);
                    aqObject.CheckProperty(Get_Dashboard_NegativeCashBalanceSummaryBoard_ChAge(), "Content", cmpEqual, textArrUnquote5);
                    aqObject.CheckProperty(Get_Dashboard_NegativeCashBalanceSummaryBoard_ChAssignedTo(), "Content", cmpEqual, textArrUnquote6);
                    aqObject.CheckProperty(Get_Dashboard_NegativeCashBalanceSummaryBoard_ChName(), "Content", cmpEqual, textArrUnquote7);
...
function AddRemoveMoveColumns(){
        ...
        Get_Dashboard_NegativeCashBalanceSummaryBoard_ChCurrency().Click();
        Get_Dashboard_NegativeCashBalanceSummaryBoard_ChCurrency().ClickR();
        ...
        WaitObject(Get_Dashboard_NegativeCashBalanceSummaryBoard(),["ClrClassName", "WPFControlOrdinalNo"],["LabelPresenter", "4"],10);
        Get_Dashboard_NegativeCashBalanceSummaryBoard_ChCurrency().Click();
        Get_Dashboard_NegativeCashBalanceSummaryBoard_ChCurrency().ClickR();    
