...
function CR1483_Dash_Survol_Users_Selection_TabIACodes() 
{
            ...
            CR1483_Survol_Users_Selection_TabIACodes(vServerDashboard,Get_ModulesBar_BtnDashboard(),filePath_Dashboard);
}
