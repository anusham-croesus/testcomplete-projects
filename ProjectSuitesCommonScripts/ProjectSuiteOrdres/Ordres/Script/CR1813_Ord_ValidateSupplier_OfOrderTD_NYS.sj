...
/*
    ...
    CR                   :  1813
    TestLink             :  Croes-3206
    Description          :  Valider le fournisseur de l`ordre TD( NYS)
    Auteur               :  Abdel Matmat
...
*/
 ...
 function CR1813_Ord_ValidateSupplier_OfOrderTD_NYS()
 {             
    try{ 
        //lien pour TestLink
        ...
        var market = ReadDataFromExcelByRowIDColumnID(filePath_Orders, "CR1813", "CR1813_Market_Croes_3206", language+client);
