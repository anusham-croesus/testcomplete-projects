...
/* Description : A partir du module « Orders » , afficher la fenêtre  "Ajouter un critère de recherche" en cliquant sur MenuBar – SearchCriteriaSubmenuAddSearchCriterion
Vérifier la présence des contrôles et des étiquetés. */


function Survol_Ord_MenuBar_SearchCriteriaSubmenuAddSearchCriterion()
{
