...
function CR2140_6031_PurchaseOrderWithAccountNotBlockedByThePrefWithoutModificationOfAccount() {
         
      try {
            //lien pour TestLink
            Log.Link("https://jira.croesus.com/testlink/linkto.php?tprojectPrefix=Croes&item=testcase&id=Croes-6031","Lien du Cas de test sur Testlink");
