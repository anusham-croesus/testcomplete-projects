...
//    var projectName = GetExecutionLogProjectName("Ordres");
    var projectFullName = aqFileSystem.GetFileNameWithoutExtension(ProjectSuite.FileName);
    var projectName = aqString.SubString(projectFullName, 12, projectFullName.length)
    ...
    if (SendMail("christophe.paring@croesus.com;youlia.raisper@croesus.com;sana.ayaz@croesus.com;xian.wei@croesus.com;emna.ibn.hadj.mohamed@croesus.com", "mail.croesus.com", "TestComplete Execution", "testauto@croesus.com", client + projectName +" - exécution des scripts terminée", "L'exécution des scripts du projet Ordre est maintenant terminée."))
