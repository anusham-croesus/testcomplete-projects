...
/* Description : Aller au module "Orders" en cliquant sur BarModules-btnOrders.Afficher la fenêtre «Orders Module » par Ctrl+Shift+S
Vérifier le texte et la présence des contrôles */

function Survol_Ord_CreateSellOrder_CtrlShiftS()
{
    var type="sell";
