...
/**
    ...
    Rechercher un ordre ayant le statut "Trader Approval" et cliquer sur le bouton "Replace" de la barre des Ordres.
...
function Survol_Ord_OrdersBar_BtnReplace_StatusTraderApproval()
{
