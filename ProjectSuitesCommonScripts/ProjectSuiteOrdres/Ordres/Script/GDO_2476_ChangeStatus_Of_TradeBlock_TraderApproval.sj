...
/* Description :Changement de statut d`un block trade en attente de statut
https://jira.croesus.com/testlink/linkto.php?tprojectPrefix=Croes&item=testcase&id=Croes-2476
 
Analyste d'assurance qualité: Reda Alfaiz
Analyste d'automatisation: Youlia Raisper */ 
 
 function GDO_2476_ChangeStatus_Of_TradeBlock_TraderApproval()
 {             
    try{ 
