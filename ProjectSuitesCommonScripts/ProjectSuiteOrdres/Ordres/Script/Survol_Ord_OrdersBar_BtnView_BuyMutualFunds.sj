...
/**
    ...
    Rechercher un ordre d'achat de fonds d'investissement et l'afficher avec le bouton "Consulter" de la barre des Ordres.
    Vérifier le texte et la présence des contrôles.
    @author : christophe.paring@croesus.com
*/

function Survol_Ord_OrdersBar_BtnView_BuyMutualFunds()
{
