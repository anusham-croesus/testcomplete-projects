...
/**
    ...
    Rechercher un ordre ayant le statut "Executed" et cliquer sur le bouton "Replace" de la barre des Ordres.
...
function Survol_Ord_OrdersBar_BtnReplace_StatusExecuted()
{
