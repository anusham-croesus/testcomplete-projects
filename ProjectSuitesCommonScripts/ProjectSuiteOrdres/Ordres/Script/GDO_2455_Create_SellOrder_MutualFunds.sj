...
Analyste d'automatisation: Youlia Raisper */ 
 ...
 function GDO_2455_Create_SellOrder_MutualFunds()
 {             
    try{  
        ...
        var quantity=ReadDataFromExcelByRowIDColumnID(filePath_Orders, "GDO", "QuantityMutualFunds_2455", language+client);
        var security= ReadDataFromExcelByRowIDColumnID(filePath_Orders, "GDO", "SecurityMutualFunds_2455", language+client);
