...
function CR1483_Ord_Survol_Users_Selection_TabBranches() 
{
          ...
          CR1483_Survol_Users_Selection_TabBranches(vServerOrders,Get_ModulesBar_BtnOrders(), filePath_Orders);
}
