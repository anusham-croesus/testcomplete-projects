...
function CR1483_Ord_CheckErrorMsgPrefMaxWorkAs_TabUsers() 
{
        ...
        CR1483_CheckErrorMsgPrefMaxWorkAs(vServerOrders ,Get_ModulesBar_BtnOrders(),"Users",filePath_Orders,"CR1483_WinSelection_TabUsers_ErrorMsg" );    
}
