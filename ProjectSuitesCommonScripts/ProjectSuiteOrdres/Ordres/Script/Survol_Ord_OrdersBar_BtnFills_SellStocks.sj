...
/**
    ...
    Rechercher un ordre de vente d'actions et cliquer sur le bouton "Exécutions" de la barre des Ordres.
    Vérifier les textes et la présence des contrôles de la fenêtre Exécutions.
    @author : christophe.paring@croesus.com
*/

function Survol_Ord_OrdersBar_BtnFills_SellStocks()
{
    var type = "stocks";
    var order = "sell";
    var securityDescription = GetData(filePath_Orders, "Order_Fills", 69, language)
