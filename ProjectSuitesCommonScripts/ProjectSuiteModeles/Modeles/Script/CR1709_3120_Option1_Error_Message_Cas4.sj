...
function CR1709_3120_Option1_Error_Message_Cas4(){
  ...
  try{  
        ...
        //Modèle principal inactif, pas d'assigné. Modèles parents actifs, avec des assignés.                   
        CR1709_3120_Option1(false,false,true,true);
