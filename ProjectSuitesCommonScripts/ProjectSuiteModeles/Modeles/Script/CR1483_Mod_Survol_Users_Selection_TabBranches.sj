...
function CR1483_Mod_Survol_Users_Selection_TabBranches() 
{
            ...
            CR1483_Survol_Users_Selection_TabBranches(vServerModeles,Get_ModulesBar_BtnModels(), filePath_Modeles);
}
