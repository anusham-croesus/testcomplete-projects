...
/**
       ...
       https://jira.croesus.com/testlink/linkto.php?tprojectPrefix=Croes&item=testcase&id=Croes-960
        Description : 
        ...
        5-Choisir 'n'égal(e) pas' pour le champ 'Opérateur' ,saisir une valeur ensuite cliquer sur le bouton 'Appliquer':
...
*/
function CR1501_960_SearchByFilterByDateModifiedAndOperatorIsNot_equal()
{
  try {
        
        Log.Link("https://jira.croesus.com/testlink/linkto.php?tprojectPrefix=Croes&item=testcase&id=Croes-960");
