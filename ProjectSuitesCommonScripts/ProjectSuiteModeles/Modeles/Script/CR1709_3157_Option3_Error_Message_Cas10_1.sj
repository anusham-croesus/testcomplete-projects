...
function CR1709_3157_Option3_Error_Message_Cas10_1(){
  ...
  try{  
        ...
        var message3=ReadDataFromExcelByRowIDColumnID(filePath_Modeles, "CR1709", "Message3152_MSG6", language+client);
              
        Login(vServerModeles, user, psw, language);         
        Get_ModulesBar_BtnModels().Click();
        Get_MainWindow().Maximize();

        //Modèle principal actif, pas d'assigné. Modèles parents inactifs,avec des assignés.               
        CR1709_3120_Option1(false,true,true,false);
        ...
        //Valider le message 
        /*
            Un ou plusieurs modèles visés par cette opération sont inactifs:
