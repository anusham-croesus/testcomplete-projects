...
//USEUNIT ExcelUtils
 ...
 /* Description : 
https://jira.croesus.com/testlink/linkto.php?tprojectPrefix=Croes&item=testcase&id=Croes-2868
Analyste d'automatisation: Youlia Raisper */



function CR1709_2868_Check_Frequency_Field(){
  
  try{  
        //Afficher le lien de cas de test
        Log.Link("https://jira.croesus.com/testlink/linkto.php?tprojectPrefix=Croes&item=testcase&id=croes-2868","Cas de test TestLink : Croes-2868")
        ...
        Get_WinAccountInfo_TabCashManagement_GrpCashManagement_BtnClear2().Click();
