...
function Regression_Model_EnleverRelation()
{
  ...
  if(relationAssocie.Exists)
  {
    ...
    relationAssocie = Get_Models_Details_TabAssignedPortfolios_DgvAssignedPortfolios().FindChild("Value", nameRelation, 10);
    if(!relationAssocie.Exists)
