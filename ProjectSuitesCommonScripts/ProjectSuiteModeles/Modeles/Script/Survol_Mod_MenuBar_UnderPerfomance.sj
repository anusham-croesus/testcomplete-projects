...
en cliquant sur MenuBar_UnderPerfomance. Vérifier la présence des contrôles et des étiquetés.Fermer la fenêtre en cliquant sur X*/

 function Survol_Mod_MenuBar_UnderPerfomance()
 {
  if (client == "BNC" ){
    var model="~M-0000S-0"
  }
  ...
  Get_MenuBar_Edit_FunctionsForModels_UnderlyingPerformance().Click()
