...
/* Description : Dans le du module « Modeles ». Rechercher le modèle ~M-0000S-0 :
      1- Afficher la fenêtre « Gestionnaire de restrictions » en cliquant sur ModeleBar_btnRestriction.
      2- Vérifier la présence des contrôles et des étiquetés.
      3- Afficher la fenêtre « Gestionnaire de restrictions » en cliquant sur MenuBar_EditFunctions_Restrictions.
*/

function Survol_Mod_Restrictions_CombinedAccessMethods()
{
  ...
  // 1- ModeleBar_btnRestriction
  
  Log.Message("Afficher la fenêtre « Gestionnaire de restrictions » en cliquant sur ModeleBar_btnRestriction.");
  ...
  // 3- MenuBar_EditFunctions_Restriction
  
  Log.Message("Afficher la fenêtre « Gestionnaire de restrictions » en cliquant sur MenuBar_EditFunctions_Restrictions.");
