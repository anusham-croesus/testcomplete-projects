...
function CR1709_2209_Edit_Price_UMA_Model1()
{
    try{
        //Afficher le lien de cas de test
        Log.Link("https://jira.croesus.com/testlink/linkto.php?tprojectPrefix=Croes&item=testcase&id=Croes-2209","Cas de test TestLink - Méthode rééquilibrage 1 : A partir de Pad Modele: Croes-2209")
        ...
        var modelName=ReadDataFromExcelByRowIDColumnID(filePath_Modeles, "CR1709", "ModelName_2209", language+client);
...
function ResetData(client800038,modelName,FolderPath){
