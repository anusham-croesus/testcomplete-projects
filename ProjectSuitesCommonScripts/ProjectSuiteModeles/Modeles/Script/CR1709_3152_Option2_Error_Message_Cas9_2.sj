...
function CR1709_3152_Option2_Error_Message_Cas9_2(){
  ...
  try{  
        ...
        //Modèle principal actif, avec un assigné. Deux modèles parents actifs, les trois modèles parents avec des assignés.               
        CR1709_3152_Option2(true,true,true,false,true,true)
...
*/
function CR1709_3152_Option2(AssignedPrincipalModel,ActivePrincipalModel,AssignedSubModels,ActiveSubModel2,ActiveSubModel3,ActiveSubModel4)
{
    //les variables    
    var model1=ReadDataFromExcelByRowIDColumnID(filePath_Modeles, "CR1709", "ModelPrincipal_3120", language+client);
    var model2=ReadDataFromExcelByRowIDColumnID(filePath_Modeles, "CR1709", "ModelParent1_3120", language+client);
    ...
    ActivateDeactivateModel(model2,ActiveSubModel2)
    ActivateDeactivateModel(model3,ActiveSubModel3)
    ActivateDeactivateModel(model4,ActiveSubModel4)
