...
/* Description : Dans le du module « Modeles », rechercher un Modèle ~M-00002-0 :
        1- Afficher la fenêtre « Modèle Info » Par ContextualMenu - Edit.
        2- Vérifier la présence des contrôles et des étiquetés.
        3- Afficher la fenêtre « Modèle Info » Par ContextualMenu - Functions-Info.
        4- Afficher la fenêtre « Modèle Info » avec Ctrl + E.
        5- Afficher la fenêtre « Modèle Info » en cliquant sur MenuBar_EditFunctions_Info.
        6- Afficher la fenêtre « Modèle Info » en cliquant sur ModelsBar - BtnInfo.
*/

 function Survol_Mod_Info_CombinedAccessMethods()
{
  ...
  // 1- ContextualMenu - Edit
  
  Log.Message("Afficher la fenêtre « Modèle Info » Par ContextualMenu - Edit.");
  ...
  // 3- ContextualMenu - Functions-Info
  
  Log.Message("Afficher la fenêtre « Modèle Info » Par ContextualMenu - Functions-Info.");
  Get_MainWindow().Keys("[Apps]");
  ...
  Log.Message("Afficher la fenêtre « Modèle Info » avec Ctrl + E.");
  Get_MainWindow().Keys("^e")
  Get_WinModelInfo().Close();
  
  // 5- MenuBar_EditFunctions_Info.
  
  Log.Message("Afficher la fenêtre « Modèle Info » en cliquant sur MenuBar_EditFunctions_Info.");
  ...
  Log.Message("Afficher la fenêtre « Modèle Info » en cliquant sur ModelsBar - BtnInfo.");
