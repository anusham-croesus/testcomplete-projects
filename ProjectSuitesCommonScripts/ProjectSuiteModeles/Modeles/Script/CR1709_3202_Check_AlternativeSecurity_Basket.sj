...
//USEUNIT CR1709_3201_Check_AlternativeSecurity_Basket
 ...
 /* Description : 
https://jira.croesus.com/testlink/linkto.php?tprojectPrefix=Croes&item=testcase&id=Croes-3202
...
function CR1709_3202_Check_AlternativeSecurity_Basket()
{
    try{  
        ...
        var targetPanierObligation=ReadDataFromExcelByRowIDColumnID(filePath_Modeles, "CR1709", "TargetPanierObligatio_3202", language+client);
        var securityBCE=ReadDataFromExcelByRowIDColumnID(filePath_Modeles, "CR1709", "SecurityBCE", language+client);
        var symbolBCE=ReadDataFromExcelByRowIDColumnID(filePath_Modeles, "CR1709", "SymbolBCE", language+client);
        var newModel=ReadDataFromExcelByRowIDColumnID(filePath_Modeles, "CR1709", "Model_3202", language+client); 
        ...
        var message=ReadDataFromExcelByRowIDColumnID(filePath_Modeles, "CR1709", "Message_3202", language+client);   
             
        var displayQuantityBCE=ReadDataFromExcelByRowIDColumnID(filePath_Modeles, "CR1709", "DisplayQuantity_BCE", language+client);
        var modelTargetPercentBCE=ReadDataFromExcelByRowIDColumnID(filePath_Modeles, "CR1709", "ModelTargetPercent_BCE", language+client);  
        var Basket844000=ReadDataFromExcelByRowIDColumnID(filePath_Modeles, "CR1709", "Basket844000", language+client);
        var displayQuantityBasket=ReadDataFromExcelByRowIDColumnID(filePath_Modeles, "CR1709", "DisplayQuantity_Basket_3202", language+client);
        var modelTargetPercentBasket=ReadDataFromExcelByRowIDColumnID(filePath_Modeles, "CR1709", "ModelTargetPercent_Basket_3202", language+client);
        var displayQuantitySNC=ReadDataFromExcelByRowIDColumnID(filePath_Modeles, "CR1709", "DisplayQuantity_SNC", language+client);
        var modelTargetPercentSNC=ReadDataFromExcelByRowIDColumnID(filePath_Modeles, "CR1709", "ModelTargetPercent_SNC_3202", language+client);
        ...
        var modelTargetPercentCVE=ReadDataFromExcelByRowIDColumnID(filePath_Modeles, "CR1709", "ModelTargetPercent_CVE_3202", language+client); 
        var modelTargetPercentNBC100=ReadDataFromExcelByRowIDColumnID(filePath_Modeles, "CR1709", "ModelTargetPercent_NBC100_3202", language+client); 
        ...
        var modelTargetPercentECA=ReadDataFromExcelByRowIDColumnID(filePath_Modeles, "CR1709", "ModelTargetPercent_ECA_3202", language+client); 
        ...
        Get_WinReplacement_GrpSubstitutionSecurity_TxtSecurity().Keys(securityBCE);
        Get_WinReplacement_GrpSubstitutionSecurity_TxtSecurity().Keys("[Tab]");
        Aliases.CroesusApp.subMenus.Find("Value",securityBCE,10).DblClick();
        ...
        */
        ...
        Search(symbolBCE);               
        aqObject.CheckProperty(Get_WinRebalance_PositionsGrid().WPFObject("RecordListControl", "", 1).Find("Value",symbolBCE,10).DataContext.DataItem, "DisplayQuantityStr", cmpEqual, displayQuantityBCE);         
        aqObject.CompareProperty(aqString.SubString(Get_WinRebalance_PositionsGrid().WPFObject("RecordListControl", "", 1).Find("Value",symbolBCE,10).DataContext.DataItem.ModelTargetPercent,0,4),cmpEqual,aqString.SubString(modelTargetPercentBCE, 0, 4),true,3)        
