...
function CR1709_2639_Option3_Held_Security_Under_SubModel_and_ParentModel()
{
    try{  
        ...
        var message=ReadDataFromExcelByRowIDColumnID(filePath_Modeles, "CR1709", "WarningMessage_2639", language+client);
        var txtNumberOfModelsAfterSelection=ReadDataFromExcelByRowIDColumnID(filePath_Modeles, "CR1709", "TxtNumberOfModelsAfterSelection_2639", language+client);
        ...
        var modelNumbermodelsubsProrata=Get_ModelsGrid().Find("Value",modelsubsProrata,10).DataContext.DataItem.AccountNumber
        ...
        //Récupérer le numéro des models 
        var modelNumberCanadianEqui=Get_ModelsGrid().Find("Value",modelCanadianEqui,10).DataContext.DataItem.AccountNumber
        ...
        //Séléctionner option 3 dans le combo box :Rééquilirage du:
        SelectComboBoxItem(Get_WinRebalance_TabParameters_GrpRebalance_CmbSelection(),selectedSubModelAndSubModelComboBox)
        ...
        aqObject.CheckProperty(Get_DlgWarning_LblMessage(),property, cmpContains, message1 +"\n\n"+modelCanadianEqui+", "+modelNumberCanadianEqui+"\n"+modelsubsProrata+", "+modelNumbermodelsubsProrata+"\n\n"+messageSecurityBMO+"\n\n"+modelsubsProrata+", "+modelNumbermodelsubsProrata+"\n\n"+message2) //EM:Depuis CO-90-07-22-Be-1 datapool modifié Property="Message" Avant "Text"
        //aqObject.CheckProperty(Get_DlgWarning_LblMessage(), "Text", cmpEqual, message);
