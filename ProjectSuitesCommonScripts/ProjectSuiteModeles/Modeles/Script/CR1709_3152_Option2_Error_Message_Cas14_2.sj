...
function CR1709_3152_Option2_Error_Message_Cas14_2(){
  ...
  try{  
        ...
        //Modèle principal actif, pas d'assignés.Deux modèles parents actifs, les trois modèles parents n'ont pas assignés.              
        CR1709_3152_Option2(false,true,false,true,true,false)
