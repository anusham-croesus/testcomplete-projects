...
function CR1869_NomRepartition()
{
  ...
  try
  {
    ...
    aqObject.CheckProperty(Get_WinRebalance_TabProjectedPortfolios_TabProjectedPortfolio_GrpSummary_CmbAssetAllocation(), "Text", cmpNotEqual, "");
  }
  catch(exc)
  {
