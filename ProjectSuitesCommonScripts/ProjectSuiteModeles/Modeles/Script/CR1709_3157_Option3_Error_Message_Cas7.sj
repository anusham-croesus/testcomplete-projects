...
function CR1709_3157_Option3_Error_Message_Cas7(){
  ...
  try{  
       Activate_Inactivate_Pref("REAGAR", "PREF_REBALANCE_SUBMODEL", "YES", vServerModeles)
        ...
        //Modèle principal inactif, avec des assigné. Modèles parents actifs, pas d'assignés.               
        CR1709_3120_Option1(true,false,false,true);
