...
function CR1709_3152_Option2_Error_Message_Cas15(){
  ...
  try{  
         Activate_Inactivate_Pref("REAGAR", "PREF_REBALANCE_SUBMODEL", "YES", vServerModeles)
          ...
          //Modèle principal inactif, avec des assigné. Modèles parents inactifs,pas d'assignés.               
          CR1709_3120_Option1(true,false,false,false);
