...
function CR1709_3152_Option2_Error_Message_Cas5_1(){
  ...
  try{  
         Activate_Inactivate_Pref("REAGAR", "PREF_REBALANCE_SUBMODEL", "YES", vServerModeles)
          ...
          //Modèle principal actif, avec un assigné. Modèles parents actifs, un modèle n'a pas d'assignés.               
          CR1709_3152_Option2(true,true,true,true,false,true)
        ...
        //RestoreData(true,true,true,false);
...
*/
function CR1709_3152_Option2(AssignedPrincipalModel,ActivePrincipalModel,AssignedSubModel1,AssignedSubModel2,AssignedSubModel3,ActivesSubModels)
{
    //les variables    
    var model1=ReadDataFromExcelByRowIDColumnID(filePath_Modeles, "CR1709", "ModelPrincipal_3120", language+client);
    var model2=ReadDataFromExcelByRowIDColumnID(filePath_Modeles, "CR1709", "ModelParent1_3120", language+client);
