...
/* Description : Ouvrir l'application et  afficher la fenêtre « Agenda » par MenuBar_ToolsAgenda. 
 A partir de  l’onglet "FilesProcessing" afficher la fenêtre Print en cliquant sur le btn Print. Vérifier le texte et la présence des contrôles */

function Survol_Age_FilesProcessing_btnPrint()
{
