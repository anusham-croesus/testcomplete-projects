...
function ExecutionLog()
{
    ...
    var referenceName = GetVServerReference(vServerAgenda);
    var executionEndDateTimeString = aqConvert.DateTimeToFormatStr(aqDateTime.Now(), "%Y_%m_%d %H_%M_%S");
    var projectName = GetExecutionLogProjectName("Agenda");
    ...
    if (SendMail("christophe.paring@croesus.com;youlia.raisper@croesus.com;sana.ayaz@croesus.com;xian.wei@croesus.com;emna.ibn.hadj.mohamed@croesus.com", "mail.croesus.com", "TestComplete Execution", "testauto@croesus.com", client + " Agenda - exécution des scripts terminée", "L'exécution des scripts du projet Agenda est maintenant terminée."))
