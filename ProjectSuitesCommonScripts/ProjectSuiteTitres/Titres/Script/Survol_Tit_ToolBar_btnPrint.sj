...
/* Description : A partir du module « Titre » , afficher la fenêtre « Print » en cliquant sur Toolbar - btnPrint. 
 En cliquant sur le btnCancel, Vérifier le message «Impression annulée» */
 
// Cas de test: https://jira.croesus.com/testlink/linkto.php?tprojectPrefix=Croes&item=testcase&id=Croes-319
 
 function Survol_Tit_ToolBar_btnPrint()
 {
