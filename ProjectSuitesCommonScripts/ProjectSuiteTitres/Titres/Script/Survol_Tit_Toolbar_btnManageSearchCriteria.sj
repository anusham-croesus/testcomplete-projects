...
/* Description : A partir du module « Titre » , afficher la fenêtre « Critères de recherche » en cliquant sur ToolBar – btnManageSearchCriteria 
...
// Cas de test: https://jira.croesus.com/testlink/linkto.php?tprojectPrefix=Croes&item=testcase&id=Croes-325

function Survol_Tit_ToolBar_btnManageSearchCriteria()
{
