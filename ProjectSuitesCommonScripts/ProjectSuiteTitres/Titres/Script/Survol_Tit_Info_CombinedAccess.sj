...
/* Description : A partir du module « Titre » ,chercher le titre R13021 (Obligation), afficher la fenêtre « Info » en cliquant sur MenuBar - fonctions-Info. 
 ...
 /*Description    : Combiner les septs façons pour la fenêtre Info
   Date           : 22-01-2021
   version        : 90.24-21
   Analyste Auto  :Abdel.M      
 */
 
 function Survol_Tit_Info_CombinedAccess()
 {
   try {
        ...
        var type1 = "bond"; //La variable qui est utilisée dans les points de vérifications 
        var security1 = "R13021";
        var type2 = "commonStock";
        var security2 = "101705";
        var type3 = "futures";
        var security3 = "750528";
        var security4 = "970521"
        var type5 = "InvestmentFunds";
        var security5 = "995534"
        var type6 = "options";
        var security6 = "78757N";
        var type7 = "other";
        var security7 = "125850";
...
// ********** Étape 2 : Afficher la fenêtre « Info »Par MenuBar/Édition *******************
        Log.PopLogFolder();
        logEtape2 = Log.AppendFolder("Étape 2: Afficher la fenêtre « Info »Par MenuBar/Édition");
        
        Search_Security(security1);
        ...
        if (language == "french"){Check_Properties_French(type1)} //Se trouve dans la partie FUNCTIONS 
        //Les points de vérification en anglais 
        else {Check_Properties_English(type1)} //Se trouve dans la partie FUNCTIONS    
    
        Check_Existence_Of_Controls_Description(type1);//Se trouve dans la partie FUNCTIONS 
      
        Get_WinInfoSecurity_BtnCancel().Click();
        

// ********** Étape 3 : Afficher la fenêtre Info par bouton Info *******************
        Log.PopLogFolder();
        logEtape3 = Log.AppendFolder("Étape 3: Afficher la fenêtre Info par bouton Info");
        
        Search_Security(security2);
        Get_SecuritiesBar_BtnInfo().Click();
      
        //Les points de vérification en français 
        if (language == "french"){Check_Properties_French(type2)}// la fonction est dans le script Survol_Tit_Bond_MenuBar_EditFunctions_Info
        //Les points de vérification en anglais 
        else {Check_Properties_English(type2)} // la fonction est dans le script Survol_Tit_Bond_MenuBar_EditFunctions_Info
    
        Check_Existence_Of_Controls_Description(type2);// la fonction est dans le script Survol_Tit_Bond_MenuBar_EditFunctions_Info
        Get_WinInfoSecurity_BtnCancel().Click();
        
// ********** Étape 4 : Afficher la fenêtre Info par contextual menu *******************
        Log.PopLogFolder();
        logEtape4 = Log.AppendFolder("Étape 4: Afficher la fenêtre Info par contextual menu");
        
        Search_Security(security3);
        Get_SecurityGrid().Keys("[Apps]");
        Get_SecurityGrid_ContextualMenu_Edit().Click();
    
        //Les points de vérification en français 
        if (language == "french"){Check_Properties_French(type3)}// la fonction est dans le script Survol_Tit_Bond_MenuBar_EditFunctions_Info
        //Les points de vérification en anglais 
        else {Check_Properties_English(type3)} // la fonction est dans le script Survol_Tit_Bond_MenuBar_EditFunctions_Info
    
        Check_Existence_Of_Controls_Description(type3);// la fonction est dans le script Survol_Tit_Bond_MenuBar_EditFunctions_Info
        
        Get_WinInfoSecurity_BtnCancel().Click();
        
// ********** Étape 5 : Afficher la fenêtre Info Asset Allocation Ctrl-E *******************
        Log.PopLogFolder();
        logEtape5 = Log.AppendFolder("Étape 5: Afficher la fenêtre Info Asset Allocation Ctrl-E");

        Search_Security(security4);    
...
// ********** Étape 6 : Afficher la fenêtre Info par Ctrl-E *******************
        Log.PopLogFolder();
        logEtape6 = Log.AppendFolder("Étape 6: Afficher la fenêtre Info par Ctrl-E");

        Search_Security(security5);
        Get_SecurityGrid().Keys("^e");
    
        //Les points de vérification en français 
        if (language == "french"){Check_Properties_French(type5)}// la fonction est dans le script Survol_Tit_Bond_MenuBar_EditFunctions_Info
        //Les points de vérification en anglais 
        else {Check_Properties_English(type5)} // la fonction est dans le script Survol_Tit_Bond_MenuBar_EditFunctions_Info
    
        Check_Existence_Of_Controls_Description(type5);// la fonction est dans le script Survol_Tit_Bond_MenuBar_EditFunctions_Info
     
        Get_WinInfoSecurity_BtnCancel().Click();
        
// ********** Étape 7 : Afficher la fenêtre Info Titre Option par Bouton Info *******************
        Log.PopLogFolder();
        logEtape7 = Log.AppendFolder("Étape 7: Afficher la fenêtre Info Titre Option par Bouton Info");
        
        Search_Security(security6);    
        Get_SecuritiesBar_BtnInfo().Click();
    
        //Les points de vérification en français 
        if (language == "french"){Check_Properties_French(type6)}// la fonction est dans le script Survol_Tit_Bond_MenuBar_EditFunctions_Info
        //Les points de vérification en anglais 
        else {Check_Properties_English(type6)} // la fonction est dans le script Survol_Tit_Bond_MenuBar_EditFunctions_Info
    
        Check_Existence_Of_Controls_Description(type6);// la fonction est dans le script Survol_Tit_Bond_MenuBar_EditFunctions_Info
      
        Get_WinInfoSecurity_BtnCancel().Click();
        
// ********** Étape 8 : Afficher la fenêtre Info Titre Other par ContextualMenu *******************
        Log.PopLogFolder();
        logEtape8 = Log.AppendFolder("Étape 8: Afficher la fenêtre Info Titre Other par ContextualMenu");
        
        Search_Security(security7);    
        Get_SecurityGrid().Keys("[Apps]");
        Get_SecurityGrid_ContextualMenu_Functions().Click();
        Get_SecurityGrid_ContextualMenu_Functions_Info().Click();
    
        //Les points de vérification en français 
        if (language == "french"){Check_Properties_French(type7)}// la fonction est dans le script Survol_Tit_Bond_MenuBar_EditFunctions_Info
        //Les points de vérification en anglais 
        else {Check_Properties_English(type7)} // la fonction est dans le script Survol_Tit_Bond_MenuBar_EditFunctions_Info   
    
        Check_Existence_Of_Controls_Description(type7);// la fonction est dans le script Survol_Tit_Bond_MenuBar_EditFunctions_Info
     ...
     {   
       //Étape 9 : Se déconnecter de Croesus  ------------------------------------------
        Log.PopLogFolder();
        logEtape9 = Log.AppendFolder("Étape 9: Se déconnecter de Croesus ");
        //Fermer Croesus
...
{     
      ...
      {  
        ...
        if (client == "BNC" && type=="InvestmentFunds"){            
            ...
            aqObject.CheckProperty(Get_WinInfoSecurity_TabDividendsHistory_ChExDividendDate().Content, "OleValue", cmpEqual, "Date ex-dividende");
            aqObject.CheckProperty(Get_WinInfoSecurity_TabDividendsHistory_ChPaymentDate().Content, "OleValue", cmpEqual, "Date de versement");
            //Désactiver l'affichage de ce bug mineur dans les logs
