...
/* Description : A partir du module « Titre » ,chercher le titre R13021 (Obligation), afficher la fenêtre « Info » en cliquant sur HistoricalData du menu contextuel. 
 ...
 /*Description    : Combiner les trois façons pour Historical Data
   Date           : 22-01-2021
   version        : 90.24-21
   Analyste Auto  :Abdel.M      
 */
 
 function Survol_Tit_HistoricalData_CombinedAccess()
 {
   try {
...
// ********** Étape 2 : Afficher la fenêtre « Info » en cliquant sur HistoricalData du menu contextuel *******************
        Log.PopLogFolder();
        logEtape2 = Log.AppendFolder("Étape 2: Afficher la fenêtre « Info » en cliquant sur HistoricalData du menu contextuel ");
        ...
        if(language=="french"){ Check_Properties_French(type1)}// la fonction est dans le script Survol_Tit_Option_MenuBar_EditFunctions_HistoricalData     
        //Les points de vérification en anglais 
        else{Check_Properties_English(type1)}// la fonction est dans le script Survol_Tit_Option_MenuBar_EditFunctions_HistoricalData
    
        Check_Existence_Of_Controls(type1)// la fonction est dans le script Survol_Tit_Option_MenuBar_EditFunctions_HistoricalData
      
        Get_WinInfoSecurity_BtnCancel().Click();
        

// ********** Étape 3 : Afficher Historical data par bouton  *******************
        Log.PopLogFolder();
        logEtape3 = Log.AppendFolder("Étape 3: Afficher Historical data par bouton");
        ...
        //Les points de vérification en français 
        if(language=="french"){ Check_Properties_French(type2)}// la fonction est dans le script Survol_Tit_Option_MenuBar_EditFunctions_HistoricalData     
        //Les points de vérification en anglais 
        else{Check_Properties_English(type2)}// la fonction est dans le script Survol_Tit_Option_MenuBar_EditFunctions_HistoricalData
   
        Check_Existence_Of_Controls(type2);// la fonction est dans le script Survol_Tit_Option_MenuBar_EditFunctions_HistoricalData
      
        Get_WinInfoSecurity_BtnCancel().Click();
        
// ********** Étape 4 : Afficher la fenêtre Historical data par MenuBar *******************
        Log.PopLogFolder();
        logEtape4 = Log.AppendFolder("Étape 4: Afficher la fenêtre Historical data par MenuBar");
        ...
        //Les points de vérification en français 
        if(language=="french"){ Check_Properties_French(type3)}
        //Les points de vérification en anglais 
        else {Check_Properties_English(type3)}  
    
        Check_Existence_Of_Controls(type3)
...
{    
      ...
      //Désactivé pour ne pas voir dans les logs (jira mineur)
...
//      Log.Message("bug CROES-5066")
      ...
      // Désactivé pour ne pas voir le fail dans les logs (bug mineur)
