...
//Fermêture de l’application avec X
// Lien cas de test: https://jira.croesus.com/testlink/linkto.php?tprojectPrefix=Croes&item=testcase&id=Croes-316
function Survol_Tit_X()
{
