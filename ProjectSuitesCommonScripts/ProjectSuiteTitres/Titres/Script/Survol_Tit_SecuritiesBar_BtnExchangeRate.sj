...
/* Description : A partir du module « Titre » , afficher la fenêtre « Taux de change » en cliquant sur SecuritiesBar - btnExchangeRate. 
  Vérifier la présence des contrôles et des étiquetés
  // Lien du cas de Test:https://jira.croesus.com/testlink/linkto.php?tprojectPrefix=Croes&item=testcase&id=Croes-1781 */
 
 function Survol_Tit_SecuritiesBar_BtnExchangeRate()
 {
