...
/* Description : A partir du module « Transactions » ,Rechercher un deposit et afficher la fenêtre par ContextualMenu_Functions_Position. 
 Vérifier la présence des contrôles et des étiquetés */

function Survol_Tra_ContextualMenu_Functions_Position()
{  
   ...
   if (Get_ModulesBar_BtnTransactions().WaitProperty("IsChecked", true, 3000)){  
      ...
      Get_Transactions_ListView().FindChild(["ClrClassName", "WPFControlOrdinalNo"], ["DragableListViewItem", "1"], 10).WaitProperty("IsVisible", true, 30000); 
        ...
        //afficher la fenêtre par ContextualMenu_Functions_Position
        ...
        Get_Transactions_ContextualMenu_Functions_Position().Click();
