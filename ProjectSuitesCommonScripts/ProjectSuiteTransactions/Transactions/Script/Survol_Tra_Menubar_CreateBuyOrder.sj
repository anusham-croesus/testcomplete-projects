...
/* Description : Aller au module "Transactions" en cliquant sur BarModules-btnOrders.Rechercher le compte 800082-RE .Afficher la fenêtre «Orders Module » par Menubar_CreateBuyOrder
Vérifier le texte et la présence des contrôles */

function Survol_Tra_Menubar_CreateBuyOrder()
{
    ...
    if (client == "CIBC" || client == "BNC"  || client == "US" || client == "TD" )
    {
      ...
      //Afficher la fenêtre «Orders Module » par Menubar_CreateBuyOrder
