...
/* Description : Aller au module "Transactions" en cliquant sur BarModules-btnTitre.Rechercher le titre 506391. Afficher la fenêtre «Orders Module » en cliquant sur le bouton Toolbar-btnCreateSellOrder
Selectioner le bouton radio "Stocks". Vérifier le texte et la présence des contrôles */

function Survol_Tra_Toolbar_btnCreateSellOrder()
{
