...
function CR1483_Tran_Check_UserSelection_IACodes() 
{
         ...
         CR1483_Check_UserSelection_IACodes(vServerTransactions,Get_ModulesBar_BtnTransactions(),"Copernic","BD88", "0AED");
}
