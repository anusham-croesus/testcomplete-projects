...
/**
    Module               :  Transactions
    TestLink             :  3357
    Description          :  Vérifier l'option "Remember my selection" du menu Users Tab Users.
    Auteur               :  Abdel Matmat
...
function CR1483_Tran_RememberMySelection_TabIACodes() 
{
            ...
            CR1483_RememberMySelection(vServerTransactions,Get_ModulesBar_BtnTransactions(),"Users", filePath_Transactions, "Copernic");
}