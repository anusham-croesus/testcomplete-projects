...
//USEUNIT CommonCheckpoints
 ...
 /* Description :Dans le du module « Clients »,afficher la fenêtre «Info» en cliquant sur ToolBar - Btn_i (DetailedInfo).(Pour le client qui est sélectionné par default 800300) 
Vérifier la présence des contrôles et des étiquetés */

function Survol_Cli_ToolBar_Btn_i()
{
  var btn="info";
  var module="clients";
