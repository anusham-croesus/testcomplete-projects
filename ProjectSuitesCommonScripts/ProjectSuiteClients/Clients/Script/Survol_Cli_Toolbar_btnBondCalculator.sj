...
/* Description : A partir du module « Clients » ,afficher la fenêtre « Calculatrice d'obligations » en cliquant sur Toolbar - btnBondCalculator. 
 Vérifier la présence des contrôles et des étiquettes   */

 function Survol_Cli_Toolbar_btnBondCalculator()
 {
