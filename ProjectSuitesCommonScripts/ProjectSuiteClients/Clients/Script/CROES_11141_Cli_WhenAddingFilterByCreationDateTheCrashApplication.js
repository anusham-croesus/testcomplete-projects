...
*/
function CROES_11141_Cli_WhenAddingFilterByCreationDateTheCrashApplication()
{
  try {
       ...
       var CliTextAddNotTestCROES11141=ReadDataFromExcelByRowIDColumnID(filePath_Clients, "Anomalies", "CliTextAddNotTestCROES11141", language+client);
       ...
       Get_WinCRUANote_GrpNote_TxtNote().set_Text(CliTextAddNotTestCROES11141);
       Get_WinCRUANote_GrpNote_TxtNote().Click()
       ...
       Get_WinCRUANote_BtnSave().Click();
          ...
          aqObject.CheckProperty(Get_WinInfo_Notes_TabGrid_TxtNote(),"wText", cmpEqual, CliTextAddNotTestCROES11141);
           aqObject.CheckProperty(Get_WinInfo_Notes_TabGrid_TxtNote(),"wText", cmpContains, CliTextAddNotTestCROES11141);
            var textNotCROES11141= Get_WinInfo_Notes_TabGrid_DgvNotes().FindChild("Value", VarToString(CliTextAddNotTestCROES11141), 10)
       ...
       Get_WinInfo_Notes_TabGrid().Click();
        ...
        Delete_Note(CliTextAddNotTestCROES11141, vServerClients)
        Terminate_CroesusProcess();
    }
    finally {
