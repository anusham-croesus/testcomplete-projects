...
//      --> Dans la fonction CR1483_Check_BranchSelection_IACodes(), ajout d'un délai avant l'appel de la fonction CheckSelectedBranchIACodes(BranchSelection).
//          Ceci est pour permettre à l'application de rafraichir la grille Clients.
// 
