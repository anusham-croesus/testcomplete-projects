...
//USEUNIT CommonCheckpoints
 ...
 /* Description :Dans le du module « Clients »,afficher la fenêtre «Add Fictitious Client» par ClickR ContextualMenu_AddFictitious. 
Vérifier la présence des contrôles et des étiquetés et Cliquer sur chaque onglet pour vérifier le message qui apparaît*/

function Survol_Cli_ContextualMenu_AddFictitious()
{
