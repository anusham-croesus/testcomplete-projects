...
/* Description :Valider les informations de la racine principale dans la section détails
Pour valider l’affichage de données dans la patrie Détail, la fenêtre Info a été utilisée comme la référence. 
https://jira.croesus.com/testlink/linkto.php?tprojectPrefix=Croes&item=testcase&id=Croes-2052
  
[Le script a été créé pour le client 800272]
 
Analyste d'assurance qualité: Karima Mehiguene
Analyste d'automatisation: Youlia Raisper */ 
 
function CR1352_2052_Cli_DetailSection_Information_RootClient()
{
    try {
        ...
        Get_RelationshipsClientsAccountsGrid().FindEx(["Value", "IsVisible"], [rootClient, true], 10, true, 5000).Click(); //Christophe : Ajout de la propriété "IsVisible" et utilisation de FindEx() (versus Find())pour la détection
        Get_RelationshipsClientsAccountsGrid().FindEx(["Value", "IsVisible"], [rootClient, true], 10, true, 5000).DblClick(); //Christophe : Ajout de la propriété "IsVisible" et utilisation de FindEx() (versus Find())pour la détection
        ...
        var balance= Get_WinDetailedInfo_TabInfo_GrpAmounts_TxtBalance().Text;
        var totalValue=Get_WinDetailedInfo_TabInfo_GrpAmounts_TxtTotalValue().Text;
        ...
        aqObject.CheckProperty(Get_ClientsDetails_TabInfo_ScrollViewer_TxtTotalValue(),"Text",cmpEqual,totalValue);
        aqObject.CheckProperty(Get_ClientsDetails_TabInfo_ScrollViewer_TxtBalance(),"Text",cmpEqual,balance);
        ...
        Get_RelationshipsClientsAccountsGrid().Find("Value",rootClient1,10).Click();
        Get_RelationshipsClientsAccountsGrid().Find("Value",rootClient1,10).DblClick();
        ...
        //Dans la section détails, positionner le curseur sur le client principal
        Get_RelationshipsClientsAccountsDetails_PnlHierarchyPanel().Find("OriginalValue",rootClient1,10).Click();
