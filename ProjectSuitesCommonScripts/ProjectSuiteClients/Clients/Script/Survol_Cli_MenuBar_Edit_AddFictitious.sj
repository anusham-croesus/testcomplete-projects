...
//USEUNIT CommonCheckpoints
 ...
 /* Description :Dans le du module « Clients »,afficher la fenêtre «Add Fictitious Client» en cliquant surMenuBar -Edit- BtnAddFictitious. 
Vérifier la présence des contrôles et des étiquetés et Cliquer sur chaque onglet pour vérifier le message qui apparaît*/

function Survol_Cli_ToolBar_btnAdd_Fictitious()
{
  var btn="addFictitious"
  ...
  Get_MenuBar_Edit_AddForRelationshipsAndClients_CreateFictitiousClient().Click();
  ...
  if (WaitUntilObjectDisappears(Get_CroesusApp(), ["ClrClassName", "Title"], ["UniDialog", GetData(filePath_Clients,"WinAddClient",2,language)])){
