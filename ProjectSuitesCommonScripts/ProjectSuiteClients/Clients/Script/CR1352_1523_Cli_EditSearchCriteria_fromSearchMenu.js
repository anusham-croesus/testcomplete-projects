...
/* Description :Modification du critère a partir de menu Recherche
https://jira.croesus.com/testlink/linkto.php?tprojectPrefix=Croes&item=testcase&id=Croes-1523
 
Analyste d'assurance qualité: Karima Mehiguene
Analyste d'automatisation: Youlia Raisper */
 
 function CR1352_1523_Cli_EditSearchCriteria_fromSearchMenu()
 {   
   if (client == "BNC" ){
      var criterion="same adress";
   }
   else{
      var criterion="CR1352_1523_Cli_Edit";
   }
   ...
   try{
       ...
       Get_MenuBar_Search_SearchCriteria_EditTheActiveCriterionOrAddANewOne().Click();
