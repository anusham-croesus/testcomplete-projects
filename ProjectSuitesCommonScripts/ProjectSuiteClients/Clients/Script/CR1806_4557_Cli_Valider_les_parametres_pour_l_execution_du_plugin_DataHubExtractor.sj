...
function CR1806_4557_Cli_Valider_les_parametres_pour_l_execution_du_plugin_DataHubExtractor()
{
    Log.Message("CR1806_4557_Cli_Valider_les_parametres_pour_l_execution_du_plugin_DataHubExtractor()");
