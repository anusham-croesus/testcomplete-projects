...
/* Description : A partir du module « Clients » , afficher la fenêtre  "Ajouter un critère de recherche" en cliquant sur ToolBar – BtnAddOrDisplayAnActiveCriterion
Vérifier la présence des contrôles et des étiquetés. */


function Survol_Cli_Toolbar_BtnAddSearchCriterion()
{
