...
Analyste d'automatisation: Youlia Raisper */
 ...
 function CR1352_1511_Cli_Create_SimpleSearchCriteria_BranchAccessEditable()
 { 
   var criterion="CR1352_1511_BranchEditable";
   ...
   try{
       ...
       Get_WinAddSearchCriterion_ChkReadOnly().set_IsChecked(false);
       ...
       Get_WinSearchCriteriaManager().Find("Value",criterion,10).Click();   
        ...
        //Vérifier que Darwic peut modifier le critère de recherche  même la case lecture simplement
       Get_WinSearchCriteriaManager_BtnEdit().Click()   
       
       aqObject.CheckProperty(Get_WinAddSearchCriterion_TxtName(), "IsEnabled", cmpEqual, true);
       aqObject.CheckProperty(Get_WinAddSearchCriterion_TxtDescription(), "IsEnabled", cmpEqual, true);
       if (client == "BNC"){
          aqObject.CheckProperty(Get_WinAddSearchCriterion_CmbAccess(), "IsEnabled", cmpEqual, true);
       }
       else{//RJ
          aqObject.CheckProperty(Get_WinAddSearchCriterion_CmbAccess(), "IsEnabled", cmpEqual, false);
       }
       aqObject.CheckProperty(Get_WinAddSearchCriterion_CmbModule(), "IsEnabled", cmpEqual, true);
       aqObject.CheckProperty(Get_WinAddSearchCriterion_ChkReadOnly(), "IsEnabled", cmpEqual, false);
       //Log.Message("CROES-6706")
