...
//USEUNIT CommonCheckpoints
 ...
 /* Description :Dans le du module « Clients »,afficher la fenêtre «Add External Client» par ClickR ContextualMenu_AddExternal. 
Vérifier la présence des contrôles et des étiquetés et Cliquer sur chaque onglet pour vérifier le message qui apparaît */

function Survol_Cli_ContextualMenu_AddExternal()
{
  var btn="addExternal"
