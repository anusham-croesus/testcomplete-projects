...
function CR1806_4558_Cli_Valider_les_records_dans_la_table_B_DATA_HUB()
{
    Log.Message("CR1806_4558_Cli_Valider_les_records_dans_la_table_B_DATA_HUB()");
    CR1806_4558_Valider_les_records_dans_la_table_B_DATA_HUB_PourLeModule(moduleName_Clients);
}