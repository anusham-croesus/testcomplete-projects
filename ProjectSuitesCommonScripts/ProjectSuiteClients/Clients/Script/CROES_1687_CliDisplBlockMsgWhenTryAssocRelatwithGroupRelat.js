...
*/
function CROES_1687_CliDisplBlockMsgWhenTryAssocRelatwithGroupRelat()
{
    try {
        ...
        Login(vServerClients, userNameKEYNEJ, passwordKEYNEJ, language);
         var RELATIONSHIPCROES1687_1=ReadDataFromExcelByRowIDColumnID(filePath_Clients, "Anomalies", "RELATIONSHIPCROES1687_1", language+client);
         var RELATIONSHIPCROES1687_2=ReadDataFromExcelByRowIDColumnID(filePath_Clients, "Anomalies", "RELATIONSHIPCROES1687_2", language+client);
         var relationGroupeCROES1687=ReadDataFromExcelByRowIDColumnID(filePath_Clients, "Anomalies", "relationGroupeCROES1687", language+client);
         var CodeCpCROES_1687=ReadDataFromExcelByRowIDColumnID(filePath_Clients, "Anomalies", "CodeCpCROES_1687", language+client);
         var NumClient800257=ReadDataFromExcelByRowIDColumnID(filePath_Clients, "Anomalies", "NumClient800257", language+client);
         var MsgInformatCROES_1687=ReadDataFromExcelByRowIDColumnID(filePath_Clients, "Anomalies", "MsgInformatCROES_1687", language+client);
         ...
         //Assigner la relation relationship1 au client  NumClient800257
         Get_ModulesBar_BtnClients().Click();
         Search_Client(NumClient800257)
         Get_RelationshipsClientsAccountsGrid().Find("Value",NumClient800257,10).ClickR();
        ...
        //Assigner la relation relationship2 au client  NumClient800257
         Get_ModulesBar_BtnClients().Click();
         Search_Client(NumClient800257)
         Get_RelationshipsClientsAccountsGrid().Find("Value",NumClient800257,10).ClickR();
         Get_RelationshipsClientsAccountsGrid_ContextualMenu_Relationship().Click();
