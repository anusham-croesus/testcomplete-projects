...
/**
       ...
       Se connecter avec COPERN.
        ...
        https://jira.croesus.com/testlink/linkto.php?tprojectPrefix=Croes&item=testcase&id=Croes-779
         ...
         5- Choisir 'entre' pour le champ 'Opérateur',saisir une valeur ensuite cliquer sur le bouton 'Appliquer'
         MG: Choisir 'contenant' pour le champ 'Opérateur', saisir une valeur ensuite cliquer sur le bouton 'Appliquer':
...
function CR1501_779_Cli_FilterSearchByDateModifiedAndOperatorIsBetween()
{
    try {
          Log.Link("https://jira.croesus.com/testlink/linkto.php?tprojectPrefix=Croes&item=testcase&id=Croes-779");
       ...
       /*  var numberClient800300=ReadDataFromExcelByRowIDColumnID(filePath_Clients, "CR1501", "numberClient800300", language+client);
         var ClientTextAddNotTestCROES779=ReadDataFromExcelByRowIDColumnID(filePath_Clients, "CR1501", "ClientTextAddNotTestCROES779", language+client);
         ...
         Get_WinCRUANote_GrpNote_TxtNote().Keys(ClientTextAddNotTestCROES779);
         ...
         WaitObject(Get_WinCRUANote(),"UID","NoteSentenceDataGrid_ae74")
         var textAjoutNoteCROES779=Get_WinCRUANote_GrpNote_TxtNote().Text;
         Log.Message(textAjoutNoteCROES779)
         ...
         Get_WinCRUANote_BtnSave().Click();
          ...
          Get_WinInfo_Notes_TabGrid_DgvNotes().FindChild("Value", VarToString(textAjoutNoteCROES779), 10).Click();
          
         
          aqObject.CheckProperty(Get_WinInfo_Notes_TabGrid_TxtNote(),"wText", cmpEqual, textAjoutNoteCROES779);
          aqObject.CheckProperty(Get_WinInfo_Notes_TabGrid_TxtNote(),"wText", cmpContains, ClientTextAddNotTestCROES779);
          ...
          //Les points de vérifications
            ...
            var textNotCROES779= Get_WinInfo_Notes_TabGrid_DgvNotes().FindChild("Value", VarToString(textAjoutNoteCROES779), 10)
            var x=textNotCROES779.Exists;
            Log.Message(x);
          if(textNotCROES779.Exists)
            {
        ...
        //Delete_Note(ClientTextAddNotTestCROES779, vServerClients)
