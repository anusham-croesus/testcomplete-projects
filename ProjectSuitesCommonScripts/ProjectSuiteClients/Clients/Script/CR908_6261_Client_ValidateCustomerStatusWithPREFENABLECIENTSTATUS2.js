...
/**
    https://jira.croesus.com/testlink/linkto.php?tprojectPrefix=Croes&item=testcase&id=Croes-6261
...
function CR908_6261_Client_ValidateCustomerStatusWithPREFENABLECIENTSTATUS2()
{
    try {
          Log.Link("https://jira.croesus.com/testlink/linkto.php?tprojectPrefix=Croes&item=testcase&id=Croes-6261");
         
          //	Mettre la préférence PREF_ENABLE_CLIENT_STATUS = 2
           Activate_Inactivate_PrefFirm("FIRM_1","PREF_ENABLE_CLIENT_STATUS","2",vServerClients);
           ...
           /*3. Faire info client */
           Get_ClientsBar_BtnInfo().Click();
           /*Les points de vérifications : Le champ État = Ouvert Anglais le champ Status = Deleted*/
           aqObject.CheckProperty(Get_WinDetailedInfo_TabInfo_GrpGeneral_TxtStatusForRelationship(), "Text", cmpEqual, statuClientDeleted);
          Get_WinDetailedInfo_BtnCancel().Click();
          
           /*Faire la recherche du client 800015*/
           Search_Client(numberClient800015);
           Get_RelationshipsClientsAccountsGrid().FindChild("Value", numberClient800015, 10).Click();
           /*3. Faire info client */
           Get_ClientsBar_BtnInfo().Click();
           /*Les points de vérifications : Le champ État = Ouvert Anglais le champ Status = Open*/
           aqObject.CheckProperty(Get_WinDetailedInfo_TabInfo_GrpGeneral_TxtStatusForRelationship(), "Text", cmpEqual, statuClientOpen);
