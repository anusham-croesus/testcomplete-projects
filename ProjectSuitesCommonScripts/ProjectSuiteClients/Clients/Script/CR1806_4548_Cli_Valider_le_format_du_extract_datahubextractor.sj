...
function CR1806_4548_Cli_Valider_le_format_du_extract_datahubextractor()
{
    Log.Message("CR1806_4548_Cli_Valider_le_format_du_extract_datahubextractor()");
    CR1806_4548_Valider_le_format_du_extract_datahubextractor_PourLeModule(moduleName_Clients);
}