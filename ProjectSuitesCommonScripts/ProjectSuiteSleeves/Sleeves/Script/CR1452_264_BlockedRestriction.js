...
function CR1452_264_BlockedRestriction()
{
    try{             
...
function EditRestriction(restriction, cmbSeverity,severity){    
  ...
  Get_SubMenus().Find("WPFControlText",cmbSeverity,100).Click();
  Get_WinCRURestriction_BtnOK().Click();
  aqObject.CheckProperty(Get_WinRestrictionsManager_DgvRestriction().WPFObject("RecordListControl", "", 1).Items.Item(0).DataItem, "Severity",cmpEqual,severity); 
