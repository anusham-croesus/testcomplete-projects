...
function Creation_CHCAN2_Model()
{
    try{             
        var user=ReadDataFromExcelByRowIDColumnID(filePath_ExecutionVServers,"USER", "UNI00", "username");  
        var modelName=ReadDataFromExcelByRowIDColumnID(filePath_Sleeves, "CR1452", "ModelCR1452_CHCAN2", language+client);
        ...
        var PercentageBCE=ReadDataFromExcelByRowIDColumnID(filePath_Sleeves, "CR1452", "PercentageCHCAN2_BCE", language+client);
