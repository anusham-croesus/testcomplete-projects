...
function Creation_TESTPOSBLOQ2_Model()
{
    try{             
        var user=ReadDataFromExcelByRowIDColumnID(filePath_ExecutionVServers,"USER", "UNI00", "username");  
        var modelName=ReadDataFromExcelByRowIDColumnID(filePath_Sleeves, "CR1452", "ModelCR1452_TESTP2", language+client);
        ...
        var percentageXCB=ReadDataFromExcelByRowIDColumnID(filePath_Sleeves, "CR1452", "Percentage_XCB_TESTP2", language+client);
        var securityNA = ReadDataFromExcelByRowIDColumnID(filePath_Sleeves, "CR1452", "PositionNA", language+client);
        var percentageNA=ReadDataFromExcelByRowIDColumnID(filePath_Sleeves, "CR1452", "Percentage_NA", language+client);
        ...
        Get_Toolbar_BtnAdd().Click();     
        AddPositionToModel(securityNA,percentageNA,typePicker,"")
