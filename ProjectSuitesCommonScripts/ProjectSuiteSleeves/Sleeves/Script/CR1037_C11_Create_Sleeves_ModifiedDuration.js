...
function CR1037_C11_Create_Sleeves_ModifiedDuration()
{
      try{   
           
         var user =ReadDataFromExcelByRowIDColumnID(filePath_ExecutionVServers,"USER", "COPERN", "username")         
         var account= ReadDataFromExcelByRowIDColumnID(filePath_Sleeves, "CreationOfSleeves", "AccountNo_C11", language+client);
         var assetAllocation = ReadDataFromExcelByRowIDColumnID(filePath_Sleeves, "CreationOfSleeves", "WinManagerSleeveCmbAssetAllocationModifiedDuration", language+client);
        ...
        //c)Tous les titres de chaque classe d'actifs sont affichés dans la sleeve correspondante.
         ...
         var assetClassItems3_5years =GetAssetClassItems(Get_Portfolio_AssetClassesGrid_DgvItem(3))// suavgarde les positions de chaque segment de la grille
         Compare_UnderlyingSecurities_vs_AssetClassItems(assetClassItems3_5years,sleeveDescription[2])
         Get_Portfolio_AssetClassesGrid().WPFObject("RecordListControl", "", 1).WPFObject("DataRecordPresenter", "", 3).set_IsExpanded(false) // Fermer + 
         
         var assetClass5_10years =GetAssetClassItems(Get_Portfolio_AssetClassesGrid_DgvItem(4))
         Compare_UnderlyingSecurities_vs_AssetClassItems(assetClass5_10years,sleeveDescription[3])
         Get_Portfolio_AssetClassesGrid().WPFObject("RecordListControl", "", 1).WPFObject("DataRecordPresenter", "", 4).set_IsExpanded(false)  
         
         var assetClass10years =GetAssetClassItems(Get_Portfolio_AssetClassesGrid_DgvItem(5))
         Compare_UnderlyingSecurities_vs_AssetClassItems(assetClass10years,sleeveDescription[4])
         Get_Portfolio_AssetClassesGrid().WPFObject("RecordListControl", "", 1).WPFObject("DataRecordPresenter", "", 5).set_IsExpanded(false) 
                  
         var assetClassOther =GetAssetClassItems(Get_Portfolio_AssetClassesGrid_DgvItem(6))
         Compare_UnderlyingSecurities_vs_AssetClassItems(assetClassOther,sleeveDescription[5])
         Get_Portfolio_AssetClassesGrid().WPFObject("RecordListControl", "", 1).WPFObject("DataRecordPresenter", "",6).set_IsExpanded(false)
