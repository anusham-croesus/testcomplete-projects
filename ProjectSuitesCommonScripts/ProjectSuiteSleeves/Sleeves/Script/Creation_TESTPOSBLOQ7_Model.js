...
function Creation_TESTPOSBLOQ7_Model()
{
    try{             
        var user=ReadDataFromExcelByRowIDColumnID(filePath_ExecutionVServers,"USER", "UNI00", "username");  
        var modelName=ReadDataFromExcelByRowIDColumnID(filePath_Sleeves, "CR1452", "ModelCR1452_TESTPOSBLOQ7", language+client);        
        ...
        var typePickerTitre=ReadDataFromExcelByRowIDColumnID(filePath_Sleeves, "CR1452", "TypePickerTitre", language+client);        
        var securityABX = ReadDataFromExcelByRowIDColumnID(filePath_Sleeves, "CR1452", "Security_SymbolABX", language+client);
        var PercentageABX=ReadDataFromExcelByRowIDColumnID(filePath_Sleeves, "CR1452", "Percentage_ABX", language+client);
        var securityR32316 = ReadDataFromExcelByRowIDColumnID(filePath_Sleeves, "CR1452", "Security_R32316", language+client);
        var percentageR32316=ReadDataFromExcelByRowIDColumnID(filePath_Sleeves, "CR1452", "Percentage_R32316_BLOQ7", language+client);
        ...
        AddPositionToModel(securityABX,PercentageABX,typePicker,"")      
        
        //Ajouter une position R32316  
        Get_Toolbar_BtnAdd().Click();     
        AddPosition(securityR32316,percentageR32316,typePickerTitre,"")
