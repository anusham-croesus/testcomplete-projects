...
function CR1452_2438_RebalancingAccount_WithModel()
{
    try{  
        ...
        var sleeveAdhoc= ReadDataFromExcelByRowIDColumnID(filePath_Sleeves, "CR1452", "SleeveDescriptionCR1452_2438", language+client);              
        ...
        var messageAccount =ReadDataFromExcelByRowIDColumnID(filePath_Sleeves, "CR1452", "MessageAccount_2438", language+client);
        var messageCanadianEquity=ReadDataFromExcelByRowIDColumnID(filePath_Sleeves, "CR1452", "MessageCanadianEquity_2438", language+client);
        ...
        /*Validation: Au niveau du compte: Achat de 88 ABX Message d'exclusion qui s'affiche, Valeur théorique: 362557.02$ Exclusion: 35481.10$ CAD de R32316 */                
        ...
        aqObject.CheckProperty(Get_WinRebalance_TabProposedOrders_DgvProposedOrders().WPFObject("RecordListControl", "", 1).Find("Value",securityABX,10).DataContext.DataItem, "EditableQuantity", cmpEqual, quantityABX);
        //Validation du message 
        aqObject.CheckProperty(Get_WinRebalance_TabProjectedPortfolios_TabProposedOrders_GrpRebalancingMessages_LblZeroMarketValueMsg(), "Text", cmpContains, messageAccount);
        
        /*Validation: Au niveau du segment 'Actions Canadiennes': Achat de 88 ABX Achat de 39000 R32316 Message d'exclusion qui s'affiche, Valeur théorique: 133816.10$ Exclusion: 35481.10$ CAD de R32316*/      
        ...
        aqObject.CheckProperty(Get_WinRebalance_TabProposedOrders_DgvProposedOrders().WPFObject("RecordListControl", "", 1).Find("Value",securityABX,10).DataContext.DataItem, "OrderType", cmpEqual, orderType);
        aqObject.CheckProperty(Get_WinRebalance_TabProposedOrders_DgvProposedOrders().WPFObject("RecordListControl", "", 1).Find("Value",securityABX,10).DataContext.DataItem, "EditableQuantity", cmpEqual, quantityABX);
        aqObject.CheckProperty(Get_WinRebalance_TabProposedOrders_DgvProposedOrders().WPFObject("RecordListControl", "", 1).Find("Value",securityR32316,10).DataContext.DataItem, "OrderType", cmpEqual, orderType);
        aqObject.CheckProperty(Get_WinRebalance_TabProposedOrders_DgvProposedOrders().WPFObject("RecordListControl", "", 1).Find("Value",securityR32316,10).DataContext.DataItem, "EditableQuantity", cmpEqual, quantityR32316);
        //Validation du message 
        aqObject.CheckProperty(Get_WinRebalance_TabProjectedPortfolios_TabProposedOrders_GrpRebalancingMessages_LblZeroMarketValueMsg(), "WPFControlText", cmpContains, messageCanadianEquity);
        
        /*Validation: Au niveau du segment 'Non attribués': Vente de -39000 R32316 */   
        Get_WinRebalance_TabProjectedPortfolios_PnlBrowser_DgvNavigator().WPFObject("RecordListControl", "", 1).WPFObject("DataRecordPresenter", "", 1).set_IsExpanded(true)
        ...
        aqObject.CheckProperty(Get_WinRebalance_TabProposedOrders_DgvProposedOrders().WPFObject("RecordListControl", "", 1).Find("Value",securityR32316,10).DataContext.DataItem, "OrderType", cmpEqual, orderTypeSell);
        aqObject.CheckProperty(Get_WinRebalance_TabProposedOrders_DgvProposedOrders().WPFObject("RecordListControl", "", 1).Find("Value",securityR32316,10).DataContext.DataItem, "EditableQuantity", cmpEqual, quantityR32316);
