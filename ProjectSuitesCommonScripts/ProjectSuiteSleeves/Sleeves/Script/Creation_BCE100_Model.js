...
function Creation_BCE100_Model()
{
    try{             
        ...
        var percentage=ReadDataFromExcelByRowIDColumnID(filePath_Sleeves, "CR1452", "ModelBCE100Percentage", language+client);
        ...
        AddPositionToModel(BCE ,percentage,typePicker,"")  
