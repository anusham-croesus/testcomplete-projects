...
function CR1452_2514_RebalancingAccount()
{
    try{  
        ...
        var messageAccount =ReadDataFromExcelByRowIDColumnID(filePath_Sleeves, "CR1452", "MessageAccount_2514", language+client);
        var messageAdhoc=ReadDataFromExcelByRowIDColumnID(filePath_Sleeves, "CR1452", "MessageAdhoc_2514", language+client);
        ...
        /*Validation: Au niveau du compte: valeur théorique =331.43$ exclusion = 5400.57$*/          
        ...
        /*Au niveau du segment Adh: mêmes valeurs: valeur théorique =331.43$ exclusion = 5400.57$ */  
...
function ResetData(account,securityPOW){

    ChangeNonRedeemable(securityPOW,false); 
    //Pour rafraîchir les données   
    Get_ModulesBar_BtnAccounts().Click();
    ...
    Drag(Get_RelationshipsClientsAccountsGrid().Find("Value",account,10), Get_ModulesBar_BtnPortfolio());       
    //Valider que la position est non-rachetable
    aqObject.CheckProperty(Get_Portfolio_AssetClassesGrid().WPFObject("RecordListControl", "", 1).Find("Value",securityPOW,10).DataContext.DataItem, "IsBlockedSecurity", cmpEqual,false);
