...
function CR1452_2422_RebalancingAccount_WithModel()
{
    try{ 
        ...
        var quantityToMoveXCB =ReadDataFromExcelByRowIDColumnID(filePath_Sleeves, "CR1452", "PercentageToMoveXCB", language+client);
        var messageAccount=ReadDataFromExcelByRowIDColumnID(filePath_Sleeves, "CR1452", "Message_CR1452_2422", language+client);
        var messageAdhoc=ReadDataFromExcelByRowIDColumnID(filePath_Sleeves, "CR1452", "MessageAdhoc_CR1452_2422", language+client);
        var messageLongTerme=ReadDataFromExcelByRowIDColumnID(filePath_Sleeves, "CR1452", "MessageLongTerme_CR1452_2422", language+client);
        ...
        Get_WinMoveSecurities_GrpSecurities_DgvListView().Items.Item(0).set_PercentageToMove(quantityToMoveXCB)
        Get_WinMoveSecurities_CmbToSleeve().Keys(sleeveAdhoc);                
        Get_WinMoveSecurities_CmbToSleeve().Keys(sleeveAdhoc);
        Get_WinMoveSecurities_BtnOk().Click();       
        ...
        /*Validation:Dans 'Long terme': Achat Dis: 187 */        
