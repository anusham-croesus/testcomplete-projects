...
function Creation_TESTPOSBLOQ6_Model()
{
    try{             
        var user=ReadDataFromExcelByRowIDColumnID(filePath_ExecutionVServers,"USER", "UNI00", "username");  
        var modelName=ReadDataFromExcelByRowIDColumnID(filePath_Sleeves, "CR1452", "ModelCR1452_TESTPOSBLOQ6", language+client);
        ...
        var PercentageBCE=ReadDataFromExcelByRowIDColumnID(filePath_Sleeves, "CR1452", "Percentage_BCE", language+client);
        ...
        AddPositionToModel(securityBCE,PercentageBCE,typePicker,"")      
