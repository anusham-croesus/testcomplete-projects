...
function Help_Client_ArchivDocuments_Properties_ClickRight()
{
  ...
  Get_WinPersonalDocuments().ClickR(); //La zone grise où se trouve les propriétés lorsqu'un fichier est sélectionné
