...
function Help_Client_Address_AddPhone_ClickRight()
{
  ...
  Get_WinCRUTelephone_LblType().ClickR();
  ...
  aqObject.CheckProperty(Get_HelpWindow_Title(vServerHelp),
                                "contentText", cmpEqual, ReadDataFromExcelByRowIDColumnID(filePath_Help, "Feuil1", 22, columnID));
  
  Get_WinCRUTelephone().Close();
