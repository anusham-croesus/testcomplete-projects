...
function ExecutionLog()
{
    ...
    if (SendMail("christophe.paring@croesus.com;youlia.raisper@croesus.com;xian.wei@croesus.com;emna.ibn.hadj.mohamed@croesus.com", "mail.croesus.com", "TestComplete Execution", "testauto@croesus.com", client + " Agenda - exécution des scripts terminée", "L'exécution des scripts du projet Agenda est maintenant terminée."))
