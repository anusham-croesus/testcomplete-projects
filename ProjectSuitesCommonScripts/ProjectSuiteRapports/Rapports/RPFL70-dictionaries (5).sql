...
insert into b_dict (code_dict,  indexdict, user_num, desc_l1, desc_l2, mnemonic_l1, mnemonic_l2, opts, ordre_Affi) values (64, 2, 0,  "Seamark équilibré - imposable"                     ,     "Seamark Asset Management Balanced - Taxable"   ,    "C302", "C302", "P", 2) 
insert into b_dict (code_dict,  indexdict, user_num, desc_l1, desc_l2, mnemonic_l1, mnemonic_l2, opts, ordre_Affi) values (64, 3, 0,  "Foyston, Gordon & Payne Can. éq. - imposable"      ,     "Foyston Gordon & Payne Cdn Balanced - Taxable" ,    "C303", "C303", "P", 3) 
insert into b_dict (code_dict,  indexdict, user_num, desc_l1, desc_l2, mnemonic_l1, mnemonic_l2, opts, ordre_Affi) values (64, 4, 0,  "KBSH équilibré - imposable"                            , "KBSH Capital Management Balanced - Taxable"        ,"C304", "C304", "P", 4) 
insert into b_dict (code_dict,  indexdict, user_num, desc_l1, desc_l2, mnemonic_l1, mnemonic_l2, opts, ordre_Affi) values (64, 5, 0,  "Seamark équilibré - non-imposable"                     , "Seamark Balanced - Non-Taxable"                    ,"C305", "C305", "P", 5) 
insert into b_dict (code_dict,  indexdict, user_num, desc_l1, desc_l2, mnemonic_l1, mnemonic_l2, opts, ordre_Affi) values (64, 6, 0,  "KBSH équilibré - non imposable"                        , "KBSH Balanced - Non-Taxable"                       ,"C306", "C306", "P", 6) 
...
insert into b_dict (code_dict,  indexdict, user_num, desc_l1, desc_l2, mnemonic_l1, mnemonic_l2, opts, ordre_Affi) values (64, 10, 0, "KBSH canadiennes équilibré"                        ,     "KBSH Capital Management Canadian Balanced"     ,    "C311", "C311", "P", 10)
...
insert into b_dict (code_dict,  indexdict, user_num, desc_l1, desc_l2, mnemonic_l1, mnemonic_l2, opts, ordre_Affi) values (64, 12, 0, "Sceptre canadiennes à petite capitalisation"       ,     "Sceptre Investment Counsel Canadian Small Cap" ,    "C314", "C314", "P", 12)
insert into b_dict (code_dict,  indexdict, user_num, desc_l1, desc_l2, mnemonic_l1, mnemonic_l2, opts, ordre_Affi) values (64, 13, 0, "Mawer canadiennes à petite capitalisation"         ,     "Mawer Canadian Small Cap"                      ,    "C315", "C315", "P", 13)
insert into b_dict (code_dict,  indexdict, user_num, desc_l1, desc_l2, mnemonic_l1, mnemonic_l2, opts, ordre_Affi) values (64, 14, 0, "Jarislowsky Fraser équilibré - imposable"              , "Jarislowsky Fraser Ltd. Balanced - Taxable"        ,"C316", "C316", "P", 14)
insert into b_dict (code_dict,  indexdict, user_num, desc_l1, desc_l2, mnemonic_l1, mnemonic_l2, opts, ordre_Affi) values (64, 15, 0, "Jarislowsky Fraser équilibré - non imposable"      ,     "Jarislowsky Fraser Balanced - Non-Taxable"     ,    "C317", "C317", "P", 15)
...
insert into b_dict (code_dict,  indexdict, user_num, desc_l1, desc_l2, mnemonic_l1, mnemonic_l2, opts, ordre_Affi) values (64, 19, 0, "KBSH titres à revenu diversifié"                        , "KBSH Capital Management Diversified Income"        ,"C321", "C321", "P", 19)
insert into b_dict (code_dict,  indexdict, user_num, desc_l1, desc_l2, mnemonic_l1, mnemonic_l2, opts, ordre_Affi) values (64, 20, 0, "Dreman actions américaines"                        ,     "Dreman Value Management US Equity"             ,    "C322", "C322", "P", 20)
insert into b_dict (code_dict,  indexdict, user_num, desc_l1, desc_l2, mnemonic_l1, mnemonic_l2, opts, ordre_Affi) values (64, 21, 0, "Brandes actions américaines"                           , "Brandes Investment Partners US Equity*"            ,"C324", "C324", "P", 21)
...
insert into b_dict (code_dict,  indexdict, user_num, desc_l1, desc_l2, mnemonic_l1, mnemonic_l2, opts, ordre_Affi) values (64, 24, 0, "Pitcairn am?ricaines à petite capitalisation"      ,     "Pitcairn Financial Group US Small Cap"         ,    "C327", "C327", "P", 24)
...
insert into b_dict (code_dict,  indexdict, user_num, desc_l1, desc_l2, mnemonic_l1, mnemonic_l2, opts, ordre_Affi) values (64, 29, 0, "Transamerica actions américaines"                  ,     "Transamerica Capital Group US Equity"          ,    "C335", "C335", "P", 29)
insert into b_dict (code_dict,  indexdict, user_num, desc_l1, desc_l2, mnemonic_l1, mnemonic_l2, opts, ordre_Affi) values (64, 30, 0, "McLean Budden Fonds équilibré - imposable"         ,     "McLean Budden Balanced - Taxable"              ,    "C337", "C337", "P", 30)
insert into b_dict (code_dict,  indexdict, user_num, desc_l1, desc_l2, mnemonic_l1, mnemonic_l2, opts, ordre_Affi) values (64, 31, 0, "McLean Budden Fonds équilibré - non imposable"     ,     "McLean Budden Balanced - Non Taxable"          ,    "C338", "C338", "P", 31)
insert into b_dict (code_dict,  indexdict, user_num, desc_l1, desc_l2, mnemonic_l1, mnemonic_l2, opts, ordre_Affi) values (64, 32, 0, "Foyston, Gordon & Payne Can. équil.- non imp."     ,     "Foyston, Gordon & Payne Cdn Bal.-Non-Taxable"  ,    "C339", "C339", "P", 32)
...
insert into b_dict (code_dict,  indexdict, user_num, desc_l1, desc_l2, mnemonic_l1, mnemonic_l2, opts, ordre_Affi) values (64, 41, 0, "Jarislowsky Fraser Nord-Amér. - imposable"             , "Jarislowsky Fraser North American - Taxable"       ,"C349", "C349", "P", 41)
insert into b_dict (code_dict,  indexdict, user_num, desc_l1, desc_l2, mnemonic_l1, mnemonic_l2, opts, ordre_Affi) values (64, 42, 0, "Jarislowsky Fraser. Nord-amér.- non imposable"     ,     "Jarislowsky Fraser N.-American - Non-Taxable"  ,    "C350", "C350", "P", 42)
...
insert into b_dict (code_dict,  indexdict, user_num, desc_l1, desc_l2, mnemonic_l1, mnemonic_l2, opts, ordre_Affi) values (64, 45, 0, "Mawer Fonds à traitement fiscal avantageux"        ,     "Mawer Investment Management Tax Efficient"     ,    "C353", "C353", "P", 45)
insert into b_dict (code_dict,  indexdict, user_num, desc_l1, desc_l2, mnemonic_l1, mnemonic_l2, opts, ordre_Affi) values (64, 46, 0, "McLean Budden Fonds d'actions américaines"         ,     "McLean Budden US Equity"                       ,    "C354", "C354", "P", 46)
...
insert into b_dict (code_dict,  indexdict, user_num, desc_l1, desc_l2, mnemonic_l1, mnemonic_l2, opts, ordre_Affi) values (64, 48, 0, "Fairlane titres à revenu fixe"                         , "Fairlane Asset Management Fixed Income"            ,"C356", "C356", "P", 48)
...
insert into b_dict (code_dict,  indexdict, user_num, desc_l1, desc_l2, mnemonic_l1, mnemonic_l2, opts, ordre_Affi) values (64, 53, 0, "Sionna canadiennes équilibré"                      ,     "Sionna Investment Managers Canadian Balanced"  ,    "C362", "C362", "P", 53)
