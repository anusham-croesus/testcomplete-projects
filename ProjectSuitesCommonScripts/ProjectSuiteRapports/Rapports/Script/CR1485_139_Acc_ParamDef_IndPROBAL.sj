...
//USEUNIT CR1485_139_Common_functions
...
function CR1485_139_Acc_ParamDef_IndPROBAL()
{
    Log.Message("JIRA CROES-9342");
    Log.Message("Bug JIRA CROES-10329");
    
    try {
        reportName = GetData(filePath_ReportsCR1485, "139_Summarized_Branch", 2, language);
        accountNumber = GetData(filePath_ReportsCR1485, "139_Summarized_Branch", 21);
        ...
        reportFileName = GetData(filePath_ReportsCR1485, "139_Summarized_Branch", 23);
        ...
        //Default parameters
        reportLanguage = GetData(filePath_ReportsCR1485, "139_Summarized_Branch", 26, language);
        ...
        reportFileName = GetData(filePath_ReportsCR1485, "139_Summarized_Branch", 29);
        ...
        //Default parameters
        reportLanguage = GetData(filePath_ReportsCR1485, "139_Summarized_Branch", 32, language);
        SetReportsOptions(null, null, null, reportLanguage);
