...
function CR1485_138_Acc_ParamDef_IndPROBAL()
{
    ...
    try {
        ...
        accountNumber = GetData(filePath_ReportsCR1485, "138_Summarized_Region", 21);
        ...
        reportFileName = GetData(filePath_ReportsCR1485, "138_Summarized_Region", 23);
        ...
        //Default parameters
        reportLanguage = GetData(filePath_ReportsCR1485, "138_Summarized_Region", 26, language);
        ...
        reportFileName = GetData(filePath_ReportsCR1485, "138_Summarized_Region", 29);
        ...
        //Default parameters
        reportLanguage = GetData(filePath_ReportsCR1485, "138_Summarized_Region", 32, language);
        SetReportsOptions(null, null, null, reportLanguage);
