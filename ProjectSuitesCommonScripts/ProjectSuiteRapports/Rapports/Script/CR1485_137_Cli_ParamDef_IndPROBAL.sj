...
function CR1485_137_Cli_ParamDef_IndPROBAL()
{
    ...
    try {
        ...
        clientNumber = GetData(filePath_ReportsCR1485, "137_Summarized_IA", 5);
        ...
        reportFileName = GetData(filePath_ReportsCR1485, "137_Summarized_IA", 7);
        ...
        //Default parameters
        reportLanguage = GetData(filePath_ReportsCR1485, "137_Summarized_IA", 10, language);
        ...
        reportFileName = GetData(filePath_ReportsCR1485, "137_Summarized_IA", 13);
        ...
        //Default parameters
        reportLanguage = GetData(filePath_ReportsCR1485, "137_Summarized_IA", 16, language);
        SetReportsOptions(null, null, null, reportLanguage);
