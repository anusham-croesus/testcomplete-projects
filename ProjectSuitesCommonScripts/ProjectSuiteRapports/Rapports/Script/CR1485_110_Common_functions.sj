...
{
    Activate_Inactivate_Pref(userNameReportsCR1485, "PREF_PIMG_COVER_PAGE", "YES", vServerReportsCR1485);
    
    //Activer la pref pour le rapport "Revenus" ("Income") : rapport à jumeler avec le rapport "Page couverture GGPP"
