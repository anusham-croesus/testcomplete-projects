...
function ActivatePrefs()
{
    ...
    Activate_Inactivate_Pref(userNameReportsCR1485, "PREF_REPORT_MATURITY", "YES", vServerReportsCR1485);
    Activate_Inactivate_Pref(userNameReportsCR1485, "PREF_REPORT_DISPLAY_BRANCH_ADDRESS", "YES", vServerReportsCR1485);
}



function SetReportParameters(startDate, endDate, checkAllRecords, costCalculation)
{
