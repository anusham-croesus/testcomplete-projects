...
function CR1485_140_Cli_ParamDef()
{
    ...
    try {
        ...
        clientNumber = GetData(filePath_ReportsCR1485, "140_Summarized_Investor_IA", 5);
        ...
        reportFileName = GetData(filePath_ReportsCR1485, "140_Summarized_Investor_IA", 7);
        ...
        //Default parameters
        reportLanguage = GetData(filePath_ReportsCR1485, "140_Summarized_Investor_IA", 10, language);
        ...
        reportFileName = GetData(filePath_ReportsCR1485, "140_Summarized_Investor_IA", 13);
        ...
        //Default parameters
        reportLanguage = GetData(filePath_ReportsCR1485, "140_Summarized_Investor_IA", 16, language);
        SetReportsOptions(null, null, null, reportLanguage);
