...
{
    //Activer la pref du rapport 147
    Activate_Inactivate_Pref(userName, "PREF_REPORT_PMFA_COVERPAGE1", "YES", vServerReportsCR1485);
    
    //Désactiver la pref du rapport 148 (Car même nom)
    Activate_Inactivate_Pref(userName, "PREF_REPORT_PMFA_COVERPAGE2", "NO", vServerReportsCR1485);
