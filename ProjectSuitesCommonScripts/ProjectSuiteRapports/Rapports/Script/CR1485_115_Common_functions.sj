...
{
    //Activate_Inactivate_PrefBranch("0", "PREF_REPORT_MSTAR_SNAPSHOT", "YES", vServerReportsCR1485);
    //Activate_Inactivate_PrefBranch("0", "PREF_REPORT_SHOW_MSTAR_SNAPSHOT", "1", vServerReportsCR1485);
    
    Activate_Inactivate_Pref(userNameReportsCR1485, "PREF_REPORT_MSTAR_SNAPSHOT", "YES", vServerReportsCR1485);
    Activate_Inactivate_Pref(userNameReportsCR1485, "PREF_REPORT_SHOW_MSTAR_SNAPSHOT", "1", vServerReportsCR1485);
}
