...
function CR1485_142_Cli_ParamDef()
{
    ...
    try {
        ...
        reportFileName = GetData(filePath_ReportsCR1485, "142_Summarized_Investor_Region", 7);
        ...
        //Default parameters
        reportLanguage = GetData(filePath_ReportsCR1485, "142_Summarized_Investor_Region", 10, language);
        ...
        reportFileName = GetData(filePath_ReportsCR1485, "142_Summarized_Investor_Region", 13);
        ...
        //Default parameters
        reportLanguage = GetData(filePath_ReportsCR1485, "142_Summarized_Investor_Region", 16, language);
        SetReportsOptions(null, null, null, reportLanguage);
