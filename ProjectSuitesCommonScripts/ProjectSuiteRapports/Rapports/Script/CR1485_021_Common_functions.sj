...
{
    Activate_Inactivate_Pref(userNameReportsCR1485, "PREF_REPORT_TRANS_MISSING_COST", "YES", vServerReportsCR1485);
    Activate_Inactivate_Pref(userNameReportsCR1485, "PREF_ENABLE_REPORT_TRANS_MISSING_COST", "YES", vServerReportsCR1485);
