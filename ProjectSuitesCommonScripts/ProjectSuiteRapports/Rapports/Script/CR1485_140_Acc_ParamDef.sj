...
//USEUNIT CR1485_140_Common_functions
...
function CR1485_140_Acc_ParamDef()
{
    Log.Message("Bug JIRA CROES-10192");
    Log.Message("Bug JIRA CROES-10329");
    
    try {
        reportName = GetData(filePath_ReportsCR1485, "140_Summarized_Investor_IA", 2, language);
        accountNumber = GetData(filePath_ReportsCR1485, "140_Summarized_Investor_IA", 21);
        ...
        reportFileName = GetData(filePath_ReportsCR1485, "140_Summarized_Investor_IA", 23);
        ...
        //Default parameters
        reportLanguage = GetData(filePath_ReportsCR1485, "140_Summarized_Investor_IA", 26, language);
        ...
        reportFileName = GetData(filePath_ReportsCR1485, "140_Summarized_Investor_IA", 29);
        ...
        //Default parameters
        reportLanguage = GetData(filePath_ReportsCR1485, "140_Summarized_Investor_IA", 32, language);
        SetReportsOptions(null, null, null, reportLanguage);
