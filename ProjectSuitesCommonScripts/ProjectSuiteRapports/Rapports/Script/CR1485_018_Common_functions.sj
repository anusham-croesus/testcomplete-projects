...
{
    Activate_Inactivate_Pref(userNameReportsCR1485, "PREF_SHOW_REPORT_HOLDERS_WEB", "YES", vServerReportsCR1485);
    Activate_Inactivate_Pref(userNameReportsCR1485, "PREF_REPORT_HOLDERS_WEB", "YES", vServerReportsCR1485);
