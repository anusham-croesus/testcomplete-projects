...
function ActivatePrefs()
{
    ...
    //Activer la pref du rapport 109
    Activate_Inactivate_Pref(userNameReportsCR1485, "PREF_ROGERS_COVER_PAGE", "YES", vServerReportsCR1485);
    
    //Désactiver les prefs du rapport 6 (Car même nom)
