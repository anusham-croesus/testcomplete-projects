...
function ActivatePrefs()
{
    ...
    MakeReportVisibleForRelationships("FBNGP_Q_EVAL", vServerReportsCR1485)
}



function SetReportParameters(asOfDate, checkIncludeGraph, checkGroupByRegion, checkGroupByIndustryCode, groupByIndustryCode, costCalculation, checkUseTheSpecifiedInvestmentObjective, checkFundBreakdownClassBreakdown, checkFundBreakdownAppendix, numbering)
{
    ...
    if (Get_WinParameters_GrpAssetAllocation_ChkUseTheSpecifiedInvestmentObjective().IsEnabled)
