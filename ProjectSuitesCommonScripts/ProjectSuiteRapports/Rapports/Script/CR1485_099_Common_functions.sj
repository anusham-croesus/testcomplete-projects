...
function ActivatePrefs()
{
    ...
    MakeReportVisibleForAccounts("FBNFISC_GP_NON_REAL", vServerReportsCR1485);
}



function SetReportParameters(asOfDate, checkGroupByRegion, checkGroupByIndustryCode, groupByIndustryCode, costCalculation, assetAllocation, customAllocation, checkFundBreakdownClassBreakdown, checkFundBreakdownAppendix, numbering)
{
