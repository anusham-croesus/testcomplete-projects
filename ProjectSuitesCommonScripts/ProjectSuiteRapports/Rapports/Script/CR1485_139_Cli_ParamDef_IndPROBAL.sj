...
function CR1485_139_Cli_ParamDef_IndPROBAL()
{
    ...
    try {
        ...
        clientNumber = GetData(filePath_ReportsCR1485, "139_Summarized_Branch", 5);
        ...
        reportFileName = GetData(filePath_ReportsCR1485, "139_Summarized_Branch", 7);
        ...
        //Default parameters
        reportLanguage = GetData(filePath_ReportsCR1485, "139_Summarized_Branch", 10, language);
        ...
        reportFileName = GetData(filePath_ReportsCR1485, "139_Summarized_Branch", 13);
        ...
        //Default parameters
        reportLanguage = GetData(filePath_ReportsCR1485, "139_Summarized_Branch", 16, language);
        SetReportsOptions(null, null, null, reportLanguage);
