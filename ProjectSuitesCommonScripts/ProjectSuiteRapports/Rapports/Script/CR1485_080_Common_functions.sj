...
{
    Activate_Inactivate_Pref(userNameReportsCR1485, "PREF_REPORT_FDP_TRANSACTION", "YES", vServerReportsCR1485);
    ...
    //Rendre le rapport visible pour le module Clients de Croesus car c'est un rapport WebAdvisor
    //MakeReportVisibleForClients("FDP_TRANSACTION", vServerReportsCR1485);
}



function SetReportParameters(numbering)
{
