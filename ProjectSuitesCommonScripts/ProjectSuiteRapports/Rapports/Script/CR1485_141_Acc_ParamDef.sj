...
function CR1485_141_Acc_ParamDef()
{
    ...
    try {
        ...
        reportFileName = GetData(filePath_ReportsCR1485, "141_Summarized_Investor_Firm", 23);
        ...
        //Default parameters
        reportLanguage = GetData(filePath_ReportsCR1485, "141_Summarized_Investor_Firm", 26, language);
        ...
        reportFileName = GetData(filePath_ReportsCR1485, "141_Summarized_Investor_Firm", 29);
        ...
        //Default parameters
        reportLanguage = GetData(filePath_ReportsCR1485, "141_Summarized_Investor_Firm", 32, language);
        SetReportsOptions(null, null, null, reportLanguage);
