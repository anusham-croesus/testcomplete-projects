...
function ExecutionLog()
{
    ...
    PublishDataLocation(newReportsBackupPath, "Backup des Rapports", false);
    ...
    Log.Message("Save lsMHT Log to: " + ProjectSuite.Path + referenceName + ".mht");
	Log.SaveResultsAs(ProjectSuite.Path + referenceName + ".mht", lsMHT);
        
    Log.Message("Save lsJUnit Log to: " + ProjectSuite.Path + referenceName + ".xml");
	Log.SaveResultsAs(ProjectSuite.Path + referenceName + ".xml", lsJUnit);
        
    Log.Message("Save lsZip Log to: " + ProjectSuite.Path + referenceName + ".zip");
