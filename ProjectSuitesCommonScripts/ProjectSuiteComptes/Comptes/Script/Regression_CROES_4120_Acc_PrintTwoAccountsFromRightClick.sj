...
function Regression_CROES_4120_Acc_PrintTwoAccountsFromRightClick()
{
  try
  {
    ...
    Log.AppendFolder("Select 2 accounts, print using right-click and validate that .pdf file is correctly saved.");
    Get_ModulesBar_BtnAccounts().Click();
    
    // Créer un tableau contenant les numéros de comptes 
    var comptes = new Array(account1, account2);
    ...
    Get_RelationshipsClientsAccountsGrid().FindChild("Value", account2, 10).ClickR();  
    Log.Message("Right-click on the Account window, and Print.");
