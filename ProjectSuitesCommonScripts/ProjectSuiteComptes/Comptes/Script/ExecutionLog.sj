...
function ExecutionLog()
{
    ...
    var referenceName = GetVServerReference(vServerAccounts);
    var executionEndDateTimeString = aqConvert.DateTimeToFormatStr(aqDateTime.Now(), "%Y_%m_%d %H_%M_%S");
    var projectName = GetExecutionLogProjectName("Accounts");
    ...
    if (SendMail("christophe.paring@croesus.com;youlia.raisper@croesus.com;sana.ayaz@croesus.com;xian.wei@croesus.com;emna.ibn.hadj.mohamed@croesus.com", "mail.croesus.com", "TestComplete Execution", "testauto@croesus.com", client + " Account - exécution des scripts terminée", "L'exécution des scripts du projet Account est maintenant terminée."))
