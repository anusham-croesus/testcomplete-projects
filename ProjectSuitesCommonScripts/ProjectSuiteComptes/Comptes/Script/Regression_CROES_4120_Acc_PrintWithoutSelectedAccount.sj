...
function Regression_CROES_4120_Acc_PrintWithoutSelectedAccount()
{
  try
  {
    ...
    Log.PopLogFolder();
    Log.Message("Validate that file was correctly saved.");
    
    if (aqFile.Exists(pdfFilenameFullPath))
    {
      Log.Checkpoint("The file was correctly saved to " + pdfFilenameFullPath + ".");
    }
    else
    {
      Log.Error("The file was not correctly saved to " + pdfFilenameFullPath + ".");
    }        
  }  
