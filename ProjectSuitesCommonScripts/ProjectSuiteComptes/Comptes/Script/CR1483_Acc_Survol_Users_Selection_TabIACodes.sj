...
function CR1483_Acc_Survol_Users_Selection_TabIACodes() 
{
            ...
            CR1483_Survol_Users_Selection_TabIACodes(vServerAccounts,Get_ModulesBar_BtnAccounts(),filePath_Accounts);
}
