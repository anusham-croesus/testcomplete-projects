...
*/
function CROES_11141_Comp_WhenAddingFilterByCreationDateTheCrashApplication()
{
  try {
       ...
       var CompTextAddNotTestCROES11141=ReadDataFromExcelByRowIDColumnID(filePath_Accounts, "Anomalies", "CompTextAddNotTestCROES11141", language+client);
       var descriptionFiltreCreatioDateCROES11141=ReadDataFromExcelByRowIDColumnID(filePath_Accounts, "Anomalies", "descriptionFiltreCreatioDateCROES11141", language+client);
        ...
        //Chercher un compte
         ...
         Get_WinCRUANote_GrpNote_TxtNote().set_Text(CompTextAddNotTestCROES11141);
         Get_WinCRUANote_GrpNote_TxtNote().Click()
         WaitObject(Get_WinCRUANote(),["UID", " IsEnabled"],["Button_eb1f", true],10);
         Get_WinCRUANote_BtnSave().Click();
         
          //Les points de vérifications
         
          aqObject.CheckProperty(Get_WinInfo_Notes_TabGrid_TxtNote(),"wText", cmpEqual, CompTextAddNotTestCROES11141);
           aqObject.CheckProperty(Get_WinInfo_Notes_TabGrid_TxtNote(),"wText", cmpContains, CompTextAddNotTestCROES11141);
            var textNotCROES11141= Get_WinInfo_Notes_TabGrid_DgvNotes().FindChild("Value", VarToString(CompTextAddNotTestCROES11141), 10)
        ...
        Delete_Note(CompTextAddNotTestCROES11141, vServerAccounts)
        Terminate_CroesusProcess();
    }
    finally {
