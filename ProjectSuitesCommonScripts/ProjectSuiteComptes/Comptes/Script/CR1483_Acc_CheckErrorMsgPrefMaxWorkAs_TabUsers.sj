...
function CR1483_Acc_CheckErrorMsgPrefMaxWorkAs_TabUsers() 
{
            ...
            CR1483_CheckErrorMsgPrefMaxWorkAs(vServerAccounts ,Get_ModulesBar_BtnAccounts(),"Users",filePath_Accounts,"CR1483_WinSelection_TabUsers_ErrorMsg" );    
}
