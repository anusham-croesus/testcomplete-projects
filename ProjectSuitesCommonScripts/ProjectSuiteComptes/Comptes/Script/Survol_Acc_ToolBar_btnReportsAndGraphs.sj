...
//USEUNIT CommonCheckpoints
 ...
 /* Description : A partir du module « Accounts » , afficher la fenêtre « Rapports titre » en cliquant sur Toolbar-btnReportsAndGraphs. 
...
Vérifier la présence des  boutons OK, Fermer, Modifier, Sauvegarder ,Paramètres  */
 ...
 function Survol_Acc_ToolBar_btnReportsAndGraphs()
{
  var module="accounts";
  var btn="reports";
