...
/* Description : Dans le module « Comptes », afficher l'onglet "Objectif de placement" de la fenêtre « Info compte » 
en cliquant sur AccountBar_Info > Objectif de placement. Vérifier que l'onglet "Objectif de placement" est bien sélectionné. */

function Survol_Acc_AccountsBar_BtnInfo_InvestmentObjective()
{
