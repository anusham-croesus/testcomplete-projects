...
function CR1483_Acc_RememberMySelection_TabUsers() 
{
            ...
            CR1483_RememberMySelection(vServerAccounts,Get_ModulesBar_BtnAccounts(),"Users", filePath_Accounts, "Copernic");
}
