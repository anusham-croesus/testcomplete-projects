...
function CR1483_Rel_Survol_Users_Selection_TabBranches() 
{
            ...
            CR1483_Survol_Users_Selection_TabBranches(vServerRelations,Get_ModulesBar_BtnRelationships(), filePath_Relations);
}
