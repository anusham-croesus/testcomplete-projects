...
function Get_WinQuickSearch_Tab_IACodes_RdoBranchCode()
{
...
function CR1483_Check_BranchSelection_IACodes(vServer,Button,BranchSelection) {
          ...
          try {
                   ...
                   // var BranchSelection = "Toronto";
                    ...
                    //Accéder à l'onglet Succursales
                    Get_WinUserMultiSelection_TabBranches().Click();
                    WaitObject(Get_CroesusApp(),"Uid","DataGrid_97ea");
                    ...
                    Get_WinUserMultiSelection_BtnApply().WaitProperty("IsEnabled", true, 5000);
                    Get_WinUserMultiSelection_BtnApply().Click();
                    WaitUntilObjectDisappears(Get_CroesusApp(),"Uid","UserMultiSelectionWindow_e5eb");
...
function CR1483_Check_UserSelection_IACodes(vServer,Button,UserSelection,IACode1, IACode2) {
          ...
          try {
                    ...
                    //Accéder à l'onglet Utilisateurs
                    Get_WinUserMultiSelection_TabUsers().Click();
                    WaitObject(Get_CroesusApp(),"Uid","DataGrid_e796");
...
function CR1483_Survol_Users_Selection_TabIACodes(vServer, Button, filePath) {
          ...
          try {
                    ...
                    var ExpectedFolder = folderPath_Data+"ExportToExcel\\"+client+"\\ExpectedFolder\\Relationships\\WinSelection\\"+language+"\\";
                    var ResultFolder = folderPath_Data+"ExportToExcel\\"+client+"\\ResultFolder\\Relationships\\WinSelection\\"+language+"\\";  
                    ...
                    aqObject.CheckProperty(Get_WinQuickSearch_Tab_IACodes_RdoBranchCode().DataContext, "Label", cmpEqual, ReadDataFromExcelByRowIDColumnID(filePath, "CR1483", "CR1483_TabIACodes_QuickSearch_RdoBranchCode", language+client));  
                    aqObject.CheckProperty(Get_WinQuickSearch_Tab_IACodes_RdoBranchCode(), "IsVisible", cmpEqual, true);
                    aqObject.CheckProperty(Get_WinQuickSearch_Tab_IACodes_RdoBranchCode(), "IsEnabled", cmpEqual, true);
