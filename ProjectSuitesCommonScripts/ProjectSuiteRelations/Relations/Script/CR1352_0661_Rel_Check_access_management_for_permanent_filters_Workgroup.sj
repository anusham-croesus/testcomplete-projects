...
/**
    Description : Vérifier la gestion d'accès des filtres permanents - Équipe de travail
    https://jira.croesus.com/testlink/linkto.php?tprojectPrefix=Croes&item=testcase&id=Croes-661
    Analyste d'assurance qualité : Reda Alfaiz
    Analyste d'automatisation : Christophe Paring
*/

function CR1352_0661_Rel_Check_access_management_for_permanent_filters_Workgroup()
{
    var expectedIACode = "0AED";
    var filterName = "test0661";
