...
/**
    Description : Supprimer une relation par le menu droit de la souris
    https://jira.croesus.com/testlink/linkto.php?tprojectPrefix=Croes&item=testcase&id=Croes-599
    Analyste d'assurance qualité : Reda Alfaiz
    Analyste d'automatisation : Christophe Paring
*/

function CR1352_0599_Rel_Delete_a_relationship_with_the_mouse_right_click()
{
