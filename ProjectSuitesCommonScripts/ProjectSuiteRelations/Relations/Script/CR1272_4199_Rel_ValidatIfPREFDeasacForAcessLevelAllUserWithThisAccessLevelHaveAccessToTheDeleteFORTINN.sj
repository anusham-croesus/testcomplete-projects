...
function CR1272_4199_Rel_ValidatIfPREFDeasacForAcessLevelAllUserWithThisAccessLevelHaveAccessToTheDeleteFORTINN()
{
 var UserName=ReadDataFromExcelByRowIDColumnID(filePath_ExecutionVServers, "USER", "FORTINN", "username");
 var PassWord=ReadDataFromExcelByRowIDColumnID(filePath_ExecutionVServers, "USER", "FORTINN", "psw");
 ...
 var defaultValueChange=ReadDataFromExcelByRowIDColumnID(filePath_Relations, "CR1272", "defaultValueChangeFORTINN", language+client);
