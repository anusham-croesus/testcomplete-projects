...
function CR1483_Rel_CheckErrorMsgPrefMaxWorkAs() 
{
           ...
           CR1483_CheckErrorMsgPrefMaxWorkAs(vServerRelations ,Get_ModulesBar_BtnRelationships(),"Branches",filePath_Relations,"CR1483_WinSelection_TabBranches_ErrorMsg" );   
}
