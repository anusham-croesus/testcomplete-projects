...
function CR1483_Rel_Survol_Users_Selection_TabIACodes() 
{
            ...
            CR1483_Survol_Users_Selection_TabIACodes(vServerRelations,Get_ModulesBar_BtnRelationships(),filePath_Relations);
}
