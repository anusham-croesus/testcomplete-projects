...
//USEUNIT Survol_Rel_RelationshipsBar_BtnInfo
 ...
 /* Description :Dans le du module « Relationship » ,afficher la fenêtre «Create Relationship» par ToolBar_btnAdd. 
Vérifier la présence des contrôles et des étiquetés et et Cliquer sur chaque onglet pour vérifier le message qui apparaît*/
 ...
 function Survol_Rel_ToolBar_btnAdd()
{ 
  ...
  Check_Properties_RelationshipsInfo_TabInfo(language) // la fonction est dans Survol_Rel_RelationshipsBar_BtnInfo
  //Grp Note
