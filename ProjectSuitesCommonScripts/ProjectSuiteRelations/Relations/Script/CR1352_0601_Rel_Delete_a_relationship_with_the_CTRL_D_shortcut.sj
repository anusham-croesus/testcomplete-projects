...
/**
    Description : Supprimer une relation par le raccourci CTRL + D
    https://jira.croesus.com/testlink/linkto.php?tprojectPrefix=Croes&item=testcase&id=Croes-601
    Analyste d'assurance qualité : Reda Alfaiz
    Analyste d'automatisation : Christophe Paring
*/

function CR1352_0601_Rel_Delete_a_relationship_with_the_CTRL_D_shortcut()
{
