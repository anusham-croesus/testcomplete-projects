...
/**
    Description : Vérifier la gestion d'accès des filtres permanents - Firme
    https://jira.croesus.com/testlink/linkto.php?tprojectPrefix=Croes&item=testcase&id=Croes-660
    Analyste d'assurance qualité : Reda Alfaiz
    Analyste d'automatisation : Christophe Paring
*/

function CR1352_0660_Rel_Check_access_management_for_permanent_filters_Firm()
{
    var expectedIACode = "0AED";
    var filterName = "test0660";
