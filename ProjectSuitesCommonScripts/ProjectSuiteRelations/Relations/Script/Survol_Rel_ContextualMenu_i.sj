...
//USEUNIT Survol_Rel_RelationshipsBar_BtnInfo
 ...
 /* Description :Dans le du module « Relationships  »,afficher la fenêtre «Info» en cliquant sur ContextualMenu_i .(Pour la relation qui est sélectionnée par default #1 TEST) 
Vérifier la présence des contrôles et des étiquetés dans tous les onglets*/

function Survol_Rel_ContextualMenu_i()
{
