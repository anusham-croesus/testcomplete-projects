...
function CR1272_4199_Rel_ValidatIfPREFDeasacForAcessLevelAllUserWithThisAccessLevelHaveAccessToTheDeleteVICTOM()
{
 var UserName=ReadDataFromExcelByRowIDColumnID(filePath_ExecutionVServers, "USER", "VICTOM", "username");
 var PassWord=ReadDataFromExcelByRowIDColumnID(filePath_ExecutionVServers, "USER", "VICTOM", "psw");
 ...
 var defaultValueChange=ReadDataFromExcelByRowIDColumnID(filePath_Relations, "CR1272", "defaultValueChangeVICTOM", language+client);
