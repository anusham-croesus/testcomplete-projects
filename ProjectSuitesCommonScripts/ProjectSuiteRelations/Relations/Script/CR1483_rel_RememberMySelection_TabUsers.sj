...
function CR1483_Rel_RememberMySelection_TabUsers() 
{
            ...
            CR1483_RememberMySelection(vServerRelations, Get_ModulesBar_BtnRelationships(),"Users", filePath_Relations, "Copernic");
}
