...
function ExecutionLog()
{
    ...
    if (SendMail("christophe.paring@croesus.com;youlia.raisper@croesus.com;sana.ayaz@croesus.com;xian.wei@croesus.com;emna.ibn.hadj.mohamed@croesus.com", "mail.croesus.com", "TestComplete Execution", "testauto@croesus.com", client + " TransitionWeb - exécution des scripts terminée", "L'exécution des scripts du projet TransitionWeb est maintenant terminée."))
