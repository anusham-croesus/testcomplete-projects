...
function Performance_RCM_QueryLogStatusAll(){
...
//        var queryLogFromDate = ReadDataFromExcelByRowIDColumnID(filePath_Performance, sheetName_DataBD_RCM, "QueryLogFromDate", language+client);
        var statusValue      = ReadDataFromExcelByRowIDColumnID(filePath_Performance, sheetName_DataBD_RCM, "StatusValueAll", language+client);
             
        Performance_RCM_QueryLogStatus(statusValue, "Performance_RCM_QueryLogStatusAll");     
}