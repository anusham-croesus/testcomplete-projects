...
function Performance_Acc_Sleeves_RebalanceAllSleeves(){
...
//    var nbOfAccountsToBeSelected4 = GetData(filePath_Performance, sheetName_DataBD, 52, language);
    ...
    var SoughtForValue1 = "Performance_Acc_Sleeves_RebalanceAllSleeves_" + nbOfAccountsToBeSelected1;
    var SoughtForValue2 = "Performance_Acc_Sleeves_RebalanceAllSleeves_" + nbOfAccountsToBeSelected2;
    var SoughtForValue3 = "Performance_Acc_Sleeves_RebalanceAllSleeves_" + nbOfAccountsToBeSelected3;
    var SoughtForValue4 = "Performance_Acc_Sleeves_RebalanceAllSleeves_" + nbOfAccountsToBeSelected4;
    var SoughtForValue5 = "Performance_Acc_Sleeves_CashMgmt_RebalanceAllSleeves_" + nbOfAccountsToBeSelected1;
    var SoughtForValue6 = "Performance_Acc_Sleeves_CashMgmt_RebalanceAllSleeves_" + nbOfAccountsToBeSelected2;
    var SoughtForValue7 = "Performance_Acc_Sleeves_CashMgmt_RebalanceAllSleeves_" + nbOfAccountsToBeSelected3;
    var SoughtForValue8 = "Performance_Acc_Sleeves_CashMgmt_RebalanceAllSleeves_" + nbOfAccountsToBeSelected4;
    
    
    //AccSleevesRebalanceAllSleeves(SoughtForValue1,nbOfAccountsToBeSelected1);   
    
    //AccSleevesRebalanceAllSleeves(SoughtForValue2,nbOfAccountsToBeSelected2);
     
    //AccSleevesRebalanceAllSleeves(SoughtForValue3,nbOfAccountsToBeSelected3);
    
    AccSleevesRebalanceAllSleeves(SoughtForValue4,nbOfAccountsToBeSelected4,"","4800000");

    //AccSleevesRebalanceAllSleeves(SoughtForValue5,nbOfAccountsToBeSelected1,"Cash Management");

    //AccSleevesRebalanceAllSleeves(SoughtForValue6,nbOfAccountsToBeSelected2,"Cash Management");

    //AccSleevesRebalanceAllSleeves(SoughtForValue7,nbOfAccountsToBeSelected3,"Cash Management");

    AccSleevesRebalanceAllSleeves(SoughtForValue8,nbOfAccountsToBeSelected4,"Cash Management","4800000");
    
    //AccSleevesRebalanceAllSleeves("Performance_Acc_Sleeves_RebalanceAccount_ALL","ALL","","24000000");
} 




function AccSleevesRebalanceAllSleeves(SoughtForValue,nbOfAccountsToBeSelected,addFunction, waitTime){
...
//        var waitTimeShort = GetData(filePath_Performance, sheetName_DataBD, 45, language);
        ...
        StopWatchObj.Start(); 
        WaitUntilObjectDisappears(Get_CroesusApp(),"Uid", "ProgressCroesusWindow_b5e1","1680000"); 
        WaitObject(Get_CroesusApp(),"Uid", "Expander_0a4c",waitTime);
...
function test(){
    ...
    AccSleevesRebalanceAllSleeves(SoughtForValue4,nbOfAccountsToBeSelected4);
}