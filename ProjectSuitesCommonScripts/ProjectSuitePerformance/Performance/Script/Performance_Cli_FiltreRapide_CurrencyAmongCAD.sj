...
function Performance_Cli_FiltreRapide_CurrencyAmongCAD() {

              var StopWatchObj   = HISUtils.StopWatch;
              var SoughtForValue = "Performance_Cli_FiltreRapide_CurrencyAmongCAD";
              ...
              var field         = ReadDataFromExcelByRowIDColumnID(filePath_Performance, sheetName_DataBD, "FieldCurrency", language+client);        
              var operator      = ReadDataFromExcelByRowIDColumnID(filePath_Performance, sheetName_DataBD, "OperatorAmong", language+client);        
              var valeurValue   = ReadDataFromExcelByRowIDColumnID(filePath_Performance, sheetName_DataBD, "ValeurCAD", language+client);        
              ...
              // Mesurer la performance d'application du filtre 
              StopWatchObj.Start();
