...
function Performance_Acc_Rapport_ProjectedIncomeAnnual(){

        var StopWatchObj = HISUtils.StopWatch;
        var SoughtForValue = "Performance_Acc_Rapport_ProjectedIncomeAnnual"; 
        var typeReport = GetData(filePath_Performance, sheetName_DataBD, 42, language) 
        ...
        var typeReport    = ReadDataFromExcelByRowIDColumnID(filePath_Performance, sheetName_DataBD, "TypeProjectedIncome", language+client); 
...
//        }
        ...
        // Projection de liquidités (annuelle)
