...
function Performance_Acc_Rapport_PortfolioPerformance(){

        var StopWatchObj = HISUtils.StopWatch;
        var SoughtForValue = "Performance_Acc_Rapport_PortfolioPerformance"; 
...
//        var waitTimeLong = GetData(filePath_Performance, sheetName_DataBD, 44, language);
        ...
        var typeReport    = ReadDataFromExcelByRowIDColumnID(filePath_Performance, sheetName_DataBD, "TypePortFolioPerformance", language+client); 
