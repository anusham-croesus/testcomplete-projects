...
function Performance_Tit_Drap_FromClients(){

        var StopWatchObj = HISUtils.StopWatch;
        var SoughtForValue = "Performance_Tit_Drap_FromClients";
...
//        var client = GetData(filePath_Performance, sheetName_DataBD, 3, language);
        ...
        WaitObject(Get_RelationshipsClientsAccountsGrid(), ["ClrClassName", "WPFControlOrdinalNo"], ["DataRecordPresenter", "24"]);
        Get_RelationshipsClientsAccountsGrid().FindChild(["ClrClassName", "WPFControlOrdinalNo"], ["DataRecordPresenter", "24"], 10).WaitProperty("VisibleOnScreen", true, 15000);
...
//    
//            // Maillage un client au module titres
//            StopWatchObj.Start();
//            Drag(Get_RelationshipsClientsAccountsGrid().FindChild(["ClrClassName", "WPFControlOrdinalNo"], ["DataRecordPresenter", posClient], 10), Get_ModulesBar_BtnSecurities());
...
//        } else if (DataType == "Data"){
        ...
        // Recherche de clients
            ...
            // Maillage un client au module titres
            StopWatchObj.Start();
            Drag(Get_RelationshipsClientsAccountsGrid().Find("Value",clientNo,1000), Get_ModulesBar_BtnSecurities());
            WaitObject(Get_CroesusApp(), "Uid", "DataGrid_865b", waitTimeShort);
            Get_SecurityGrid().FindChild(["ClrClassName", "WPFControlOrdinalNo"], ["DataRecordPresenter", "1"], 10).WaitProperty("VisibleOnScreen", true, 15000);
            StopWatchObj.Stop();
            //***********************************************************************
