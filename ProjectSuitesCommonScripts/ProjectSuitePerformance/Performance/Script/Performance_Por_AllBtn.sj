...
function Performance_Por_AllBtn(){

        var StopWatchObj = HISUtils.StopWatch;
        var SoughtForValue = "Performance_Por_AllBtn";
...
//        }
        ...
        Get_PortfolioBar_BtnAll().WaitProperty("Enabled", true, 15000);
    
        // Mesure la performance clique le boutton tous   
        StopWatchObj.Start();
        Get_PortfolioBar_BtnAll().Click();
        Get_PortfolioBar_BtnAll().WaitProperty("IsChecked", true, waitTimeShort);
        StopWatchObj.Stop();
