...
function WebConfig_UserPage_IACode_2Characters_SearchIACode(){

        var StopWatchObj = HISUtils.StopWatch;
        var SoughtForValue = "WebConfig_UserPage_IACode_2Characters_SearchIACode";
        ...
        var searchCodeDisplayed = ReadDataFromExcelByRowIDColumnID(filePath_Performance, sheetName_DataWebConfigurator, "searchCodeDisplayed", language+client);
        ...
        try {
            ...
            PageActif.QuerySelector(IACodeUSerPageSearchBoxCSS).Keys(code2Ca + "[Enter]");
            
            StopWatchObj.Start();
            WaitObject(PageActif.Find("idStr","cPTree",100), ["idStr","VisibleOnScreen"], [searchCodeDisplayed + "_anchor", true], waitTime);
            StopWatchObj.Stop();
