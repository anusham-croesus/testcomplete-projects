...
function Performance_Por_GroupBtn(){

        var StopWatchObj = HISUtils.StopWatch;
        var SoughtForValue = "Performance_Por_GroupBtn";
...
//        var waitTimeShort = GetData(filePath_Performance, sheetName_DataBD, 45, language);
        ...
        // Bouton segement
        StopWatchObj.Start();
        Get_PortfolioGrid_BarToggleButtonToolBar_BtnByAssetClass().WaitProperty("IsChecked", true, waitTimeShort);
        StopWatchObj.Stop();
        //***********************************************************************
