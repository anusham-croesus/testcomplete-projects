...
function Performance_Por_Drag_FromRelationships() {

        var StopWatchObj = HISUtils.StopWatch;
        var SoughtForValue = "Performance_Por_Drag_FromRelationships";
...
//    
//            // Maillage une relations au module Portefeuille
//            StopWatchObj.Start();
//            Drag(Get_RelationshipsClientsAccountsGrid().FindChild(["ClrClassName", "WPFControlOrdinalNo"], ["DataRecordPresenter", posRelation], 10), Get_ModulesBar_BtnPortfolio());
...
//        } else if (DataType == "Data"){
            ...
            // Maillage une relations au module Portefeuille
            StopWatchObj.Start();
            Drag(Get_RelationshipsClientsAccountsGrid().Find("Value",relationshipName,1000), Get_ModulesBar_BtnPortfolio());
            WaitObject(Get_CroesusApp(), "Uid", "PortfolioPlugin_f3c4", waitTimeShort);
            Get_Portfolio_PositionsGrid().FindChild(["ClrClassName", "WPFControlOrdinalNo"], ["DataRecordPresenter", "1"], 10).WaitProperty("VisibleOnScreen", true, 15000);
            StopWatchObj.Stop();
            //***********************************************************************
