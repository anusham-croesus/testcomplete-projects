...
function Performance_Cli_Drag_FromTransactions(){

        var StopWatchObj = HISUtils.StopWatch;
        var SoughtForValue = "Performance_Cli_Drag_FromTransactions";
...
//        var waitTimeShort = GetData(filePath_Performance, sheetName_DataBD, 45, language);
        ...
        //if (DataType == "Position"){
            ...
            // Maillage un transactions au module client
            StopWatchObj.Start();
            Drag(Get_Transactions_ListView().FindChild(["ClrClassName", "WPFControlOrdinalNo"], ["DragableListViewItem", posTransaction], 10), Get_ModulesBar_BtnClients());
        ...
        /*} else if (DataType == "Data"){
            ...
            //Get_Transactions_ListView().Find("Text",account,1000).WaitProperty("IsFocused", true, waitTimeShort);
            // Maillage un transactions au module client
            StopWatchObj.Start();
            Drag(Get_Transactions_ListView().Find("Text",account,1000), Get_ModulesBar_BtnClients());
