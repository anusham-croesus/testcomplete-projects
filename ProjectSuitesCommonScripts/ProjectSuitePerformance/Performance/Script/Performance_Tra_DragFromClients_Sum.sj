...
function Performance_Tra_DragFromClients_Sum(){

        var StopWatchObj = HISUtils.StopWatch;
        var SoughtForValue = "Performance_Tra_DragFromClients_Sum";
...
//        } else if (DataType == "Data"){
            ...
            // Maillage un client au module transaction
            Drag(Get_RelationshipsClientsAccountsGrid().Find("Value",clientNo,1000), Get_ModulesBar_BtnTransactions());
            WaitObject(Get_CroesusApp(), "Uid", "FixedColumnListView_1b3e");
            Get_Transactions_ListView().FindChild(["ClrClassName", "WPFControlOrdinalNo"], ["DragableListViewItem", "2"], 10).WaitProperty("VisibleOnScreen", true, 15000);
            //***********************************************************************
//        }       
