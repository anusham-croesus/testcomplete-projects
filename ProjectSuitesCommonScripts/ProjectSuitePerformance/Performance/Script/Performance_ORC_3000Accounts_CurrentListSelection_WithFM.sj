...
function Performance_ORC_3000Accounts_CurrentListSelection_WithFM()
{
        var cmbTransactionWithFM = ReadDataFromExcelByRowIDColumnID(filePath_Performance, "DataPerformanceNFR", "cmbTransactionUnitsPerAccount", language+client);        
        var SoughtForValueCurrentListSelectionWithFM = ReadDataFromExcelByRowIDColumnID(filePath_Performance, "DataPerformanceNFR", "SoughtForValueCurrentListSelectionWithFM", language+client);        
        
        Performance_ORC_3000Accounts(cmbTransactionWithFM, SoughtForValueCurrentListSelectionWithFM);
...
//        var SoughtForValue = "Performance_ORC_3000Accounts_%OfSecurityHeld_BtnPreview";
        ...
        var symbolFID081 = ReadDataFromExcelByRowIDColumnID(filePath_Performance, "DataPerformanceNFR", "symbolFID081", language+client);        
...
//************************** Étape 2 *********************************************************************************
        ...
        AddASellBySymbol(qtySellORC3000,cmbTransaction,symbolFID081);
        
//************************** Étape 3 *********************************************************************************
        Log.PopLogFolder();
        logEtape3 = Log.AppendFolder("Étape 3: Ajouter transactions équivalentes (Achat) (50% (MSFT) et 5% (AAPL))");
        
        PurchasequivalentTransactAddiction(qtyBuyORC3000, symbolNBC181);  //Répartition: 50% (NBC181) et 
