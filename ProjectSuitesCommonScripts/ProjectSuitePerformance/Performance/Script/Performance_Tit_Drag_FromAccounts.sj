...
function Performance_Tit_Drag_FromAccounts(){

        var StopWatchObj = HISUtils.StopWatch;
        var SoughtForValue = "Performance_Tit_Drag_FromAccounts";
...
//  
//            // Maillage un comptes au module titres
//            StopWatchObj.Start();
//            Drag(Get_RelationshipsClientsAccountsGrid().FindChild(["ClrClassName", "WPFControlOrdinalNo"], ["DataRecordPresenter", posAccount], 10), Get_ModulesBar_BtnSecurities());
//            WaitObject(Get_CroesusApp(), "Uid", "DataGrid_865b");
//            Get_SecurityGrid().WaitProperty("VisibleOnScreen", true, 15000);
//            StopWatchObj.Stop();
//            //***********************************************************************
//        } else if (DataType == "Data"){
            ...
            // Maillage un comptes au module titres
            StopWatchObj.Start();
            Drag(Get_RelationshipsClientsAccountsGrid().Find("Value",account,1000), Get_ModulesBar_BtnSecurities());
