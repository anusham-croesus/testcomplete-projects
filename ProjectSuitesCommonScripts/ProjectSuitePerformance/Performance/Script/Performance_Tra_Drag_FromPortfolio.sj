...
function Performance_Tra_Drag_FromPortfolio(){

        var StopWatchObj = HISUtils.StopWatch;
        var SoughtForValue = "Performance_Tra_Drag_FromPortfolio";
...
//        } else if (DataType == "Data"){
            ...
            // Maillage portefeuille au module transactions
            StopWatchObj.Start();
            Drag(Get_Portfolio_PositionsGrid().FindChild(["ClrClassName", "WPFControlOrdinalNo"], ["XamTextEditor", posPortfolio], 10), Get_ModulesBar_BtnTransactions());
            WaitObject(Get_CroesusApp(), "Uid", "FixedColumnListView_1b3e", waitTimeShort); 
