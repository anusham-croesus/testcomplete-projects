...
function Performance_Cli_Rapport_GainsLossesRealized(){

        var StopWatchObj = HISUtils.StopWatch;
        var SoughtForValue = "Performance_Cli_Rapport_GainsLossesRealized"; 
...
//        var waitTimeLong = GetData(filePath_Performance, sheetName_DataBD, 44, language);
        ...
        Delay(6000);
        if (Get_DlgPrintingStatusMessageLogs().Exists) Get_DlgPrintingStatusMessageLogs_BtnOK().Click();
