...
function Performance_Rel_Rapport_Transactions(){

        var StopWatchObj = HISUtils.StopWatch;
        var SoughtForValue = "Performance_Rel_Rapport_Transactions"; 
//        var typeReport = GetData(filePath_Performance, sheetName_DataBD, 39, language) 
...
//        var waitTimeLong = GetData(filePath_Performance, sheetName_DataBD, 44, language);
        ...
        var typeReport   = ReadDataFromExcelByRowIDColumnID(filePath_Performance, sheetName_DataBD, "TypeTransactions", language+client);        
