...
function Performance_Rel_Rapport_GainsLossesRealized(){

        var StopWatchObj = HISUtils.StopWatch;
        var SoughtForValue = "Performance_Rel_Rapport_GainsLossesRealized"; 
//        var typeReport = GetData(filePath_Performance, sheetName_DataBD, 40, language) 
...
//        var waitTimeLong = GetData(filePath_Performance, sheetName_DataBD, 44, language);
        ...
        var typeReport   = ReadDataFromExcelByRowIDColumnID(filePath_Performance, sheetName_DataBD, "TypeGainsLosses", language+client);
...
function SetReportParameters()
{
    ...
    var startDate="2018/01/01"; //"01/01/2018"
