...
function Performance_Acc_Drag_FromRelationships() {

        var StopWatchObj = HISUtils.StopWatch;
        var SoughtForValue = "Performance_Acc_Drag_FromRelationships";
...
//    
//            // Maillage une relations au module comptes
//            StopWatchObj.Start();
//            Drag(Get_RelationshipsClientsAccountsGrid().FindChild(["ClrClassName", "WPFControlOrdinalNo"], ["DataRecordPresenter", posRelation], 10), Get_ModulesBar_BtnAccounts());
...
//        } else if (DataType == "Data"){
            ...
            // Maillage une relations au module comptes
            StopWatchObj.Start();
            Drag(Get_RelationshipsClientsAccountsGrid().Find("Value",relationshipName,100), Get_ModulesBar_BtnAccounts());
            WaitObject(Get_CroesusApp(), ["ClrClassName", "WPFControlOrdinalNo"], ["ToggleButton", 1],waitTimeShort);
            StopWatchObj.Stop();
            //***********************************************************************
//        }
