...
//USEUNIT Performance_Rel_JoinClients_To_Relationships

/* Analyste d'assurance qualité: Isabelle Gaudreault
Analyste d'automatisation: Xian Wei */

function Performance_Rel_JoinAccounts_To_Relationships()
{

            var StopWatchObj = HISUtils.StopWatch;
            var SoughtForValue = "Performance_Rel_JoinAccounts_To_Relationships";
...
//            var waitTimeShort = GetData(filePath_Performance, sheetName_DataBD, 45, language);
            ...
            try {
                ...
                // lie un nouveau comptes à une relation
                Log.Message("Join the account " + clientName + " to the relationship " + relationshipName + ".");
                ...
                WaitObject(Get_CroesusApp(),"Uid", "RelationshipAssignationResults_5ddd");
                Get_WinAssignToARelationship_BtnYes().WaitProperty("Enabled", true, 15000);
                ...
                Get_RelationshipsClientsAccountsDetails_PnlHierarchyPanel().WaitProperty("VisibleOnScreen", true, 15000);
