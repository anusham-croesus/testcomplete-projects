...
function Performance_Tit_HistoricalDataBtn(){

        var StopWatchObj = HISUtils.StopWatch;
        var SoughtForValue = "Performance_Tit_HistoricalDataBtn";
...
//        var waitTimeShort = GetData(filePath_Performance, sheetName_DataBD, 45, language);
        ...
        //if (DataType == "Position"){
            ...
            Get_SecuritiesBar_BtnHistoricalData().WaitProperty("Enabled", true, 15000);
            //***********************************************************************
