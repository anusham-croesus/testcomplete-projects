...
function Performance_Cli_Drag_FromAccounts(){

        var StopWatchObj = HISUtils.StopWatch;
        var SoughtForValue = "Performance_Cli_Drag_FromAccounts";
...
//  
//            // Maillage un comptes au module clients
//            StopWatchObj.Start();
//            Drag(Get_RelationshipsClientsAccountsGrid().FindChild(["ClrClassName", "WPFControlOrdinalNo"], ["DataRecordPresenter", posAccount], 10), Get_ModulesBar_BtnClients());
...
//        } else if (DataType == "Data"){
            ...
            // Maillage un comptes au module clients
            StopWatchObj.Start();
            Drag(Get_RelationshipsClientsAccountsGrid().Find("Value",account,1000), Get_ModulesBar_BtnClients());
            WaitObject(Get_CroesusApp(), ["ClrClassName", "WPFControlOrdinalNo"], ["ToggleButton", 1],waitTimeShort);
            StopWatchObj.Stop();
            //***********************************************************************
//        }
