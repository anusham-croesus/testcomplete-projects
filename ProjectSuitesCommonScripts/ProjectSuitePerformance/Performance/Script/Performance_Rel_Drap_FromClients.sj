...
function Performance_Rel_Drap_FromClients(){

        var StopWatchObj = HISUtils.StopWatch;
        var SoughtForValue = "Performance_Rel_Drap_FromClients";
...
//    
//            // Maillage un client au module relations
//            StopWatchObj.Start();
//            Drag(Get_RelationshipsClientsAccountsGrid().FindChild(["ClrClassName", "WPFControlOrdinalNo"], ["DataRecordPresenter", posClient], 10), Get_ModulesBar_BtnRelationships());
...
//        } else if (DataType == "Data"){
            ...
            Drag(Get_RelationshipsClientsAccountsGrid().Find("Value",clientNo,1000), Get_ModulesBar_BtnRelationships());
            // Maillage un client au module relations
            StopWatchObj.Start();
