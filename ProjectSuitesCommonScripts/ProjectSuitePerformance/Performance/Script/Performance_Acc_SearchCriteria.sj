...
function Performance_Acc_SearchCriteria(){

        var StopWatchObj = HISUtils.StopWatch;
        var SoughtForValue = "Performance_Acc_SearchCriteria";
...
//        var searchCriterionName = GetData(filePath_Performance, sheetName_DataBD, 29, language);
        ...
        var searchCriterionName = ReadDataFromExcelByRowIDColumnID(filePath_Performance, sheetName_DataBD, "CriterionPerformanceAccounts", language+client); 
