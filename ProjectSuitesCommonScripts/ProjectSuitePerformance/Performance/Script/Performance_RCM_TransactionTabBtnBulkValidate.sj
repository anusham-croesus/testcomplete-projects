...
function Performance_RCM_TransactionTabBtnBulkValidate(){

        var StopWatchObj = HISUtils.StopWatch;
        var SoughtForValue = "Performance_RCM_TransactionTabBtnBulkValidate";
        ...
        try {
          ...
          // Attendre le button 'Bulk Validate' présent et actif dans la fenêtre RQS
          WaitObject(Get_WinRQS_TabTransactionBlotter_BlotterControl(), "Uid", "Button_947a", waitTime);
          Get_WinRQS_TabTransactionBlotter_BtnBulkValidate().WaitProperty("Enabled", true, waitTime)
          
          Get_WinRQS_TabTransactionBlotter_BtnBulkValidate().Click();
          //Mesurer la performance de l'ouverture de la fenêtre 'Bulk Validate'
          StopWatchObj.Start();          
          //WaitObject(Get_CroesusApp(), "Uid", "Window_fff1",waitTimeShort);
          Get_WinBulkValidation().WaitProperty("VisibleOnScreen", true, waitTimeShort);   
          //Get_WinBulkValidation_BtnClose().WaitProperty("VisibleOnScreen", true, waitTimeShort);  
