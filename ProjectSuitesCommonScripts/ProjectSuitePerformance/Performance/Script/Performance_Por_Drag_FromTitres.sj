...
function Performance_Por_Drag_FromTitres() {

            var StopWatchObj = HISUtils.StopWatch;
            var SoughtForValue = "Performance_Por_Drag_FromTitres";
...
//    
//                // Maillage un titre au module portefeuille
//                StopWatchObj.Start();
//                Drag(Get_SecurityGrid().FindChild(["ClrClassName", "WPFControlOrdinalNo"], ["DataRecordPresenter", posTitre], 10), Get_ModulesBar_BtnPortfolio());
...
//            } else if (DataType == "Data"){
                ...
                // Maillage un titre au module portefeuille
                StopWatchObj.Start();
                Drag(Get_SecurityGrid().Find("Value",titre,1000), Get_ModulesBar_BtnPortfolio());
                WaitObject(Get_CroesusApp(), "Uid", "PortfolioPlugin_f3c4", waitTimeShort);
                Get_Portfolio_PositionsGrid().FindChild(["ClrClassName", "WPFControlOrdinalNo"], ["DataRecordPresenter", "1"], 10).WaitProperty("VisibleOnScreen", true, 15000);
