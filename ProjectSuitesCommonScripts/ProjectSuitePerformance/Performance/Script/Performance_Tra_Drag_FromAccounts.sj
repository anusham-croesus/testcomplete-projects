...
function Performance_Tra_Drag_FromAccounts(){

        var StopWatchObj = HISUtils.StopWatch;
        var SoughtForValue = "Performance_Tra_Drag_FromAccounts";
...
//  
//            // Maillage un comptes au module Transactions
//            StopWatchObj.Start();
//            Drag(Get_RelationshipsClientsAccountsGrid().FindChild(["ClrClassName", "WPFControlOrdinalNo"], ["DataRecordPresenter", posAccount], 10), Get_ModulesBar_BtnTransactions());
...
//        } else if (DataType == "Data"){
            ...
            // Maillage un comptes au module Transactions
            StopWatchObj.Start();
            Drag(Get_RelationshipsClientsAccountsGrid().Find("Value",account,100), Get_ModulesBar_BtnTransactions());
            WaitObject(Get_CroesusApp(), "Uid", "FixedColumnListView_1b3e", waitTimeShort);
            Get_Transactions_ListView().FindChild(["ClrClassName", "WPFControlOrdinalNo"], ["DragableListViewItem", "2"], 10).WaitProperty("VisibleOnScreen", true, 15000);
            StopWatchObj.Stop()
            //***********************************************************************
