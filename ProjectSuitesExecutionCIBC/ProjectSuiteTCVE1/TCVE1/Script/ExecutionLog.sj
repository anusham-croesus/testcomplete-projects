...
function ExecutionLog()
{
    ...
    if (SendMail("christophe.paring@croesus.com;sana.ayaz@croesus.com;xian.wei@croesus.com;philippe.maurice@croesus.com;karima.mouzaoui@croesus.com", "mail.croesus.com", "TestComplete Execution", "testauto@croesus.com", client + " TCVE1 - exécution des scripts terminée", "L'exécution des scripts du projet TCVE1 est maintenant terminée."))
